...
_jo.setObject((java.lang.Object)(_hintimageview.getObject()));
...
_tf = new anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper();
_tf.setObject((javafx.scene.control.TextField)(_mtextfield.getObject()));
...
_hintimageview.SetLayoutAnimated(_duration,_horizontalpadding,_mbase.getHeight()/(double)2-_b.getHeight()/(double)2,_b.getWidth(),_b.getHeight());
...
_hintimageview.SetLayoutAnimated(_duration,__c.DipToCurrent((int) (2)),__c.DipToCurrent((int) (2)),_b.getWidth(),_b.getHeight());
