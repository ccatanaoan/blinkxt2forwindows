...
public class badger extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("cloyd.blink", "cloyd.blink.badger", this);
            if (htSubs == null) {
...
_xlbl.setFont(_xui.CreateDefaultBoldFont((float) (16)));
...
_p.AddView((javafx.scene.Node)(_xlbl.getObject()),_radius,_radius,0,0);
...
_xlbl.SetLayoutAnimated(_duration,0,0,_radius*2,_radius*2);
...
_xlbl.SetVisibleAnimated(ba,_animationduration,__c.True);
 //BA.debugLineNum = 100;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.B4XViewWrapper  _createnewpanel(anywheresoftware.b4a.objects.B4XViewWrapper _view,int _count) throws Exception{
...
_xp.SetColorAndBorder(_color,0,_color,_radius);
...
_parent.AddView((javafx.scene.Node)(_xp.getObject()),_cx,_cy,0,0);
...
public ResumableSub_RemoveBadge(cloyd.blink.badger parent,anywheresoftware.b4a.objects.B4XViewWrapper _view) {
this.parent = parent;
this._view = _view;
}
...
_p.SetLayoutAnimated(parent._animationduration,parent._cx,parent._cy,0,0);
...
public ResumableSub_ReplaceLabel(cloyd.blink.badger parent,anywheresoftware.b4a.objects.B4XViewWrapper _view,int _badge) {
this.parent = parent;
this._view = _view;
this._badge = _badge;
}
...
_lbl.SetLayoutAnimated((int) (parent._animationduration/(double)2),parent._radius+parent.__c.DipToCurrent((int) (8)),0,parent._radius*2,parent._radius*2);
...
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = _createnewpanel(_view,_badge);
...
_p.SetLayoutAnimated(_animationduration,_cx-_radius,_cy-_radius,_radius*2,_radius*2);
