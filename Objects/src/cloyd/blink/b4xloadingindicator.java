...
public class b4xloadingindicator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("cloyd.blink", "cloyd.blink.b4xloadingindicator", this);
            if (htSubs == null) {
...
public ResumableSub_MainLoop(cloyd.blink.b4xloadingindicator parent) {
this.parent = parent;
}
