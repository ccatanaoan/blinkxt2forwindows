...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("cloyd.blink", "cloyd.blink.b4xsearchtemplate", this);
            if (htSubs == null) {
...
_tf._reset /*cloyd.blink.b4jtextflow*/ ();
...
_tf._append /*cloyd.blink.b4jtextflow*/ (_item.substring((int) (0),_x))._setcolor /*cloyd.blink.b4jtextflow*/ (_customlistview1._defaulttextcolor);
 };
...
_tf._append /*cloyd.blink.b4jtextflow*/ (_item.substring(_x,(int) (_x+_full.length())))._setcolor /*cloyd.blink.b4jtextflow*/ (_texthighlightcolor);
 };
...
_tf._append /*cloyd.blink.b4jtextflow*/ (_item.substring((int) (_x+_full.length())))._setcolor /*cloyd.blink.b4jtextflow*/ (_customlistview1._defaulttextcolor);
 };
...
public ResumableSub_Show(cloyd.blink.b4xsearchtemplate parent,cloyd.blink.b4xdialog _dialog) {
this.parent = parent;
