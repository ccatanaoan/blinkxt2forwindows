...
public class scrollinglabel extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("cloyd.blink", "cloyd.blink.scrollinglabel", this);
            if (htSubs == null) {
...
_mbase.AddView((javafx.scene.Node)(_p.getObject()),0,0,_mbase.getWidth(),_mbase.getHeight());
...
_p.AddView((javafx.scene.Node)(_xlbl.getObject()),0,0,_mbase.getWidth(),_mbase.getHeight());
 };
...
public ResumableSub_StartScrolling(cloyd.blink.scrollinglabel parent,anywheresoftware.b4a.objects.B4XViewWrapper _p,float _originalwidth) {
this.parent = parent;
this._p = _p;
