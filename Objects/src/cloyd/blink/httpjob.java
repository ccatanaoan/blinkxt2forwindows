...
anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper _b = null;
 //BA.debugLineNum = 255;BA.debugLine="Public Sub GetBitmap As Image";
 //BA.debugLineNum = 256;BA.debugLine="Dim b As Image";
_b = new anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper();
 //BA.debugLineNum = 257;BA.debugLine="b = fx.LoadImage(HttpUtils2Service.TempFolder, ta";
