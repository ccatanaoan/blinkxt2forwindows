...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("cloyd.blink", "cloyd.blink.b4xformatter", this);
            if (htSubs == null) {
...
public String  _addformatdata(cloyd.blink.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public cloyd.blink.b4xformatter._b4xformatdata  _copyformatdata(cloyd.blink.b4xformatter._b4xformatdata _data) throws Exception{
...
public cloyd.blink.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
cloyd.blink.b4xformatter._b4xformatdata _d = null;
...
public cloyd.blink.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (cloyd.blink.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return null;
}
public cloyd.blink.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
cloyd.blink.b4xformatter._b4xformatdata _d = null;
...
_d = (cloyd.blink.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public cloyd.blink.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
