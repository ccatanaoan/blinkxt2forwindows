...
public class anotherprogressbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("cloyd.blink", "cloyd.blink.anotherprogressbar", this);
            if (htSubs == null) {
...
public ResumableSub_BusyLoop(cloyd.blink.anotherprogressbar parent) {
this.parent = parent;
}
...
_mbase.AddView((javafx.scene.Node)(_miv.getObject()),0,0,0,0);
 //BA.debugLineNum = 42;BA.debugLine="mBase.AddView(lbl, 0, 0, mBase.Width, mBase.Heigh";
_mbase.AddView((javafx.scene.Node)(_lbl.getObject()),0,0,_mbase.getWidth(),_mbase.getHeight());
