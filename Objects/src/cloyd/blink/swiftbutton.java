...
public class swiftbutton extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("cloyd.blink", "cloyd.blink.swiftbutton", this);
            if (htSubs == null) {
...
public String  _p_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Private Sub p_MouseClicked (EventData As MouseEven";
 //BA.debugLineNum = 103;BA.debugLine="EventData.Consume";
_eventdata.Consume();
