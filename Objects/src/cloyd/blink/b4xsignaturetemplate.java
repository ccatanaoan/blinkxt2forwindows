...
public class b4xsignaturetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("cloyd.blink", "cloyd.blink.b4xsignaturetemplate", this);
            if (htSubs == null) {
...
_cvs.DrawText((""+__c.SmartStringFormatter("datetime",(Object)(__c.DateTime.getNow()))+""),__c.DipToCurrent((int) (2)),_baseline,_textfont,_textcolor,BA.getEnumFromString(javafx.scene.text.TextAlignment.class,"LEFT"));
 };
...
_mbase.SetLayoutAnimated((int) (0),0,0,__c.DipToCurrent((int) (300)),__c.DipToCurrent((int) (200)));
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((cloyd.blink.b4xdialog) args[0]);
