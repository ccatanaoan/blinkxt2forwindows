...
_cvsdays.DrawText(_d.substring((int) (0),(int) (2)),(_i-_firstday+0.5)*_boxw,__c.DipToCurrent((int) (20)),_daysfont,_daysinweekcolor,BA.getEnumFromString(javafx.scene.text.TextAlignment.class,"CENTER"));
 }
};
