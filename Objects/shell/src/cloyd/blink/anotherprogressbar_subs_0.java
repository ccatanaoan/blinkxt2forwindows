...
try {
		Debug.PushSubsStack("Base_Resize (anotherprogressbar) ","anotherprogressbar",6,__ref.getField(false, "ba"),__ref,48);
...
try {
		Debug.PushSubsStack("BusyLoop (anotherprogressbar) ","anotherprogressbar",6,__ref.getField(false, "ba"),__ref,58);
...
try {
		Debug.PushSubsStack("getValue (anotherprogressbar) ","anotherprogressbar",6,__ref.getField(false, "ba"),__ref,147);
...
try {
		Debug.PushSubsStack("getVisible (anotherprogressbar) ","anotherprogressbar",6,__ref.getField(false, "ba"),__ref,143);
...
try {
		Debug.PushSubsStack("setValue (anotherprogressbar) ","anotherprogressbar",6,__ref.getField(false, "ba"),__ref,151);
...
try {
		Debug.PushSubsStack("SetValueNoAnimation (anotherprogressbar) ","anotherprogressbar",6,__ref.getField(false, "ba"),__ref,155);
...
try {
		Debug.PushSubsStack("setVisible (anotherprogressbar) ","anotherprogressbar",6,__ref.getField(false, "ba"),__ref,135);
...
try {
		Debug.PushSubsStack("UpdateGraphics (anotherprogressbar) ","anotherprogressbar",6,__ref.getField(false, "ba"),__ref,102);
