...
try {
		Debug.PushSubsStack("Base_Resize (anotherprogressbar) ","anotherprogressbar",8,__ref.getField(false, "ba"),__ref,49);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.anotherprogressbar.class, "_updategraphics" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("BusyLoop (anotherprogressbar) ","anotherprogressbar",8,__ref.getField(false, "ba"),__ref,59);
...
public ResumableSub_BusyLoop(cloyd.blink.anotherprogressbar parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
try {
		Debug.PushSubsStack("DesignerCreateView (anotherprogressbar) ","anotherprogressbar",8,__ref.getField(false, "ba"),__ref,32);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.anotherprogressbar.class, "_setvalue" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Value"))),(Object)(RemoteObject.createImmutable((100)))))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.anotherprogressbar.class, "_base_resize" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")));
...
try {
		Debug.PushSubsStack("getValue (anotherprogressbar) ","anotherprogressbar",8,__ref.getField(false, "ba"),__ref,148);
...
try {
		Debug.PushSubsStack("getVisible (anotherprogressbar) ","anotherprogressbar",8,__ref.getField(false, "ba"),__ref,144);
...
try {
		Debug.PushSubsStack("Initialize (anotherprogressbar) ","anotherprogressbar",8,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("setValue (anotherprogressbar) ","anotherprogressbar",8,__ref.getField(false, "ba"),__ref,152);
...
try {
		Debug.PushSubsStack("SetValueNoAnimation (anotherprogressbar) ","anotherprogressbar",8,__ref.getField(false, "ba"),__ref,156);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.anotherprogressbar.class, "_setvalue" /*RemoteObject*/ ,(Object)(_v));
...
try {
		Debug.PushSubsStack("setVisible (anotherprogressbar) ","anotherprogressbar",8,__ref.getField(false, "ba"),__ref,136);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.anotherprogressbar.class, "_busyloop" /*void*/ );
 };
...
try {
		Debug.PushSubsStack("UpdateGraphics (anotherprogressbar) ","anotherprogressbar",8,__ref.getField(false, "ba"),__ref,103);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.anotherprogressbar.class, "_setvisible" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getVisible")));
