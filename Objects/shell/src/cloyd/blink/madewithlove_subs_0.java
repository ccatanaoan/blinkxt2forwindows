...
try {
		Debug.PushSubsStack("Base_Resize (madewithlove) ","madewithlove",25,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("DesignerCreateView (madewithlove) ","madewithlove",25,__ref.getField(false, "ba"),__ref,15);
...
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_append" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Made with ")));
 BA.debugLineNum = 23;BA.debugLine="tf.SetFont(xlbl.Font)";
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_setfont" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.objects.JFX.FontWrapper"), _xlbl.runMethod(false,"getFont").getObject()));
 BA.debugLineNum = 24;BA.debugLine="tf.SetColor(xlbl.TextColor)";
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_setcolor" /*RemoteObject*/ ,(Object)(_xlbl.runMethod(true,"getTextColor")));
 BA.debugLineNum = 25;BA.debugLine="tf.Append(Chr(0xF004))";
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_append" /*RemoteObject*/ ,(Object)(BA.ObjectToString(madewithlove.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xf004))))));
 BA.debugLineNum = 26;BA.debugLine="tf.SetFont(xui.CreateFontAwesome(xlbl.TextSize))";
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_setfont" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.objects.JFX.FontWrapper"), __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreateFontAwesome",(Object)(BA.numberCast(float.class, _xlbl.runMethod(true,"getTextSize")))).getObject()));
 BA.debugLineNum = 27;BA.debugLine="tf.SetColor(xui.Color_Red)";
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_setcolor" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Red")));
 BA.debugLineNum = 28;BA.debugLine="tf.Append(\" in B4X\")";
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_append" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable(" in B4X")));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_createtextflow" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")));
...
try {
		Debug.PushSubsStack("Initialize (madewithlove) ","madewithlove",25,__ref.getField(false, "ba"),__ref,9);
