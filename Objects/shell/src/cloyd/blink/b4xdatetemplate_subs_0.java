...
try {
		Debug.PushSubsStack("btnMonth_Click (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,147);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xdatetemplate.class, "_drawdays" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("btnYear_Click (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,141);
...
b4xdatetemplate._mdialog = RemoteObject.createNew ("cloyd.blink.b4xdialog");__ref.setField("_mdialog",b4xdatetemplate._mdialog);
...
try {
		Debug.PushSubsStack("DaysPaneFg_Touch (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,154);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xdatetemplate.class, "_handlemouse" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _x)),(Object)(BA.numberCast(double.class, _y)),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("!",_action,_p.getField(true,"TOUCH_ACTION_UP")))));
...
try {
		Debug.PushSubsStack("DialogClosed (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,176);
...
try {
		Debug.PushSubsStack("DrawBox (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,82);
...
try {
		Debug.PushSubsStack("DrawDays (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("getDate (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,89);
...
try {
		Debug.PushSubsStack("GetPanel (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,159);
...
try {
		Debug.PushSubsStack("HandleMouse (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,114);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xdatetemplate.class, "_drawbox" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_cvsbackground" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_highlightedcolor" /*RemoteObject*/ )),(Object)(_boxx),(Object)(_boxy));
 };
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xdatetemplate.class, "_selectday" /*RemoteObject*/ ,(Object)(_newselectedday));
 BA.debugLineNum = 129;BA.debugLine="Hide";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xdatetemplate.class, "_hide" /*RemoteObject*/ );
 };
 };
...
try {
		Debug.PushSubsStack("Hide (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,136);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdialog" /*RemoteObject*/ ).runClassMethod (cloyd.blink.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")));
...
try {
		Debug.PushSubsStack("Initialize (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,34);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xdatetemplate.class, "_setdate" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_selecteddate" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("SelectDay (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,106);
...
try {
		Debug.PushSubsStack("setDate (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,93);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xdatetemplate.class, "_selectday" /*RemoteObject*/ ,(Object)(b4xdatetemplate.__c.getField(false,"DateTime").runMethod(true,"GetDayOfMonth",(Object)(_date))));
...
try {
		Debug.PushSubsStack("Show (b4xdatetemplate) ","b4xdatetemplate",12,__ref.getField(false, "ba"),__ref,163);
