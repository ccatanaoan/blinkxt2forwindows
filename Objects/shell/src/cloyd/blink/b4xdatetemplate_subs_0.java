...
_btn.setObject(b4xdatetemplate.__c.runMethod(false,"Sender",__ref.getField(false, "ba")));Debug.locals.put("btn", _btn);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xdatetemplate.class, "_handlemouse" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _x)),(Object)(BA.numberCast(double.class, _y)),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("!",_action,BA.numberCast(double.class, _p.getField(true,"TOUCH_ACTION_UP"))))));
...
_p.setObject(__ref.getField(false,"_dayspanefg" /*RemoteObject*/ ).getObject());Debug.locals.put("p", _p);
