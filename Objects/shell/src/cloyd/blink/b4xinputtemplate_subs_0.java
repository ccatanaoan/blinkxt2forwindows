...
b4xinputtemplate._lbltitle = RemoteObject.createNew ("anywheresoftware.b4j.objects.LabelWrapper");__ref.setField("_lbltitle",b4xinputtemplate._lbltitle);
...
try {
		Debug.PushSubsStack("ConfigureForNumbers (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("GetPanel (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,90);
...
try {
		Debug.PushSubsStack("Initialize (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("IsValid (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,77);
...
try {
		Debug.PushSubsStack("Show (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("TextField1_Action (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("TextField1_EnterPressed (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,85);
...
try {
		Debug.PushSubsStack("TextField1_TextChanged (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,60);
...
try {
		Debug.PushSubsStack("Validate (b4xinputtemplate) ","b4xinputtemplate",13,__ref.getField(false, "ba"),__ref,64);
