...
parent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(parent.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(BA.ObjectToString("response_arm.txt")),(Object)(parent._response));
 BA.debugLineNum = 1054;BA.debugLine="GetCommandID(response)";
Debug.ShouldStop(536870912);
_getcommandid(parent._response);
 BA.debugLineNum = 1055;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immedia-";
Debug.ShouldStop(1073741824);
...
this.state = 4;
;
 BA.debugLineNum = 1057;BA.debugLine="For i = 1 To 30";
Debug.ShouldStop(1);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 1058;BA.debugLine="GetCommandStatus(response)";
Debug.ShouldStop(2);
_getcommandstatus(parent._response);
 BA.debugLineNum = 1059;BA.debugLine="If commandComplete Then";
Debug.ShouldStop(4);
if (true) break;
...
this.state = 10;
;
 BA.debugLineNum = 1063;BA.debugLine="File.WriteString(File.DirApp,\"response_arm_com";
Debug.ShouldStop(64);
parent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(parent.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(BA.ObjectToString("response_arm_commandcomplete.txt")),(Object)(parent._response));
 BA.debugLineNum = 1064;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(128);
parent.__c.runVoidMethod ("Sleep",main.ba,anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "main", "ivdriveway_mouseclicked"),BA.numberCast(int.class, 1000));
this.state = 20;
return;
...
this.state = 10;
;
 BA.debugLineNum = 1065;BA.debugLine="Exit";
Debug.ShouldStop(256);
this.state = 11;
if (true) break;
 if (true) break;
...
this.state = 18;
;
 BA.debugLineNum = 1067;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immedia";
Debug.ShouldStop(1024);
_restget(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/network/"),parent._networkid,RemoteObject.createImmutable("/command/"),parent._commandid));
 BA.debugLineNum = 1068;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("Sleep",main.ba,anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "main", "ivdriveway_mouseclicked"),BA.numberCast(int.class, 1000));
this.state = 21;
return;
