...
try {
		Debug.PushSubsStack("Base_Resize (b4xbreadcrumb) ","b4xbreadcrumb",9,__ref.getField(false, "ba"),__ref,46);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xbreadcrumb.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xbreadcrumb) ","b4xbreadcrumb",9,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("Draw (b4xbreadcrumb) ","b4xbreadcrumb",9,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("DrawItem (b4xbreadcrumb) ","b4xbreadcrumb",9,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("FindItem (b4xbreadcrumb) ","b4xbreadcrumb",9,__ref.getField(false, "ba"),__ref,130);
...
try {
		Debug.PushSubsStack("getItems (b4xbreadcrumb) ","b4xbreadcrumb",9,__ref.getField(false, "ba"),__ref,147);
...
try {
		Debug.PushSubsStack("Initialize (b4xbreadcrumb) ","b4xbreadcrumb",9,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("setItems (b4xbreadcrumb) ","b4xbreadcrumb",9,__ref.getField(false, "ba"),__ref,142);
...
try {
		Debug.PushSubsStack("Touch_Touch (b4xbreadcrumb) ","b4xbreadcrumb",9,__ref.getField(false, "ba"),__ref,109);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_presseditem" /*RemoteObject*/ ,__ref.runClassMethod (cloyd.blink.b4xbreadcrumb.class, "_finditem" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y))));
...
Debug.JustUpdateDeviceLine();
_index = __ref.runClassMethod (cloyd.blink.b4xbreadcrumb.class, "_finditem" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y)));Debug.locals.put("index", _index);Debug.locals.put("index", _index);
