...
public static cloyd.blink.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"accountID",main._accountid,"AtualSkin",main._atualskin,"authToken",main._authtoken,"btnActivity",main._btnactivity,"btnDriveway",main._btndriveway,"cameraThumbnail",main._camerathumbnail,"clvDriveway",main._clvdriveway,"clvFrontDoor",main._clvfrontdoor,"clvSideYard",main._clvsideyard,"commandComplete",main._commandcomplete,"commandID",main._commandid,"DateUtils",main._dateutils,"emailAddress",main._emailaddress,"f_H",main._f_h,"f_W",main._f_w,"f_X",main._f_x,"f_Y",main._f_y,"fx",main._fx,"HttpUtils2Service",Debug.moduleToString(cloyd.blink.httputils2service.class),"imgInit",main._imginit,"isMaximized",main._ismaximized,"ivClose",main._ivclose,"ivDriveway",main._ivdriveway,"ivFrontDoor",main._ivfrontdoor,"ivMax",main._ivmax,"ivMin",main._ivmin,"ivSideYard",main._ivsideyard,"lblDriveway",main._lbldriveway,"lblFrontDoor",main._lblfrontdoor,"lblSideYard",main._lblsideyard,"lblStatus",main._lblstatus,"lblSyncModule",main._lblsyncmodule,"lbTitle",main._lbtitle,"MainForm",main._mainform,"networkID",main._networkid,"password",main._password,"response",main._response,"userRegion",main._userregion,"xMouse",main._xmouse,"xui",main._xui,"yMouse",main._ymouse};
}
}