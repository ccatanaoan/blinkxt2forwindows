...
try {
		Debug.PushSubsStack("Blur (main) ","main",0,main.ba,main.mostCurrent,990);
...
Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 990;BA.debugLine="Private Sub Blur (bmp As B4XBitmap) As B4XBitmap";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 991;BA.debugLine="Try";
Debug.ShouldStop(1073741824);
try { BA.debugLineNum = 992;BA.debugLine="Dim bc As BitmapCreator";
Debug.ShouldStop(-2147483648);
_bc = RemoteObject.createNew ("b4j.example.bitmapcreator");Debug.locals.put("bc", _bc);
 BA.debugLineNum = 993;BA.debugLine="Dim ReduceScale As Int = 2";
Debug.ShouldStop(1);
_reducescale = BA.numberCast(int.class, 2);Debug.locals.put("ReduceScale", _reducescale);Debug.locals.put("ReduceScale", _reducescale);
 BA.debugLineNum = 994;BA.debugLine="bc.Initialize(bmp.Width / ReduceScale / bmp.Scal";
Debug.ShouldStop(2);
...
Debug.locals.put("steps", _steps);
 BA.debugLineNum = 1001;BA.debugLine="For y = 0 To bc.mHeight - 1";
Debug.ShouldStop(256);
{
final int step11 = 1;
...
Debug.locals.put("y", _y);
 BA.debugLineNum = 1002;BA.debugLine="For x = 0 To 2";
Debug.ShouldStop(512);
{
final int step12 = 1;
final int limit12 = 2;
...
Debug.locals.put("x", _x);
 BA.debugLineNum = 1003;BA.debugLine="bc.GetARGB(x, y, clrs(x))";
Debug.ShouldStop(1024);
...
;
 BA.debugLineNum = 1005;BA.debugLine="SetAvg(bc, 1, y, clrs, temp)";
Debug.ShouldStop(4096);
_setavg(_bc,BA.numberCast(int.class, 1),BA.numberCast(int.class, _y),_clrs,_temp);
 BA.debugLineNum = 1006;BA.debugLine="m = 0";
Debug.ShouldStop(8192);
_m = BA.numberCast(int.class, 0);Debug.locals.put("m", _m);
 BA.debugLineNum = 1007;BA.debugLine="For x = 2 To bc.mWidth - 2";
Debug.ShouldStop(16384);
{
final int step17 = 1;
...
Debug.locals.put("x", _x);
 BA.debugLineNum = 1008;BA.debugLine="bc.GetARGB(x + 1, y, clrs(m))";
Debug.ShouldStop(32768);
_bc.runVoidMethod ("_getargb",(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_x),RemoteObject.createImmutable(1)}, "+",1, 1)),(Object)(BA.numberCast(int.class, _y)),(Object)(_clrs.getArrayElement(false,_m)));
 BA.debugLineNum = 1009;BA.debugLine="m = (m + 1) Mod clrs.Length";
Debug.ShouldStop(65536);
_m = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_m,RemoteObject.createImmutable(1)}, "+",1, 1)),_clrs.getField(true,"length")}, "%",0, 1);Debug.locals.put("m", _m);
 BA.debugLineNum = 1010;BA.debugLine="SetAvg(bc, x, y, clrs, temp)";
Debug.ShouldStop(131072);
...
;
 BA.debugLineNum = 1013;BA.debugLine="For x = 0 To bc.mWidth - 1";
Debug.ShouldStop(1048576);
{
final int step23 = 1;
...
Debug.locals.put("x", _x);
 BA.debugLineNum = 1014;BA.debugLine="For y = 0 To 2";
Debug.ShouldStop(2097152);
{
final int step24 = 1;
final int limit24 = 2;
...
Debug.locals.put("y", _y);
 BA.debugLineNum = 1015;BA.debugLine="bc.GetARGB(x, y, clrs(y))";
Debug.ShouldStop(4194304);
...
;
 BA.debugLineNum = 1017;BA.debugLine="SetAvg(bc, x, 1, clrs, temp)";
Debug.ShouldStop(16777216);
_setavg(_bc,BA.numberCast(int.class, _x),BA.numberCast(int.class, 1),_clrs,_temp);
 BA.debugLineNum = 1018;BA.debugLine="m = 0";
Debug.ShouldStop(33554432);
_m = BA.numberCast(int.class, 0);Debug.locals.put("m", _m);
 BA.debugLineNum = 1019;BA.debugLine="For y = 2 To bc.mHeight - 2";
Debug.ShouldStop(67108864);
{
final int step29 = 1;
...
Debug.locals.put("y", _y);
 BA.debugLineNum = 1020;BA.debugLine="bc.GetARGB(x, y + 1, clrs(m))";
Debug.ShouldStop(134217728);
_bc.runVoidMethod ("_getargb",(Object)(BA.numberCast(int.class, _x)),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_y),RemoteObject.createImmutable(1)}, "+",1, 1)),(Object)(_clrs.getArrayElement(false,_m)));
 BA.debugLineNum = 1021;BA.debugLine="m = (m + 1) Mod clrs.Length";
Debug.ShouldStop(268435456);
_m = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_m,RemoteObject.createImmutable(1)}, "+",1, 1)),_clrs.getField(true,"length")}, "%",0, 1);Debug.locals.put("m", _m);
 BA.debugLineNum = 1022;BA.debugLine="SetAvg(bc, x, y, clrs, temp)";
Debug.ShouldStop(536870912);
_setavg(_bc,BA.numberCast(int.class, _x),BA.numberCast(int.class, _y),_clrs,_temp);
 }
}Debug.locals.put("y", _y);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e37.toString()); BA.debugLineNum = 1027;BA.debugLine="Log(LastException)";
Debug.ShouldStop(4);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 1028;BA.debugLine="lblStatus.Text = \"Blur LastException: \" & LastEx";
Debug.ShouldStop(8);
main._lblstatus.runMethod(true,"setText",RemoteObject.concat(RemoteObject.createImmutable("Blur LastException: "),main.__c.runMethod(false,"LastException",main.ba)));
 ...
 BA.debugLineNum = 1030;BA.debugLine="Return bc.Bitmap";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("BlurIV (main) ","main",0,main.ba,main.mostCurrent,980);
...
Debug.locals.put("iv", _iv);
 BA.debugLineNum = 980;BA.debugLine="Sub BlurIV (image As String,iv As ImageView)";
Debug.ShouldStop(524288);
 BA.debugLineNum = 981;BA.debugLine="Try";
Debug.ShouldStop(1048576);
try { BA.debugLineNum = 982;BA.debugLine="Dim bmp As B4XBitmap = xui.LoadBitmapResize(File";
Debug.ShouldStop(2097152);
...
_bmp = main._xui.runMethod(false,"LoadBitmapResize",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(_image),(Object)(BA.numberCast(int.class, _iv.runMethod(true,"getWidth"))),(Object)(BA.numberCast(int.class, _iv.runMethod(true,"getHeight"))),(Object)(main.__c.getField(true,"True")));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 983;BA.debugLine="iv.SetImage(Blur(bmp))";
Debug.ShouldStop(4194304);
_iv.runVoidMethod ("SetImage",(Object)((_blur(_bmp).getObject())));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e5) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e5.toString()); BA.debugLineNum = 985;BA.debugLine="Log(LastException)";
Debug.ShouldStop(16777216);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 986;BA.debugLine="lblStatus.Text = \"BlurIV LastException: \" & Last";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("btnActivity_Click (main) ","main",0,main.ba,main.mostCurrent,1053);
...
//C
this.state = -1;
 BA.debugLineNum = 1054;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immedia-s";
Debug.ShouldStop(536870912);
...
Debug.ShouldStop(262144);
 BA.debugLineNum = 116;BA.debugLine="clvDriveway.Clear";
Debug.ShouldStop(524288);
main._clvdriveway.runVoidMethod ("_clear");
 BA.debugLineNum = 117;BA.debugLine="clvFrontDoor.Clear";
Debug.ShouldStop(1048576);
main._clvfrontdoor.runVoidMethod ("_clear");
 BA.debugLineNum = 118;BA.debugLine="clvSideYard.Clear";
Debug.ShouldStop(2097152);
main._clvsideyard.runVoidMethod ("_clear");
 BA.debugLineNum = 119;BA.debugLine="RefreshCameras(False)";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("CheckBattLife (main) ","main",0,main.ba,main.mostCurrent,684);
...
Debug.locals.put("battlevel", _battlevel);
 BA.debugLineNum = 684;BA.debugLine="Sub CheckBattLife(battlevel As Int) As String";
Debug.ShouldStop(2048);
 BA.debugLineNum = 685;BA.debugLine="Try";
Debug.ShouldStop(4096);
try { BA.debugLineNum = 687;BA.debugLine="If battlevel <= 136 Then";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("k",_battlevel,BA.numberCast(double.class, 136))) { 
 BA.debugLineNum = 688;BA.debugLine="Return \"Replace battery now!\"";
Debug.ShouldStop(32768);
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToString("Replace battery now!");
 }else 
{ BA.debugLineNum = 689;BA.debugLine="else If battlevel >= 160 Then";
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean("g",_battlevel,BA.numberCast(double.class, 160))) { 
 BA.debugLineNum = 690;BA.debugLine="Return \"Very high\"";
Debug.ShouldStop(131072);
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToString("Very high");
 }else 
{ BA.debugLineNum = 691;BA.debugLine="else If battlevel > 136 And battlevel < 138 Then";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean(">",_battlevel,BA.numberCast(double.class, 136)) && RemoteObject.solveBoolean("<",_battlevel,BA.numberCast(double.class, 138))) { 
 BA.debugLineNum = 692;BA.debugLine="Return \"Very low\"";
Debug.ShouldStop(524288);
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToString("Very low");
 }else {
 BA.debugLineNum = 694;BA.debugLine="Return \"High\"";
Debug.ShouldStop(2097152);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e12.toString()); BA.debugLineNum = 697;BA.debugLine="Log(LastException)";
Debug.ShouldStop(16777216);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 698;BA.debugLine="lblStatus.Text = \"CheckBattLife LastException: \"";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("CheckLFRLevel (main) ","main",0,main.ba,main.mostCurrent,703);
...
Debug.locals.put("lfrlevel", _lfrlevel);
 BA.debugLineNum = 703;BA.debugLine="Sub CheckLFRLevel(lfrlevel As Int) As String";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 704;BA.debugLine="Try";
Debug.ShouldStop(-2147483648);
try { BA.debugLineNum = 706;BA.debugLine="If lfrlevel > -67 Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean(">",_lfrlevel,BA.numberCast(double.class, -(double) (0 + 67)))) { 
 BA.debugLineNum = 707;BA.debugLine="Return \"Amazing\"";
Debug.ShouldStop(4);
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToString("Amazing");
 }else 
{ BA.debugLineNum = 708;BA.debugLine="else If lfrlevel > -70 And lfrlevel <= -67 Then";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean(">",_lfrlevel,BA.numberCast(double.class, -(double) (0 + 70))) && RemoteObject.solveBoolean("k",_lfrlevel,BA.numberCast(double.class, -(double) (0 + 67)))) { 
 BA.debugLineNum = 709;BA.debugLine="Return \"Very good\"";
Debug.ShouldStop(16);
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToString("Very good");
 }else 
{ BA.debugLineNum = 710;BA.debugLine="else If lfrlevel > -80 And lfrlevel <= -70 Then";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean(">",_lfrlevel,BA.numberCast(double.class, -(double) (0 + 80))) && RemoteObject.solveBoolean("k",_lfrlevel,BA.numberCast(double.class, -(double) (0 + 70)))) { 
 BA.debugLineNum = 711;BA.debugLine="Return \"OK\"";
Debug.ShouldStop(64);
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToString("OK");
 }else 
{ BA.debugLineNum = 712;BA.debugLine="else If lfrlevel > -90 And lfrlevel <= -80 Then";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean(">",_lfrlevel,BA.numberCast(double.class, -(double) (0 + 90))) && RemoteObject.solveBoolean("k",_lfrlevel,BA.numberCast(double.class, -(double) (0 + 80)))) { 
 BA.debugLineNum = 713;BA.debugLine="Return \"Not Good\"";
Debug.ShouldStop(256);
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToString("Not Good");
 }else {
 BA.debugLineNum = 715;BA.debugLine="Return \"Unusable\"";
Debug.ShouldStop(1024);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e14.toString()); BA.debugLineNum = 718;BA.debugLine="Log(LastException)";
Debug.ShouldStop(8192);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 719;BA.debugLine="lblStatus.Text = \"CheckLFRLevel LastException: \"";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("CheckMonitor (main) ","main",0,main.ba,main.mostCurrent,827);
...
RemoteObject _s = RemoteObject.declareNull("anywheresoftware.b4j.objects.JFX.ScreenWrapper");
 BA.debugLineNum = 827;BA.debugLine="Sub CheckMonitor() As Screen";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 828;BA.debugLine="Try";
Debug.ShouldStop(134217728);
try { BA.debugLineNum = 829;BA.debugLine="If fx.Screens.Size= 1 Then";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("=",main._fx.runMethod(false,"getScreens").runMethod(true,"getSize"),BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 830;BA.debugLine="Dim SList As List = fx.Screens";
Debug.ShouldStop(536870912);
...
{ BA.debugLineNum = 834;BA.debugLine="Else If fx.Screens.Size> 1 Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean(">",main._fx.runMethod(false,"getScreens").runMethod(true,"getSize"),BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 835;BA.debugLine="Dim SList As List = fx.Screens";
Debug.ShouldStop(4);
_slist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_slist = main._fx.runMethod(false,"getScreens");Debug.locals.put("SList", _slist);Debug.locals.put("SList", _slist);
 BA.debugLineNum = 836;BA.debugLine="Dim S As Screen = SList.Get(2)";
Debug.ShouldStop(8);
_s = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX.ScreenWrapper");
_s.setObject(_slist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))));Debug.locals.put("S", _s);
 BA.debugLineNum = 838;BA.debugLine="Return S";
Debug.ShouldStop(32);
Debug.CheckDeviceExceptions();if (true) return _s;
 }else {
 BA.debugLineNum = 840;BA.debugLine="Dim SList As List = fx.Screens";
Debug.ShouldStop(128);
_slist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_slist = main._fx.runMethod(false,"getScreens");Debug.locals.put("SList", _slist);Debug.locals.put("SList", _slist);
 BA.debugLineNum = 841;BA.debugLine="Dim S As Screen = SList.Get(0)";
Debug.ShouldStop(256);
_s = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX.ScreenWrapper");
_s.setObject(_slist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("S", _s);
 BA.debugLineNum = 843;BA.debugLine="Return S";
Debug.ShouldStop(1024);
Debug.CheckDeviceExceptions();if (true) return _s;
 }}
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e16.toString()); BA.debugLineNum = 846;BA.debugLine="Dim SList As List = fx.Screens";
Debug.ShouldStop(8192);
_slist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_slist = main._fx.runMethod(false,"getScreens");Debug.locals.put("SList", _slist);Debug.locals.put("SList", _slist);
 BA.debugLineNum = 847;BA.debugLine="Dim S As Screen = SList.Get(0)";
Debug.ShouldStop(16384);
_s = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX.ScreenWrapper");
_s.setObject(_slist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("S", _s);
 BA.debugLineNum = 849;BA.debugLine="Return S";
Debug.ShouldStop(65536);
Debug.CheckDeviceExceptions();if (true) return _s;
 };
...
try {
		Debug.PushSubsStack("Close_Entered_Event (main) ","main",0,main.ba,main.mostCurrent,753);
...
Debug.locals.put("e", _e);
 BA.debugLineNum = 753;BA.debugLine="Private Sub Close_Entered_Event(e As Event)";
Debug.ShouldStop(65536);
 BA.debugLineNum = 754;BA.debugLine="Try";
Debug.ShouldStop(131072);
try { BA.debugLineNum = 755;BA.debugLine="ivClose.SetImage(fx.LoadImage(File.DirAssets, im";
Debug.ShouldStop(262144);
main._ivclose.runVoidMethod ("SetImage",(Object)((main._fx.runMethod(false,"LoadImage",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.concat(main._imginit,RemoteObject.createImmutable("_btCloseEnt.png")))).getObject())));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e4.toString()); BA.debugLineNum = 757;BA.debugLine="Log(LastException)";
Debug.ShouldStop(1048576);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 };
...
try {
		Debug.PushSubsStack("Close_Exited_Event (main) ","main",0,main.ba,main.mostCurrent,761);
if (RapidSub.canDelegate("close_exited_event")) { return cloyd.blink.main.remoteMe.runUserSub(false, "main","close_exited_event", _e);}
Debug.locals.put("e", _e);
 BA.debugLineNum = 761;BA.debugLine="Private Sub Close_Exited_Event(e As Event)";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 762;BA.debugLine="Try";
Debug.ShouldStop(33554432);
try { BA.debugLineNum = 763;BA.debugLine="ivClose.SetImage(fx.LoadImage(File.DirAssets, im";
Debug.ShouldStop(67108864);
main._ivclose.runVoidMethod ("SetImage",(Object)((main._fx.runMethod(false,"LoadImage",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.concat(main._imginit,RemoteObject.createImmutable("_btClose.png")))).getObject())));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e4.toString()); BA.debugLineNum = 765;BA.debugLine="Log(LastException)";
Debug.ShouldStop(268435456);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 };
...
try {
		Debug.PushSubsStack("clvDriveway_ItemClick (main) ","main",0,main.ba,main.mostCurrent,865);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 865;BA.debugLine="Sub clvDriveway_ItemClick (Index As Int, Value As";
Debug.ShouldStop(1);
 BA.debugLineNum = 866;BA.debugLine="clvDriveway.JumpToItem(Index)";
Debug.ShouldStop(2);
main._clvdriveway.runVoidMethod ("_jumptoitem",(Object)(_index));
 BA.debugLineNum = 867;BA.debugLine="clvFrontDoor.JumpToItem(Index)";
Debug.ShouldStop(4);
main._clvfrontdoor.runVoidMethod ("_jumptoitem",(Object)(_index));
 BA.debugLineNum = 868;BA.debugLine="clvSideYard.JumpToItem(Index)";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("clvFrontDoor_ItemClick (main) ","main",0,main.ba,main.mostCurrent,859);
...
Debug.locals.put("Index", _index);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 859;BA.debugLine="Sub clvFrontDoor_ItemClick (Index As Int, Value As";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 860;BA.debugLine="clvDriveway.JumpToItem(Index)";
Debug.ShouldStop(134217728);
main._clvdriveway.runVoidMethod ("_jumptoitem",(Object)(_index));
 BA.debugLineNum = 861;BA.debugLine="clvFrontDoor.JumpToItem(Index)";
Debug.ShouldStop(268435456);
main._clvfrontdoor.runVoidMethod ("_jumptoitem",(Object)(_index));
 BA.debugLineNum = 862;BA.debugLine="clvSideYard.JumpToItem(Index)";
Debug.ShouldStop(536870912);
main._clvsideyard.runVoidMethod ("_jumptoitem",(Object)(_index));
...
try {
		Debug.PushSubsStack("clvSideYard_ItemClick (main) ","main",0,main.ba,main.mostCurrent,853);
...
Debug.locals.put("Index", _index);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 853;BA.debugLine="Sub clvSideYard_ItemClick (Index As Int, Value As";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 854;BA.debugLine="clvDriveway.JumpToItem(Index)";
Debug.ShouldStop(2097152);
main._clvdriveway.runVoidMethod ("_jumptoitem",(Object)(_index));
 BA.debugLineNum = 855;BA.debugLine="clvFrontDoor.JumpToItem(Index)";
Debug.ShouldStop(4194304);
main._clvfrontdoor.runVoidMethod ("_jumptoitem",(Object)(_index));
 BA.debugLineNum = 856;BA.debugLine="clvSideYard.JumpToItem(Index)";
Debug.ShouldStop(8388608);
main._clvsideyard.runVoidMethod ("_jumptoitem",(Object)(_index));
...
try {
		Debug.PushSubsStack("ConvertDateTime (main) ","main",0,main.ba,main.mostCurrent,1063);
...
Debug.locals.put("inputTime", _inputtime);
 BA.debugLineNum = 1063;BA.debugLine="Sub ConvertDateTime(inputTime As String) As String";
Debug.ShouldStop(64);
 BA.debugLineNum = 1065;BA.debugLine="Dim ticks As Long = ParseUTCstring(inputTime.Repl";
Debug.ShouldStop(256);
...
Debug.ShouldStop(512);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("MMM d, yyyy h:mm:ss a z"));
...
_lngticks = _ticks;Debug.locals.put("lngTicks", _lngticks);Debug.locals.put("lngTicks", _lngticks);
 BA.debugLineNum = 1070;BA.debugLine="Return DateTime.Date(lngTicks)";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("DownloadImage (main) ","main",0,main.ba,main.mostCurrent,340);
...
this.state = 4;
this.catchState = 19;
 BA.debugLineNum = 342;BA.debugLine="Dim j As HttpJob";
Debug.ShouldStop(2097152);
_j = RemoteObject.createNew ("cloyd.blink.httpjob");Debug.locals.put("j", _j);
 BA.debugLineNum = 343;BA.debugLine="response = \"\"";
Debug.ShouldStop(4194304);
...
_j.runClassMethod (cloyd.blink.httpjob.class, "_initialize" /*RemoteObject*/ ,main.ba,(Object)(BA.ObjectToString("")),(Object)(main.getObject()));
 BA.debugLineNum = 345;BA.debugLine="j.Download(Link)";
Debug.ShouldStop(16777216);
_j.runClassMethod (cloyd.blink.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(_link));
 BA.debugLineNum = 346;BA.debugLine="j.GetRequest.SetHeader(\"TOKEN_AUTH\", authToken)";
Debug.ShouldStop(33554432);
_j.runClassMethod (cloyd.blink.httpjob.class, "_getrequest" /*RemoteObject*/ ).runVoidMethod ("SetHeader",(Object)(BA.ObjectToString("TOKEN_AUTH")),(Object)(parent._authtoken));
 BA.debugLineNum = 347;BA.debugLine="Wait For (j) JobDone(j As HttpJob)";
Debug.ShouldStop(67108864);
...
;
 BA.debugLineNum = 348;BA.debugLine="If j.Success Then";
Debug.ShouldStop(134217728);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 350;BA.debugLine="If camera = \"347574\" Then";
Debug.ShouldStop(536870912);
if (true) break;
...
{ BA.debugLineNum = 352;BA.debugLine="Else If camera = \"236967\" Then";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean("=",_camera,BA.ObjectToString("236967"))) { 
this.state = 11;
}else 
{ BA.debugLineNum = 354;BA.debugLine="Else If camera = \"226821\" Then";
Debug.ShouldStop(2);
...
//C
this.state = 14;
 BA.debugLineNum = 351;BA.debugLine="Dim out As OutputStream = File.OpenOutput(File";
Debug.ShouldStop(1073741824);
...
//C
this.state = 14;
 BA.debugLineNum = 353;BA.debugLine="Dim out As OutputStream = File.OpenOutput(File";
Debug.ShouldStop(1);
_out = RemoteObject.createNew ("anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper");
...
//C
this.state = 14;
 BA.debugLineNum = 355;BA.debugLine="Dim out As OutputStream = File.OpenOutput(File";
Debug.ShouldStop(4);
_out = RemoteObject.createNew ("anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper");
...
this.state = 17;
;
 BA.debugLineNum = 357;BA.debugLine="File.Copy2(j.GetInputStream, out)";
Debug.ShouldStop(16);
parent.__c.getField(false,"File").runVoidMethod ("Copy2",(Object)((_j.runClassMethod (cloyd.blink.httpjob.class, "_getinputstream" /*RemoteObject*/ ).getObject())),(Object)((_out.getObject())));
 BA.debugLineNum = 358;BA.debugLine="out.Close '<------ very important";
Debug.ShouldStop(32);
_out.runVoidMethod ("Close");
 BA.debugLineNum = 361;BA.debugLine="iv.SetImage(j.GetBitmap)";
Debug.ShouldStop(256);
...
//C
this.state = 17;
 BA.debugLineNum = 363;BA.debugLine="response = \"ERROR: \" & j.ErrorMessage";
Debug.ShouldStop(1024);
parent._response = RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ ));
 BA.debugLineNum = 364;BA.debugLine="lblStatus.Text = \"ERROR: \" & j.ErrorMessage";
Debug.ShouldStop(2048);
...
this.state = 20;
this.catchState = 0;
 BA.debugLineNum = 368;BA.debugLine="lblStatus.Text = \"DownloadImage LastException: \"";
Debug.ShouldStop(32768);
parent._lblstatus.runMethod(true,"setText",RemoteObject.concat(RemoteObject.createImmutable("DownloadImage LastException: "),parent.__c.runMethod(false,"LastException",main.ba)));
 BA.debugLineNum = 369;BA.debugLine="Log(LastException)";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("Get_css (main) ","main",0,main.ba,main.mostCurrent,815);
...
RemoteObject _stylesheets = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 815;BA.debugLine="Public Sub Get_css";
Debug.ShouldStop(16384);
 BA.debugLineNum = 816;BA.debugLine="Try";
Debug.ShouldStop(32768);
try { BA.debugLineNum = 817;BA.debugLine="Dim jForm As JavaObject = MainForm";
Debug.ShouldStop(65536);
...
_jform.setObject(main._mainform);Debug.locals.put("jForm", _jform);
 BA.debugLineNum = 818;BA.debugLine="Dim scene As JavaObject = jForm.GetField(\"scene\"";
Debug.ShouldStop(131072);
...
_scene.setObject(_jform.runMethod(false,"GetField",(Object)(RemoteObject.createImmutable("scene"))));Debug.locals.put("scene", _scene);
 BA.debugLineNum = 819;BA.debugLine="Dim stylesheets As List = scene.RunMethod(\"getSt";
Debug.ShouldStop(262144);
...
_stylesheets.setObject(_scene.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getStylesheets")),(Object)((main.__c.getField(false,"Null")))));Debug.locals.put("stylesheets", _stylesheets);
 BA.debugLineNum = 820;BA.debugLine="stylesheets.Clear";
Debug.ShouldStop(524288);
_stylesheets.runVoidMethod ("Clear");
 BA.debugLineNum = 821;BA.debugLine="stylesheets.Add(File.GetUri(File.DirAssets, imgI";
Debug.ShouldStop(1048576);
_stylesheets.runVoidMethod ("Add",(Object)((main.__c.getField(false,"File").runMethod(true,"GetUri",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.concat(main._imginit,RemoteObject.createImmutable(".css")))))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e8.toString()); BA.debugLineNum = 823;BA.debugLine="Log(LastException)";
Debug.ShouldStop(4194304);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 };
...
try {
		Debug.PushSubsStack("GetAllCameras (main) ","main",0,main.ba,main.mostCurrent,432);
...
Debug.locals.put("json", _json);
 BA.debugLineNum = 432;BA.debugLine="Sub GetAllCameras(json As String)";
Debug.ShouldStop(32768);
 BA.debugLineNum = 433;BA.debugLine="Try";
Debug.ShouldStop(65536);
try { BA.debugLineNum = 434;BA.debugLine="lblStatus.Text = \"Getting all cameras informatio";
Debug.ShouldStop(131072);
main._lblstatus.runMethod(true,"setText",BA.ObjectToString("Getting all cameras information..."));
 BA.debugLineNum = 435;BA.debugLine="Dim parser As JSONParser";
Debug.ShouldStop(262144);
_parser = RemoteObject.createNew ("anywheresoftware.b4j.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 436;BA.debugLine="parser.Initialize(json)";
Debug.ShouldStop(524288);
_parser.runVoidMethod ("Initialize",(Object)(_json));
 BA.debugLineNum = 437;BA.debugLine="Dim root As Map = parser.NextObject";
Debug.ShouldStop(1048576);
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _parser.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 441;BA.debugLine="Dim networks As List = root.Get(\"networks\")";
Debug.ShouldStop(16777216);
...
_networks.setObject(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("networks")))));Debug.locals.put("networks", _networks);
 BA.debugLineNum = 442;BA.debugLine="For Each colnetworks As Map In networks";
Debug.ShouldStop(33554432);
...
Debug.locals.put("colnetworks", _colnetworks);
 BA.debugLineNum = 451;BA.debugLine="networkID = colnetworks.Get(\"network_id\")";
Debug.ShouldStop(4);
main._networkid = BA.ObjectToString(_colnetworks.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("network_id")))));
 BA.debugLineNum = 452;BA.debugLine="Log(\"networkID: \" &  networkID)";
Debug.ShouldStop(8);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e12.toString()); BA.debugLineNum = 456;BA.debugLine="Log(LastException)";
Debug.ShouldStop(128);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 457;BA.debugLine="lblStatus.Text = \"GetAllCameras LastException: \"";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("GetAuthInfo (main) ","main",0,main.ba,main.mostCurrent,374);
...
Debug.locals.put("json", _json);
 BA.debugLineNum = 374;BA.debugLine="Sub GetAuthInfo(json As String)";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 375;BA.debugLine="Try";
Debug.ShouldStop(4194304);
try { BA.debugLineNum = 376;BA.debugLine="lblStatus.Text = \"Getting authtoken...\"";
Debug.ShouldStop(8388608);
...
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _parser.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 380;BA.debugLine="Dim authtokenmap As Map = root.Get(\"authtoken\")";
Debug.ShouldStop(134217728);
...
_region.setObject(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("region")))));Debug.locals.put("region", _region);
 BA.debugLineNum = 391;BA.debugLine="userRegion = region.GetKeyAt(0)";
Debug.ShouldStop(64);
main._userregion = BA.ObjectToString(_region.runMethod(false,"GetKeyAt",(Object)(BA.numberCast(int.class, 0))));
 BA.debugLineNum = 392;BA.debugLine="Log(\"userRegion: \" &  userRegion)";
Debug.ShouldStop(128);
main.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("userRegion: "),main._userregion)));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e13) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e13.toString()); BA.debugLineNum = 397;BA.debugLine="Log(LastException)";
Debug.ShouldStop(4096);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 398;BA.debugLine="lblStatus.Text = \"GetAuthInfo LastException: \" &";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("GetCameraInfo (main) ","main",0,main.ba,main.mostCurrent,521);
...
Debug.locals.put("clv", _clv);
 BA.debugLineNum = 521;BA.debugLine="Sub GetCameraInfo(json As String, clv As CustomLis";
Debug.ShouldStop(256);
 BA.debugLineNum = 522;BA.debugLine="Try";
Debug.ShouldStop(512);
try { BA.debugLineNum = 523;BA.debugLine="Dim parser As JSONParser";
Debug.ShouldStop(1024);
_parser = RemoteObject.createNew ("anywheresoftware.b4j.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 524;BA.debugLine="parser.Initialize(json)";
Debug.ShouldStop(2048);
_parser.runVoidMethod ("Initialize",(Object)(_json));
...
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _parser.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 526;BA.debugLine="Dim camera_status As Map = root.Get(\"camera_stat";
Debug.ShouldStop(8192);
...
_camera_status.setObject(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("camera_status")))));Debug.locals.put("camera_status", _camera_status);
 BA.debugLineNum = 527;BA.debugLine="Dim total_108_wakeups As Int = camera_status.Get";
Debug.ShouldStop(16384);
_total_108_wakeups = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("total_108_wakeups")))));Debug.locals.put("total_108_wakeups", _total_108_wakeups);Debug.locals.put("total_108_wakeups", _total_108_wakeups);
 BA.debugLineNum = 528;BA.debugLine="Dim battery_voltage As Int = camera_status.Get(\"";
Debug.ShouldStop(32768);
_battery_voltage = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("battery_voltage")))));Debug.locals.put("battery_voltage", _battery_voltage);Debug.locals.put("battery_voltage", _battery_voltage);
 BA.debugLineNum = 529;BA.debugLine="Dim light_sensor_data_valid As String = camera_s";
Debug.ShouldStop(65536);
_light_sensor_data_valid = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("light_sensor_data_valid")))));Debug.locals.put("light_sensor_data_valid", _light_sensor_data_valid);Debug.locals.put("light_sensor_data_valid", _light_sensor_data_valid);
 BA.debugLineNum = 530;BA.debugLine="Dim lfr_tb_wakeups As Int = camera_status.Get(\"l";
Debug.ShouldStop(131072);
_lfr_tb_wakeups = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("lfr_tb_wakeups")))));Debug.locals.put("lfr_tb_wakeups", _lfr_tb_wakeups);Debug.locals.put("lfr_tb_wakeups", _lfr_tb_wakeups);
 BA.debugLineNum = 531;BA.debugLine="Dim fw_git_hash As String = camera_status.Get(\"f";
Debug.ShouldStop(262144);
_fw_git_hash = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("fw_git_hash")))));Debug.locals.put("fw_git_hash", _fw_git_hash);Debug.locals.put("fw_git_hash", _fw_git_hash);
 BA.debugLineNum = 532;BA.debugLine="Dim wifi_strength As Int = camera_status.Get(\"wi";
Debug.ShouldStop(524288);
_wifi_strength = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("wifi_strength")))));Debug.locals.put("wifi_strength", _wifi_strength);Debug.locals.put("wifi_strength", _wifi_strength);
 BA.debugLineNum = 533;BA.debugLine="Dim lfr_strength As Int = camera_status.Get(\"lfr";
Debug.ShouldStop(1048576);
_lfr_strength = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("lfr_strength")))));Debug.locals.put("lfr_strength", _lfr_strength);Debug.locals.put("lfr_strength", _lfr_strength);
 BA.debugLineNum = 534;BA.debugLine="Dim total_tb_wakeups As Int = camera_status.Get(";
Debug.ShouldStop(2097152);
_total_tb_wakeups = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("total_tb_wakeups")))));Debug.locals.put("total_tb_wakeups", _total_tb_wakeups);Debug.locals.put("total_tb_wakeups", _total_tb_wakeups);
 BA.debugLineNum = 535;BA.debugLine="Dim created_at As String = camera_status.Get(\"cr";
Debug.ShouldStop(4194304);
_created_at = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("created_at")))));Debug.locals.put("created_at", _created_at);Debug.locals.put("created_at", _created_at);
 BA.debugLineNum = 536;BA.debugLine="Dim light_sensor_ch0 As Int = camera_status.Get(";
Debug.ShouldStop(8388608);
_light_sensor_ch0 = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("light_sensor_ch0")))));Debug.locals.put("light_sensor_ch0", _light_sensor_ch0);Debug.locals.put("light_sensor_ch0", _light_sensor_ch0);
 BA.debugLineNum = 537;BA.debugLine="Dim mac As String = camera_status.Get(\"mac\")";
Debug.ShouldStop(16777216);
_mac = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("mac")))));Debug.locals.put("mac", _mac);Debug.locals.put("mac", _mac);
 BA.debugLineNum = 538;BA.debugLine="Dim unit_number As Int = camera_status.Get(\"unit";
Debug.ShouldStop(33554432);
_unit_number = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("unit_number")))));Debug.locals.put("unit_number", _unit_number);Debug.locals.put("unit_number", _unit_number);
 BA.debugLineNum = 539;BA.debugLine="Dim updated_at As String = camera_status.Get(\"up";
Debug.ShouldStop(67108864);
_updated_at = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("updated_at")))));Debug.locals.put("updated_at", _updated_at);Debug.locals.put("updated_at", _updated_at);
 BA.debugLineNum = 540;BA.debugLine="Dim light_sensor_ch1 As Int = camera_status.Get(";
Debug.ShouldStop(134217728);
_light_sensor_ch1 = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("light_sensor_ch1")))));Debug.locals.put("light_sensor_ch1", _light_sensor_ch1);Debug.locals.put("light_sensor_ch1", _light_sensor_ch1);
 BA.debugLineNum = 541;BA.debugLine="Dim time_dhcp_lease As Int = camera_status.Get(\"";
Debug.ShouldStop(268435456);
_time_dhcp_lease = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("time_dhcp_lease")))));Debug.locals.put("time_dhcp_lease", _time_dhcp_lease);Debug.locals.put("time_dhcp_lease", _time_dhcp_lease);
 BA.debugLineNum = 542;BA.debugLine="Dim temperature As Int = camera_status.Get(\"temp";
Debug.ShouldStop(536870912);
_temperature = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("temperature")))));Debug.locals.put("temperature", _temperature);Debug.locals.put("temperature", _temperature);
 BA.debugLineNum = 543;BA.debugLine="Dim time_first_video As Int = camera_status.Get(";
Debug.ShouldStop(1073741824);
_time_first_video = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("time_first_video")))));Debug.locals.put("time_first_video", _time_first_video);Debug.locals.put("time_first_video", _time_first_video);
 BA.debugLineNum = 544;BA.debugLine="Dim time_dns_resolve As Int = camera_status.Get(";
Debug.ShouldStop(-2147483648);
_time_dns_resolve = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("time_dns_resolve")))));Debug.locals.put("time_dns_resolve", _time_dns_resolve);Debug.locals.put("time_dns_resolve", _time_dns_resolve);
 BA.debugLineNum = 545;BA.debugLine="Dim id As Int = camera_status.Get(\"id\")";
Debug.ShouldStop(1);
_id = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("id")))));Debug.locals.put("id", _id);Debug.locals.put("id", _id);
 BA.debugLineNum = 546;BA.debugLine="Dim temp_alert_status As String = camera_status.";
Debug.ShouldStop(2);
_temp_alert_status = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("temp_alert_status")))));Debug.locals.put("temp_alert_status", _temp_alert_status);Debug.locals.put("temp_alert_status", _temp_alert_status);
 BA.debugLineNum = 547;BA.debugLine="Dim time_108_boot As Int = camera_status.Get(\"ti";
Debug.ShouldStop(4);
_time_108_boot = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("time_108_boot")))));Debug.locals.put("time_108_boot", _time_108_boot);Debug.locals.put("time_108_boot", _time_108_boot);
 BA.debugLineNum = 548;BA.debugLine="Dim lfr_108_wakeups As Int = camera_status.Get(\"";
Debug.ShouldStop(8);
...
_lifetime_duration = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("lifetime_duration")))));Debug.locals.put("lifetime_duration", _lifetime_duration);Debug.locals.put("lifetime_duration", _lifetime_duration);
 BA.debugLineNum = 552;BA.debugLine="Dim wifi_connect_failure_count As Int = camera_s";
Debug.ShouldStop(128);
_wifi_connect_failure_count = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("wifi_connect_failure_count")))));Debug.locals.put("wifi_connect_failure_count", _wifi_connect_failure_count);Debug.locals.put("wifi_connect_failure_count", _wifi_connect_failure_count);
 BA.debugLineNum = 553;BA.debugLine="Dim camera_id As Int = camera_status.Get(\"camera";
Debug.ShouldStop(256);
_camera_id = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("camera_id")))));Debug.locals.put("camera_id", _camera_id);Debug.locals.put("camera_id", _camera_id);
 BA.debugLineNum = 554;BA.debugLine="Dim battery_alert_status As String = camera_stat";
Debug.ShouldStop(512);
_battery_alert_status = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("battery_alert_status")))));Debug.locals.put("battery_alert_status", _battery_alert_status);Debug.locals.put("battery_alert_status", _battery_alert_status);
 BA.debugLineNum = 555;BA.debugLine="Dim dhcp_failure_count As Int = camera_status.Ge";
Debug.ShouldStop(1024);
_dhcp_failure_count = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("dhcp_failure_count")))));Debug.locals.put("dhcp_failure_count", _dhcp_failure_count);Debug.locals.put("dhcp_failure_count", _dhcp_failure_count);
 BA.debugLineNum = 556;BA.debugLine="Dim ip_address As String = camera_status.Get(\"ip";
Debug.ShouldStop(2048);
_ip_address = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("ip_address")))));Debug.locals.put("ip_address", _ip_address);Debug.locals.put("ip_address", _ip_address);
 BA.debugLineNum = 557;BA.debugLine="Dim ipv As String = camera_status.Get(\"ipv\")";
Debug.ShouldStop(4096);
_ipv = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("ipv")))));Debug.locals.put("ipv", _ipv);Debug.locals.put("ipv", _ipv);
 BA.debugLineNum = 558;BA.debugLine="Dim light_sensor_data_new As String = camera_sta";
Debug.ShouldStop(8192);
_light_sensor_data_new = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("light_sensor_data_new")))));Debug.locals.put("light_sensor_data_new", _light_sensor_data_new);Debug.locals.put("light_sensor_data_new", _light_sensor_data_new);
 BA.debugLineNum = 559;BA.debugLine="Dim network_id As Int = camera_status.Get(\"netwo";
Debug.ShouldStop(16384);
_network_id = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("network_id")))));Debug.locals.put("network_id", _network_id);Debug.locals.put("network_id", _network_id);
 BA.debugLineNum = 560;BA.debugLine="Dim account_id As Int = camera_status.Get(\"accou";
Debug.ShouldStop(32768);
_account_id = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("account_id")))));Debug.locals.put("account_id", _account_id);Debug.locals.put("account_id", _account_id);
 BA.debugLineNum = 561;BA.debugLine="Dim serial As String = camera_status.Get(\"serial";
Debug.ShouldStop(65536);
_serial = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("serial")))));Debug.locals.put("serial", _serial);Debug.locals.put("serial", _serial);
 BA.debugLineNum = 562;BA.debugLine="Dim dev_1 As Int = camera_status.Get(\"dev_1\")";
Debug.ShouldStop(131072);
_dev_1 = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("dev_1")))));Debug.locals.put("dev_1", _dev_1);Debug.locals.put("dev_1", _dev_1);
 BA.debugLineNum = 563;BA.debugLine="Dim time_wlan_connect As Int = camera_status.Get";
Debug.ShouldStop(262144);
_time_wlan_connect = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("time_wlan_connect")))));Debug.locals.put("time_wlan_connect", _time_wlan_connect);Debug.locals.put("time_wlan_connect", _time_wlan_connect);
 BA.debugLineNum = 564;BA.debugLine="Dim dev_2 As Int = camera_status.Get(\"dev_2\")";
Debug.ShouldStop(524288);
_dev_2 = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("dev_2")))));Debug.locals.put("dev_2", _dev_2);Debug.locals.put("dev_2", _dev_2);
 BA.debugLineNum = 565;BA.debugLine="Dim socket_failure_count As Int = camera_status.";
Debug.ShouldStop(1048576);
_socket_failure_count = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("socket_failure_count")))));Debug.locals.put("socket_failure_count", _socket_failure_count);Debug.locals.put("socket_failure_count", _socket_failure_count);
 BA.debugLineNum = 566;BA.debugLine="Dim dev_3 As Int = camera_status.Get(\"dev_3\")";
Debug.ShouldStop(2097152);
_dev_3 = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("dev_3")))));Debug.locals.put("dev_3", _dev_3);Debug.locals.put("dev_3", _dev_3);
 BA.debugLineNum = 567;BA.debugLine="Dim pir_rejections As Int = camera_status.Get(\"p";
Debug.ShouldStop(4194304);
_pir_rejections = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("pir_rejections")))));Debug.locals.put("pir_rejections", _pir_rejections);Debug.locals.put("pir_rejections", _pir_rejections);
 BA.debugLineNum = 568;BA.debugLine="Dim sync_module_id As Int = camera_status.Get(\"s";
Debug.ShouldStop(8388608);
_sync_module_id = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("sync_module_id")))));Debug.locals.put("sync_module_id", _sync_module_id);Debug.locals.put("sync_module_id", _sync_module_id);
 BA.debugLineNum = 569;BA.debugLine="Dim lifetime_count As Int = camera_status.Get(\"l";
Debug.ShouldStop(16777216);
_lifetime_count = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("lifetime_count")))));Debug.locals.put("lifetime_count", _lifetime_count);Debug.locals.put("lifetime_count", _lifetime_count);
 BA.debugLineNum = 570;BA.debugLine="Dim error_codes As Int = camera_status.Get(\"erro";
Debug.ShouldStop(33554432);
_error_codes = BA.numberCast(int.class, _camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("error_codes")))));Debug.locals.put("error_codes", _error_codes);Debug.locals.put("error_codes", _error_codes);
 BA.debugLineNum = 571;BA.debugLine="Dim fw_version As String = camera_status.Get(\"fw";
Debug.ShouldStop(67108864);
_fw_version = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("fw_version")))));Debug.locals.put("fw_version", _fw_version);Debug.locals.put("fw_version", _fw_version);
 BA.debugLineNum = 572;BA.debugLine="Dim ac_power As String = camera_status.Get(\"ac_p";
Debug.ShouldStop(134217728);
_ac_power = BA.ObjectToString(_camera_status.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("ac_power")))));Debug.locals.put("ac_power", _ac_power);Debug.locals.put("ac_power", _ac_power);
 BA.debugLineNum = 574;BA.debugLine="clv.Clear";
Debug.ShouldStop(536870912);
_clv.runVoidMethod ("_clear");
 BA.debugLineNum = 575;BA.debugLine="clv.AddTextItem(\"Battery voltage: \" & NumberForm";
Debug.ShouldStop(1073741824);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Battery voltage: "),main.__c.runMethod(true,"NumberFormat",(Object)((RemoteObject.solve(new RemoteObject[] {_battery_voltage,RemoteObject.createImmutable(100)}, "/",0, 0))),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 2))),RemoteObject.createImmutable("V - "),_checkbattlife(_battery_voltage)))),(Object)((RemoteObject.createImmutable("battery_voltage"))));
 BA.debugLineNum = 576;BA.debugLine="clv.AddTextItem(\"Camera to WiFi strength: \" & wi";
Debug.ShouldStop(-2147483648);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Camera to WiFi strength: "),_wifi_strength,RemoteObject.createImmutable(" - "),_checklfrlevel(_wifi_strength)))),(Object)((RemoteObject.createImmutable("wifi_strength"))));
 BA.debugLineNum = 577;BA.debugLine="clv.AddTextItem(\"Camera to Sync Module strength";
Debug.ShouldStop(1);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Camera to Sync Module strength (LFR): "),_lfr_strength,RemoteObject.createImmutable(" - "),_checklfrlevel(_lfr_strength)))),(Object)((RemoteObject.createImmutable("lfr_strength"))));
 BA.debugLineNum = 578;BA.debugLine="clv.AddTextItem(\"Temperature: \" & temperature &";
Debug.ShouldStop(2);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Temperature: "),_temperature,RemoteObject.createImmutable("ºF")))),(Object)((RemoteObject.createImmutable("temperature"))));
 BA.debugLineNum = 579;BA.debugLine="clv.AddTextItem(\"Firmware version: \" & fw_versio";
Debug.ShouldStop(4);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Firmware version: "),_fw_version))),(Object)((RemoteObject.createImmutable("fw_version"))));
 BA.debugLineNum = 580;BA.debugLine="clv.AddTextItem(\"Firmware Git Hash: \" & fw_git_h";
Debug.ShouldStop(8);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Firmware Git Hash: "),_fw_git_hash))),(Object)((RemoteObject.createImmutable("fw_git_hash"))));
 BA.debugLineNum = 581;BA.debugLine="clv.AddTextItem(\"Battery alert status: \" & batte";
Debug.ShouldStop(16);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Battery alert status: "),_battery_alert_status))),(Object)((RemoteObject.createImmutable("battery_alert_status"))));
 BA.debugLineNum = 582;BA.debugLine="clv.AddTextItem(\"Temperature alert status: \" & t";
Debug.ShouldStop(32);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Temperature alert status: "),_temp_alert_status))),(Object)((RemoteObject.createImmutable("temp_alert_status"))));
 BA.debugLineNum = 583;BA.debugLine="clv.AddTextItem(\"Updated at: \" & ConvertDateTime";
Debug.ShouldStop(64);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Updated at: "),_convertdatetime(_updated_at)))),(Object)((RemoteObject.createImmutable("updated_at"))));
 BA.debugLineNum = 584;BA.debugLine="clv.AddTextItem(\"Created at: \" & ConvertDateTime";
Debug.ShouldStop(128);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Created at: "),_convertdatetime(_created_at)))),(Object)((RemoteObject.createImmutable("created_at"))));
 BA.debugLineNum = 585;BA.debugLine="clv.AddTextItem(\"IP address: \" & ip_address, \"ip";
Debug.ShouldStop(256);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("IP address: "),_ip_address))),(Object)((RemoteObject.createImmutable("ip_address"))));
 BA.debugLineNum = 586;BA.debugLine="clv.AddTextItem(\"MAC address: \" & mac, \"mac\")";
Debug.ShouldStop(512);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("MAC address: "),_mac))),(Object)((RemoteObject.createImmutable("mac"))));
 BA.debugLineNum = 587;BA.debugLine="clv.AddTextItem(\"Camera ID: \" & camera_id, \"came";
Debug.ShouldStop(1024);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Camera ID: "),_camera_id))),(Object)((RemoteObject.createImmutable("camera_id"))));
 BA.debugLineNum = 588;BA.debugLine="clv.AddTextItem(\"Serial: \" & serial, \"serial\")";
Debug.ShouldStop(2048);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Serial: "),_serial))),(Object)((RemoteObject.createImmutable("serial"))));
 BA.debugLineNum = 589;BA.debugLine="clv.AddTextItem(\"Network ID: \" & network_id, \"ne";
Debug.ShouldStop(4096);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Network ID: "),_network_id))),(Object)((RemoteObject.createImmutable("network_id"))));
 BA.debugLineNum = 590;BA.debugLine="clv.AddTextItem(\"Account ID: \" & account_id, \"ac";
Debug.ShouldStop(8192);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Account ID: "),_account_id))),(Object)((RemoteObject.createImmutable("account_id"))));
 BA.debugLineNum = 591;BA.debugLine="clv.AddTextItem(\"ID: \" & id, \"id\")";
Debug.ShouldStop(16384);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("ID: "),_id))),(Object)((RemoteObject.createImmutable("id"))));
 BA.debugLineNum = 592;BA.debugLine="clv.AddTextItem(\"Sync Module ID: \" & sync_module";
Debug.ShouldStop(32768);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Sync Module ID: "),_sync_module_id))),(Object)((RemoteObject.createImmutable("sync_module_id"))));
 BA.debugLineNum = 593;BA.debugLine="clv.AddTextItem(\"Light sensor data valid: \" & li";
Debug.ShouldStop(65536);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Light sensor data valid: "),_light_sensor_data_valid))),(Object)((RemoteObject.createImmutable("light_sensor_data_valid"))));
 BA.debugLineNum = 594;BA.debugLine="clv.AddTextItem(\"DHCP failure count: \" & dhcp_fa";
Debug.ShouldStop(131072);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("DHCP failure count: "),_dhcp_failure_count))),(Object)((RemoteObject.createImmutable("dhcp_failure_count"))));
 BA.debugLineNum = 595;BA.debugLine="clv.AddTextItem(\"LFR tb wakeups: \" & lfr_tb_wake";
Debug.ShouldStop(262144);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("LFR tb wakeups: "),_lfr_tb_wakeups))),(Object)((RemoteObject.createImmutable("lfr_tb_wakeups"))));
 BA.debugLineNum = 596;BA.debugLine="clv.AddTextItem(\"Socket failure count: \" & socke";
Debug.ShouldStop(524288);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Socket failure count: "),_socket_failure_count))),(Object)((RemoteObject.createImmutable("socket_failure_count"))));
 BA.debugLineNum = 597;BA.debugLine="clv.AddTextItem(\"Camera thumbnail: \" & cameraThu";
Debug.ShouldStop(1048576);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Camera thumbnail: "),main._camerathumbnail))),(Object)((RemoteObject.createImmutable("thumbnail"))));
 BA.debugLineNum = 598;BA.debugLine="clv.AddTextItem(\"WiFi connect failure count: \" &";
Debug.ShouldStop(2097152);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("WiFi connect failure count: "),_wifi_connect_failure_count))),(Object)((RemoteObject.createImmutable("wifi_connect_failure_count"))));
 BA.debugLineNum = 599;BA.debugLine="clv.AddTextItem(\"Error codes: \" & error_codes, \"";
Debug.ShouldStop(4194304);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Error codes: "),_error_codes))),(Object)((RemoteObject.createImmutable("error_codes"))));
 BA.debugLineNum = 600;BA.debugLine="clv.AddTextItem(\"AC power: \" & ac_power, \"ac_pow";
Debug.ShouldStop(8388608);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("AC power: "),_ac_power))),(Object)((RemoteObject.createImmutable("ac_power"))));
 BA.debugLineNum = 601;BA.debugLine="clv.AddTextItem(\"Total 108 wakeups: \" & total_10";
Debug.ShouldStop(16777216);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Total 108 wakeups: "),_total_108_wakeups))),(Object)((RemoteObject.createImmutable("total_108_wakeups"))));
 BA.debugLineNum = 602;BA.debugLine="clv.AddTextItem(\"Total Tb wakeups: \" & total_tb_";
Debug.ShouldStop(33554432);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Total Tb wakeups: "),_total_tb_wakeups))),(Object)((RemoteObject.createImmutable("total_tb_wakeups"))));
 BA.debugLineNum = 603;BA.debugLine="clv.AddTextItem(\"Light sensor ch0: \" & light_sen";
Debug.ShouldStop(67108864);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Light sensor ch0: "),_light_sensor_ch0))),(Object)((RemoteObject.createImmutable("light_sensor_ch0"))));
 BA.debugLineNum = 604;BA.debugLine="clv.AddTextItem(\"Unit number: \" & unit_number, \"";
Debug.ShouldStop(134217728);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Unit number: "),_unit_number))),(Object)((RemoteObject.createImmutable("unit_number"))));
 BA.debugLineNum = 605;BA.debugLine="clv.AddTextItem(\"Light sensor ch1: \" & light_sen";
Debug.ShouldStop(268435456);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Light sensor ch1: "),_light_sensor_ch1))),(Object)((RemoteObject.createImmutable("light_sensor_ch1"))));
 BA.debugLineNum = 606;BA.debugLine="clv.AddTextItem(\"Time dhcp lease: \" & time_dhcp_";
Debug.ShouldStop(536870912);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Time dhcp lease: "),_time_dhcp_lease))),(Object)((RemoteObject.createImmutable("time_dhcp_lease"))));
 BA.debugLineNum = 607;BA.debugLine="clv.AddTextItem(\"Time first video: \" & time_firs";
Debug.ShouldStop(1073741824);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Time first video: "),_time_first_video))),(Object)((RemoteObject.createImmutable("time_first_video"))));
 BA.debugLineNum = 608;BA.debugLine="clv.AddTextItem(\"Time dns resolve: \" & time_dns_";
Debug.ShouldStop(-2147483648);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Time dns resolve: "),_time_dns_resolve))),(Object)((RemoteObject.createImmutable("time_dns_resolve"))));
 BA.debugLineNum = 609;BA.debugLine="clv.AddTextItem(\"Time 108 boot: \" & time_108_boo";
Debug.ShouldStop(1);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Time 108 boot: "),_time_108_boot))),(Object)((RemoteObject.createImmutable("time_108_boot"))));
 BA.debugLineNum = 610;BA.debugLine="clv.AddTextItem(\"LFR 108 wakeups: \" & lfr_108_wa";
Debug.ShouldStop(2);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("LFR 108 wakeups: "),_lfr_108_wakeups))),(Object)((RemoteObject.createImmutable("lfr_108_wakeups"))));
 BA.debugLineNum = 611;BA.debugLine="clv.AddTextItem(\"lifetime duration: \" & lifetime";
Debug.ShouldStop(4);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("lifetime duration: "),_lifetime_duration))),(Object)((RemoteObject.createImmutable("lifetime_duration"))));
 BA.debugLineNum = 612;BA.debugLine="clv.AddTextItem(\"lpv: \" & ipv, \"ipv\")";
Debug.ShouldStop(8);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("lpv: "),_ipv))),(Object)((RemoteObject.createImmutable("ipv"))));
 BA.debugLineNum = 613;BA.debugLine="clv.AddTextItem(\"light sensor data new: \" & ligh";
Debug.ShouldStop(16);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("light sensor data new: "),_light_sensor_data_new))),(Object)((RemoteObject.createImmutable("light_sensor_data_new"))));
 BA.debugLineNum = 614;BA.debugLine="clv.AddTextItem(\"Dev_1: \" & dev_1, \"dev_1\")";
Debug.ShouldStop(32);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Dev_1: "),_dev_1))),(Object)((RemoteObject.createImmutable("dev_1"))));
 BA.debugLineNum = 615;BA.debugLine="clv.AddTextItem(\"Dev_2: \" & dev_2, \"dev_2\")";
Debug.ShouldStop(64);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Dev_2: "),_dev_2))),(Object)((RemoteObject.createImmutable("dev_2"))));
 BA.debugLineNum = 616;BA.debugLine="clv.AddTextItem(\"Dev_3: \" & dev_3, \"dev_3\")";
Debug.ShouldStop(128);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Dev_3: "),_dev_3))),(Object)((RemoteObject.createImmutable("dev_3"))));
 BA.debugLineNum = 617;BA.debugLine="clv.AddTextItem(\"Time wlan connect: \" & time_wla";
Debug.ShouldStop(256);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Time wlan connect: "),_time_wlan_connect))),(Object)((RemoteObject.createImmutable("time_wlan_connect"))));
 BA.debugLineNum = 618;BA.debugLine="clv.AddTextItem(\"PIR rejections: \" & pir_rejecti";
Debug.ShouldStop(512);
_clv.runVoidMethod ("_addtextitem",(Object)((RemoteObject.concat(RemoteObject.createImmutable("PIR rejections: "),_pir_rejections))),(Object)((RemoteObject.createImmutable("pir_rejections"))));
 BA.debugLineNum = 619;BA.debugLine="clv.AddTextItem(\"Lifetime count: \" & lifetime_co";
Debug.ShouldStop(1024);
...
_clv.runVoidMethod ("_resizeitem",(Object)(BA.numberCast(int.class, _i)),(Object)(main.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 80)))));
 ...
 BA.debugLineNum = 638;BA.debugLine="clv.ResizeItem(i,35dip)";
Debug.ShouldStop(536870912);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e118.toString()); BA.debugLineNum = 642;BA.debugLine="Log(LastException)";
Debug.ShouldStop(2);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 643;BA.debugLine="lblStatus.Text = \"GetCameraInfo LastException: \"";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("GetCommandID (main) ","main",0,main.ba,main.mostCurrent,461);
if (RapidSub.canDelegate("getcommandid")) { return cloyd.blink.main.remoteMe.runUserSub(false, "main","getcommandid", _json);}
RemoteObject _parser = RemoteObject.declareNull("anywheresoftware.b4j.objects.collections.JSONParser");
RemoteObject _root = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
Debug.locals.put("json", _json);
 BA.debugLineNum = 461;BA.debugLine="Sub GetCommandID(json As String)";
Debug.ShouldStop(4096);
 BA.debugLineNum = 462;BA.debugLine="Try";
Debug.ShouldStop(8192);
try { BA.debugLineNum = 463;BA.debugLine="Dim parser As JSONParser";
Debug.ShouldStop(16384);
_parser = RemoteObject.createNew ("anywheresoftware.b4j.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 464;BA.debugLine="parser.Initialize(json)";
Debug.ShouldStop(32768);
_parser.runVoidMethod ("Initialize",(Object)(_json));
 BA.debugLineNum = 465;BA.debugLine="Dim root As Map = parser.NextObject";
Debug.ShouldStop(65536);
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _parser.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 480;BA.debugLine="commandID = root.Get(\"id\")";
Debug.ShouldStop(-2147483648);
main._commandid = BA.ObjectToString(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("id")))));
 BA.debugLineNum = 481;BA.debugLine="Log(\"commandID: \" & commandID)";
Debug.ShouldStop(1);
main.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("commandID: "),main._commandid)));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e8) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e8.toString()); BA.debugLineNum = 503;BA.debugLine="Log(LastException)";
Debug.ShouldStop(4194304);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 504;BA.debugLine="lblStatus.Text = \"GetCommandID LastException: \"";
Debug.ShouldStop(8388608);
...
try {
		Debug.PushSubsStack("GetCommandStatus (main) ","main",0,main.ba,main.mostCurrent,508);
if (RapidSub.canDelegate("getcommandstatus")) { return cloyd.blink.main.remoteMe.runUserSub(false, "main","getcommandstatus", _json);}
RemoteObject _parser = RemoteObject.declareNull("anywheresoftware.b4j.objects.collections.JSONParser");
RemoteObject _root = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
Debug.locals.put("json", _json);
 BA.debugLineNum = 508;BA.debugLine="Sub GetCommandStatus(json As String)";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 509;BA.debugLine="Try";
Debug.ShouldStop(268435456);
try { BA.debugLineNum = 510;BA.debugLine="Dim parser As JSONParser";
Debug.ShouldStop(536870912);
_parser = RemoteObject.createNew ("anywheresoftware.b4j.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 511;BA.debugLine="parser.Initialize(json)";
Debug.ShouldStop(1073741824);
_parser.runVoidMethod ("Initialize",(Object)(_json));
 BA.debugLineNum = 512;BA.debugLine="Dim root As Map = parser.NextObject";
Debug.ShouldStop(-2147483648);
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _parser.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 513;BA.debugLine="commandComplete = root.Get(\"complete\")";
Debug.ShouldStop(1);
main._commandcomplete = BA.ObjectToBoolean(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("complete")))));
 BA.debugLineNum = 514;BA.debugLine="Log(\"commandComplete: \" & commandComplete)";
Debug.ShouldStop(2);
main.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("commandComplete: "),main._commandcomplete)));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e8) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e8.toString()); BA.debugLineNum = 516;BA.debugLine="Log(LastException)";
Debug.ShouldStop(8);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 517;BA.debugLine="lblStatus.Text = \"GetCommandStatus LastException";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("GetSyncModuleInfo (main) ","main",0,main.ba,main.mostCurrent,647);
...
Debug.locals.put("json", _json);
 BA.debugLineNum = 647;BA.debugLine="Sub GetSyncModuleInfo(json As String)";
Debug.ShouldStop(64);
 BA.debugLineNum = 648;BA.debugLine="Try";
Debug.ShouldStop(128);
try { BA.debugLineNum = 649;BA.debugLine="Dim parser As JSONParser";
Debug.ShouldStop(256);
_parser = RemoteObject.createNew ("anywheresoftware.b4j.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 650;BA.debugLine="parser.Initialize(json)";
Debug.ShouldStop(512);
_parser.runVoidMethod ("Initialize",(Object)(_json));
 BA.debugLineNum = 651;BA.debugLine="Dim root As Map = parser.NextObject";
Debug.ShouldStop(1024);
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _parser.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 652;BA.debugLine="Dim syncmodule As Map = root.Get(\"syncmodule\")";
Debug.ShouldStop(2048);
...
_syncmodule.setObject(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("syncmodule")))));Debug.locals.put("syncmodule", _syncmodule);
 BA.debugLineNum = 656;BA.debugLine="Dim wifi_strength As Int = syncmodule.Get(\"wifi_";
Debug.ShouldStop(32768);
_wifi_strength = BA.numberCast(int.class, _syncmodule.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("wifi_strength")))));Debug.locals.put("wifi_strength", _wifi_strength);Debug.locals.put("wifi_strength", _wifi_strength);
 BA.debugLineNum = 657;BA.debugLine="Dim os_version As String = syncmodule.Get(\"os_ve";
Debug.ShouldStop(65536);
_os_version = BA.ObjectToString(_syncmodule.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("os_version")))));Debug.locals.put("os_version", _os_version);Debug.locals.put("os_version", _os_version);
 BA.debugLineNum = 674;BA.debugLine="Dim fw_version As String = syncmodule.Get(\"fw_ve";
Debug.ShouldStop(2);
_fw_version = BA.ObjectToString(_syncmodule.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("fw_version")))));Debug.locals.put("fw_version", _fw_version);Debug.locals.put("fw_version", _fw_version);
 BA.debugLineNum = 676;BA.debugLine="Dim status As String = syncmodule.Get(\"status\")";
Debug.ShouldStop(8);
_status = BA.ObjectToString(_syncmodule.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("status")))));Debug.locals.put("status", _status);Debug.locals.put("status", _status);
 BA.debugLineNum = 677;BA.debugLine="lblSyncModule.Text = \"Sync Module is \" & status";
Debug.ShouldStop(16);
main._lblsyncmodule.runMethod(true,"setText",RemoteObject.concat(RemoteObject.createImmutable("Sync Module is "),_status,RemoteObject.createImmutable(" | Wifi Strength: "),_wifi_strength,RemoteObject.createImmutable(" bars | Firmware version: "),_fw_version,RemoteObject.createImmutable(" | OS version: "),_os_version));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e12.toString()); BA.debugLineNum = 679;BA.debugLine="Log(LastException)";
Debug.ShouldStop(64);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 680;BA.debugLine="lblStatus.Text = \"GetSyncModuleInfo LastExceptio";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("GetUserInfo (main) ","main",0,main.ba,main.mostCurrent,403);
if (RapidSub.canDelegate("getuserinfo")) { return cloyd.blink.main.remoteMe.runUserSub(false, "main","getuserinfo", _json);}
RemoteObject _parser = RemoteObject.declareNull("anywheresoftware.b4j.objects.collections.JSONParser");
RemoteObject _root = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
Debug.locals.put("json", _json);
 BA.debugLineNum = 403;BA.debugLine="Sub GetUserInfo(json As String)";
Debug.ShouldStop(262144);
 BA.debugLineNum = 404;BA.debugLine="Try";
Debug.ShouldStop(524288);
try { BA.debugLineNum = 405;BA.debugLine="lblStatus.Text = \"Getting user information...\"";
Debug.ShouldStop(1048576);
...
Debug.ShouldStop(2097152);
_parser = RemoteObject.createNew ("anywheresoftware.b4j.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 407;BA.debugLine="parser.Initialize(json)";
Debug.ShouldStop(4194304);
_parser.runVoidMethod ("Initialize",(Object)(_json));
 BA.debugLineNum = 408;BA.debugLine="Dim root As Map = parser.NextObject";
Debug.ShouldStop(8388608);
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _parser.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 423;BA.debugLine="accountID = root.Get(\"account_id\") '88438";
Debug.ShouldStop(64);
main._accountid = BA.ObjectToString(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("account_id")))));
 BA.debugLineNum = 424;BA.debugLine="Log(\"accountID: \" &  accountID)";
Debug.ShouldStop(128);
main.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("accountID: "),main._accountid)));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e9) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e9.toString()); BA.debugLineNum = 427;BA.debugLine="Log(LastException)";
Debug.ShouldStop(1024);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 428;BA.debugLine="lblStatus.Text = \"GetUserInfo LastException: \" &";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("ivClose_MouseClicked (main) ","main",0,main.ba,main.mostCurrent,744);
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 744;BA.debugLine="Private Sub ivClose_MouseClicked (EventData As Mou";
Debug.ShouldStop(128);
 BA.debugLineNum = 745;BA.debugLine="File.Delete(File.DirApp, \"Driveway.jpg\")";
Debug.ShouldStop(256);
main.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("Driveway.jpg")));
 BA.debugLineNum = 746;BA.debugLine="File.Delete(File.DirApp, \"FrontDoor.jpg\")";
Debug.ShouldStop(512);
main.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("FrontDoor.jpg")));
 BA.debugLineNum = 747;BA.debugLine="File.Delete(File.DirApp, \"SideYard.jpg\")";
Debug.ShouldStop(1024);
main.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("SideYard.jpg")));
 BA.debugLineNum = 748;BA.debugLine="File.Delete(File.DirApp,\"screenshot.jpg\")";
Debug.ShouldStop(2048);
main.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("screenshot.jpg")));
 BA.debugLineNum = 749;BA.debugLine="File.Delete(File.DirApp,\"media.mp4\")";
Debug.ShouldStop(4096);
main.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("media.mp4")));
 BA.debugLineNum = 750;BA.debugLine="ExitApplication";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("ivDriveway_MouseClicked (main) ","main",0,main.ba,main.mostCurrent,871);
...
Debug.CheckDeviceExceptions();if (true) return ;
 BA.debugLineNum = 919;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immedia-s";
Debug.ShouldStop(4194304);
_restget(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/api/v1/accounts/88438/media/changed?since=2019-04-19T23:11:20+0000&page=1")));
...
this.state = -1;
;
 BA.debugLineNum = 922;BA.debugLine="Log(response)";
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("Log",(Object)(parent._response));
 BA.debugLineNum = 923;BA.debugLine="File.WriteString(File.DirApp,\"response.txt\",respo";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("ivFrontDoor_MouseClicked (main) ","main",0,main.ba,main.mostCurrent,956);
...
RemoteObject _mf = RemoteObject.declareNull("cloyd.blink.frmmedia");
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 956;BA.debugLine="Sub ivFrontDoor_MouseClicked (EventData As MouseEv";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 957;BA.debugLine="Dim mf As frmMedia";
Debug.ShouldStop(268435456);
_mf = RemoteObject.createNew ("cloyd.blink.frmmedia");Debug.locals.put("mf", _mf);
 BA.debugLineNum = 958;BA.debugLine="mf.Initialize(MainForm)";
Debug.ShouldStop(536870912);
_mf.runClassMethod (cloyd.blink.frmmedia.class, "_initialize" /*RemoteObject*/ ,main.ba,(Object)(main._mainform));
 BA.debugLineNum = 959;BA.debugLine="mf.timestamp = lblFrontDoor.Text";
Debug.ShouldStop(1073741824);
_mf.setField ("_timestamp" /*RemoteObject*/ ,main._lblfrontdoor.runMethod(true,"getText"));
 BA.debugLineNum = 960;BA.debugLine="mf.url=$\"    <h1>${lblFrontDoor.Text}</h1>    <im";
Debug.ShouldStop(-2147483648);
_mf.setField ("_url" /*RemoteObject*/ ,(RemoteObject.concat(RemoteObject.createImmutable("\n"),RemoteObject.createImmutable("   <h1>"),main.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main._lblfrontdoor.runMethod(true,"getText")))),RemoteObject.createImmutable("</h1>\n"),RemoteObject.createImmutable("   <img src=\""),main.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.__c.getField(false,"File").runMethod(true,"GetUri",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("FrontDoor.jpg")))))),RemoteObject.createImmutable("\"/>\n"),RemoteObject.createImmutable("   \n"),RemoteObject.createImmutable(""))));
 BA.debugLineNum = 965;BA.debugLine="mf.Show";
Debug.ShouldStop(16);
_mf.runClassMethod (cloyd.blink.frmmedia.class, "_show" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("ivMax_MouseClicked (main) ","main",0,main.ba,main.mostCurrent,769);
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 769;BA.debugLine="Private Sub ivMax_MouseClicked (EventData As Mouse";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("ivMin_MouseClicked (main) ","main",0,main.ba,main.mostCurrent,789);
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 789;BA.debugLine="Private Sub ivMin_MouseClicked (EventData As Mouse";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 790;BA.debugLine="Try";
Debug.ShouldStop(2097152);
try { BA.debugLineNum = 791;BA.debugLine="Dim jmf As JavaObject = MainForm";
Debug.ShouldStop(4194304);
...
_jmf.setObject(main._mainform);Debug.locals.put("jmf", _jmf);
 BA.debugLineNum = 792;BA.debugLine="Dim stage As JavaObject = jmf.GetField(\"stage\")";
Debug.ShouldStop(8388608);
...
_stage.setObject(_jmf.runMethod(false,"GetField",(Object)(RemoteObject.createImmutable("stage"))));Debug.locals.put("stage", _stage);
 BA.debugLineNum = 793;BA.debugLine="stage.RunMethod(\"setIconified\", Array As Object(";
Debug.ShouldStop(16777216);
_stage.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setIconified")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(main.__c.getField(true,"True"))})));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e6.toString()); BA.debugLineNum = 795;BA.debugLine="Log(LastException)";
Debug.ShouldStop(67108864);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 };
...
try {
		Debug.PushSubsStack("ivSideYard_MouseClicked (main) ","main",0,main.ba,main.mostCurrent,968);
...
RemoteObject _mf = RemoteObject.declareNull("cloyd.blink.frmmedia");
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 968;BA.debugLine="Sub ivSideYard_MouseClicked (EventData As MouseEve";
Debug.ShouldStop(128);
 BA.debugLineNum = 969;BA.debugLine="Dim mf As frmMedia";
Debug.ShouldStop(256);
_mf = RemoteObject.createNew ("cloyd.blink.frmmedia");Debug.locals.put("mf", _mf);
 BA.debugLineNum = 970;BA.debugLine="mf.Initialize(MainForm)";
Debug.ShouldStop(512);
_mf.runClassMethod (cloyd.blink.frmmedia.class, "_initialize" /*RemoteObject*/ ,main.ba,(Object)(main._mainform));
 BA.debugLineNum = 971;BA.debugLine="mf.timestamp = lblSideYard.Text";
Debug.ShouldStop(1024);
_mf.setField ("_timestamp" /*RemoteObject*/ ,main._lblsideyard.runMethod(true,"getText"));
 BA.debugLineNum = 972;BA.debugLine="mf.url=$\"    <h1>${lblSideYard.Text}</h1>    <img";
Debug.ShouldStop(2048);
_mf.setField ("_url" /*RemoteObject*/ ,(RemoteObject.concat(RemoteObject.createImmutable("\n"),RemoteObject.createImmutable("   <h1>"),main.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main._lblsideyard.runMethod(true,"getText")))),RemoteObject.createImmutable("</h1>\n"),RemoteObject.createImmutable("   <img src=\""),main.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.__c.getField(false,"File").runMethod(true,"GetUri",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("SideYard.jpg")))))),RemoteObject.createImmutable("\"/>\n"),RemoteObject.createImmutable("   \n"),RemoteObject.createImmutable(""))));
 BA.debugLineNum = 977;BA.debugLine="mf.Show";
Debug.ShouldStop(65536);
_mf.runClassMethod (cloyd.blink.frmmedia.class, "_show" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("lbTitle_MouseDragged (main) ","main",0,main.ba,main.mostCurrent,724);
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 724;BA.debugLine="Private Sub lbTitle_MouseDragged (EventData As Mou";
Debug.ShouldStop(524288);
 BA.debugLineNum = 725;BA.debugLine="Try";
Debug.ShouldStop(1048576);
try { BA.debugLineNum = 726;BA.debugLine="If isMaximized Then Return";
Debug.ShouldStop(2097152);
if (main._ismaximized.<Boolean>get().booleanValue()) { 
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 727;BA.debugLine="Dim jo As JavaObject = EventData";
Debug.ShouldStop(4194304);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo.setObject(_eventdata.getObject());Debug.locals.put("jo", _jo);
 BA.debugLineNum = 728;BA.debugLine="MainForm.WindowLeft = jo.RunMethod(\"getScreenX\",";
Debug.ShouldStop(8388608);
main._mainform.runMethod(true,"setWindowLeft",RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, _jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getScreenX")),(Object)((main.__c.getField(false,"Null"))))),main._xmouse}, "-",1, 0));
 BA.debugLineNum = 729;BA.debugLine="MainForm.WindowTop = jo.RunMethod(\"getScreenY\",";
Debug.ShouldStop(16777216);
main._mainform.runMethod(true,"setWindowTop",RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, _jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getScreenY")),(Object)((main.__c.getField(false,"Null"))))),main._ymouse}, "-",1, 0));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e7.toString()); BA.debugLineNum = 731;BA.debugLine="Log(LastException)";
Debug.ShouldStop(67108864);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 };
...
try {
		Debug.PushSubsStack("lbTitle_MousePressed (main) ","main",0,main.ba,main.mostCurrent,735);
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 735;BA.debugLine="Private Sub lbTitle_MousePressed (EventData As Mou";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 736;BA.debugLine="Try";
Debug.ShouldStop(-2147483648);
try { BA.debugLineNum = 737;BA.debugLine="xMouse = EventData.X + lbTitle.Left + 15";
Debug.ShouldStop(1);
main._xmouse = RemoteObject.solve(new RemoteObject[] {_eventdata.runMethod(true,"getX"),main._lbtitle.runMethod(true,"getLeft"),RemoteObject.createImmutable(15)}, "++",2, 0);
 BA.debugLineNum = 738;BA.debugLine="yMouse = EventData.Y + lbTitle.Top + 15";
Debug.ShouldStop(2);
main._ymouse = RemoteObject.solve(new RemoteObject[] {_eventdata.runMethod(true,"getY"),main._lbtitle.runMethod(true,"getTop"),RemoteObject.createImmutable(15)}, "++",2, 0);
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e5.toString()); BA.debugLineNum = 740;BA.debugLine="Log(LastException)";
Debug.ShouldStop(8);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 };
...
try {
		Debug.PushSubsStack("Max_Entered_Event (main) ","main",0,main.ba,main.mostCurrent,773);
if (RapidSub.canDelegate("max_entered_event")) { return cloyd.blink.main.remoteMe.runUserSub(false, "main","max_entered_event", _e);}
Debug.locals.put("e", _e);
 BA.debugLineNum = 773;BA.debugLine="Private Sub Max_Entered_Event(e As Event)";
Debug.ShouldStop(16);
 BA.debugLineNum = 774;BA.debugLine="Try";
Debug.ShouldStop(32);
try { BA.debugLineNum = 775;BA.debugLine="ivMax.SetImage(fx.LoadImage(File.DirAssets, imgI";
Debug.ShouldStop(64);
main._ivmax.runVoidMethod ("SetImage",(Object)((main._fx.runMethod(false,"LoadImage",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.concat(main._imginit,RemoteObject.createImmutable("_btMaxEnt.png")))).getObject())));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e4.toString()); BA.debugLineNum = 777;BA.debugLine="Log(LastException)";
Debug.ShouldStop(256);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 };
...
try {
		Debug.PushSubsStack("Max_Exited_Event (main) ","main",0,main.ba,main.mostCurrent,781);
if (RapidSub.canDelegate("max_exited_event")) { return cloyd.blink.main.remoteMe.runUserSub(false, "main","max_exited_event", _e);}
Debug.locals.put("e", _e);
 BA.debugLineNum = 781;BA.debugLine="Private Sub Max_Exited_Event(e As Event)";
Debug.ShouldStop(4096);
 BA.debugLineNum = 782;BA.debugLine="Try";
Debug.ShouldStop(8192);
try { BA.debugLineNum = 783;BA.debugLine="ivMax.SetImage(fx.LoadImage(File.DirAssets, imgI";
Debug.ShouldStop(16384);
main._ivmax.runVoidMethod ("SetImage",(Object)((main._fx.runMethod(false,"LoadImage",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.concat(main._imginit,RemoteObject.createImmutable("_btMax.png")))).getObject())));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e4.toString()); BA.debugLineNum = 785;BA.debugLine="Log(LastException)";
Debug.ShouldStop(65536);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 };
...
try {
		Debug.PushSubsStack("Min_Entered_Event (main) ","main",0,main.ba,main.mostCurrent,799);
if (RapidSub.canDelegate("min_entered_event")) { return cloyd.blink.main.remoteMe.runUserSub(false, "main","min_entered_event", _e);}
Debug.locals.put("e", _e);
 BA.debugLineNum = 799;BA.debugLine="Private Sub Min_Entered_Event(e As Event)";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 800;BA.debugLine="Try";
Debug.ShouldStop(-2147483648);
try { BA.debugLineNum = 801;BA.debugLine="ivMin.SetImage(fx.LoadImage(File.DirAssets, imgI";
Debug.ShouldStop(1);
main._ivmin.runVoidMethod ("SetImage",(Object)((main._fx.runMethod(false,"LoadImage",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.concat(main._imginit,RemoteObject.createImmutable("_btMinEnt.png")))).getObject())));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e4.toString()); BA.debugLineNum = 803;BA.debugLine="Log(LastException)";
Debug.ShouldStop(4);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 };
...
try {
		Debug.PushSubsStack("Min_Exited_Event (main) ","main",0,main.ba,main.mostCurrent,807);
if (RapidSub.canDelegate("min_exited_event")) { return cloyd.blink.main.remoteMe.runUserSub(false, "main","min_exited_event", _e);}
Debug.locals.put("e", _e);
 BA.debugLineNum = 807;BA.debugLine="Private Sub Min_Exited_Event(e As Event)";
Debug.ShouldStop(64);
 BA.debugLineNum = 808;BA.debugLine="Try";
Debug.ShouldStop(128);
try { BA.debugLineNum = 809;BA.debugLine="ivMin.SetImage(fx.LoadImage(File.DirAssets, imgI";
Debug.ShouldStop(256);
main._ivmin.runVoidMethod ("SetImage",(Object)((main._fx.runMethod(false,"LoadImage",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.concat(main._imginit,RemoteObject.createImmutable("_btMin.png")))).getObject())));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e4.toString()); BA.debugLineNum = 811;BA.debugLine="Log(LastException)";
Debug.ShouldStop(1024);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 };
...
try {
		Debug.PushSubsStack("ParseUTCstring (main) ","main",0,main.ba,main.mostCurrent,1073);
...
Debug.locals.put("utc", _utc);
 BA.debugLineNum = 1073;BA.debugLine="Sub ParseUTCstring(utc As String) As Long";
Debug.ShouldStop(65536);
 BA.debugLineNum = 1074;BA.debugLine="Dim df As String = DateTime.DateFormat";
Debug.ShouldStop(131072);
_df = main.__c.getField(false,"DateTime").runMethod(true,"getDateFormat");Debug.locals.put("df", _df);Debug.locals.put("df", _df);
 BA.debugLineNum = 1075;BA.debugLine="Dim res As Long";
Debug.ShouldStop(262144);
_res = RemoteObject.createImmutable(0L);Debug.locals.put("res", _res);
 BA.debugLineNum = 1076;BA.debugLine="If utc.CharAt(10) = \"T\" Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("=",_utc.runMethod(true,"charAt",(Object)(BA.numberCast(int.class, 10))),BA.ObjectToChar("T"))) { 
 BA.debugLineNum = 1078;BA.debugLine="If utc.CharAt(19) = \".\" Then utc = utc.SubString";
Debug.ShouldStop(2097152);
...
_utc = RemoteObject.concat(_utc.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 19))),RemoteObject.createImmutable("+0000"));Debug.locals.put("utc", _utc);};
 BA.debugLineNum = 1079;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd'T'HH:mm:ssZ\"";
Debug.ShouldStop(4194304);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd'T'HH:mm:ssZ"));
 }else {
 BA.debugLineNum = 1082;BA.debugLine="DateTime.DateFormat = \"EEE MMM dd HH:mm:ss Z yyy";
Debug.ShouldStop(33554432);
...
Debug.ShouldStop(134217728);
try { BA.debugLineNum = 1085;BA.debugLine="res = DateTime.DateParse(utc)";
Debug.ShouldStop(268435456);
_res = main.__c.getField(false,"DateTime").runMethod(true,"DateParse",(Object)(_utc));Debug.locals.put("res", _res);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e12) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e12.toString()); BA.debugLineNum = 1087;BA.debugLine="res = 0";
Debug.ShouldStop(1073741824);
_res = BA.numberCast(long.class, 0);Debug.locals.put("res", _res);
 };
 BA.debugLineNum = 1089;BA.debugLine="DateTime.DateFormat = df";
Debug.ShouldStop(1);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",_df);
 BA.debugLineNum = 1090;BA.debugLine="Return res";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("RefreshCameras (main) ","main",0,main.ba,main.mostCurrent,175);
...
_links = parent.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {3},new Object[] {RemoteObject.createImmutable(("347574")),RemoteObject.createImmutable(("236967")),(RemoteObject.createImmutable("226821"))})));Debug.locals.put("links", _links);
 BA.debugLineNum = 188;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immedia-";
Debug.ShouldStop(134217728);
_restget(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/network/"),parent._networkid,RemoteObject.createImmutable("/syncmodules")));
 BA.debugLineNum = 189;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(268435456);
...
this.state = 4;
;
 BA.debugLineNum = 190;BA.debugLine="GetSyncModuleInfo(response)";
Debug.ShouldStop(536870912);
_getsyncmoduleinfo(parent._response);
 BA.debugLineNum = 192;BA.debugLine="BlurIV(\"Driveway.jpg\",ivDriveway)";
Debug.ShouldStop(-2147483648);
_bluriv(BA.ObjectToString("Driveway.jpg"),parent._ivdriveway);
 BA.debugLineNum = 193;BA.debugLine="BlurIV(\"FrontDoor.jpg\",ivFrontDoor)";
Debug.ShouldStop(1);
_bluriv(BA.ObjectToString("FrontDoor.jpg"),parent._ivfrontdoor);
 BA.debugLineNum = 194;BA.debugLine="BlurIV(\"SideYard.jpg\",ivSideYard)";
Debug.ShouldStop(2);
_bluriv(BA.ObjectToString("SideYard.jpg"),parent._ivsideyard);
 BA.debugLineNum = 196;BA.debugLine="For Each link As String In links";
Debug.ShouldStop(8);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 197;BA.debugLine="camera = link";
Debug.ShouldStop(16);
_camera = _link;Debug.locals.put("camera", _camera);
 BA.debugLineNum = 198;BA.debugLine="If camera = \"347574\" Then";
Debug.ShouldStop(32);
if (true) break;
...
{ BA.debugLineNum = 202;BA.debugLine="Else If camera = \"236967\" Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("=",_camera,BA.ObjectToString("236967"))) { 
this.state = 11;
}else 
{ BA.debugLineNum = 206;BA.debugLine="Else If camera = \"226821\" Then";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("=",_camera,BA.ObjectToString("226821"))) { 
this.state = 13;
}}}
...
//C
this.state = 14;
 BA.debugLineNum = 199;BA.debugLine="lblStatus.Text = \"Capturing a new thumbnail fo";
Debug.ShouldStop(64);
parent._lblstatus.runMethod(true,"setText",BA.ObjectToString("Capturing a new thumbnail for the Driveway..."));
 BA.debugLineNum = 200;BA.debugLine="iv = ivDriveway";
Debug.ShouldStop(128);
_iv = parent._ivdriveway;Debug.locals.put("iv", _iv);
 BA.debugLineNum = 201;BA.debugLine="clv = clvDriveway";
Debug.ShouldStop(256);
...
//C
this.state = 14;
 BA.debugLineNum = 203;BA.debugLine="lblStatus.Text = \"Capturing a new thumbnail fo";
Debug.ShouldStop(1024);
parent._lblstatus.runMethod(true,"setText",BA.ObjectToString("Capturing a new thumbnail for the Front Door..."));
 BA.debugLineNum = 204;BA.debugLine="iv = ivFrontDoor";
Debug.ShouldStop(2048);
_iv = parent._ivfrontdoor;Debug.locals.put("iv", _iv);
 BA.debugLineNum = 205;BA.debugLine="clv = clvFrontDoor";
Debug.ShouldStop(4096);
...
//C
this.state = 14;
 BA.debugLineNum = 207;BA.debugLine="lblStatus.Text = \"Capturing a new thumbnail fo";
Debug.ShouldStop(16384);
parent._lblstatus.runMethod(true,"setText",BA.ObjectToString("Capturing a new thumbnail for the Side Yard..."));
 BA.debugLineNum = 208;BA.debugLine="iv = ivSideYard";
Debug.ShouldStop(32768);
_iv = parent._ivsideyard;Debug.locals.put("iv", _iv);
 BA.debugLineNum = 209;BA.debugLine="clv = clvSideYard";
Debug.ShouldStop(65536);
_clv = parent._clvsideyard;Debug.locals.put("clv", _clv);
 if (true) break;
;
 BA.debugLineNum = 212;BA.debugLine="If FirstRun Then";
Debug.ShouldStop(524288);
...
//C
this.state = 62;
 BA.debugLineNum = 214;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immedi";
Debug.ShouldStop(2097152);
...
this.state = 62;
;
 BA.debugLineNum = 216;BA.debugLine="GetCameraInfo(response,clv)";
Debug.ShouldStop(8388608);
_getcamerainfo(parent._response,_clv);
 BA.debugLineNum = 217;BA.debugLine="DownloadImage(\"https://rest-\" & userRegion &\".";
Debug.ShouldStop(16777216);
_downloadimage(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/"),parent._camerathumbnail,RemoteObject.createImmutable(".jpg")),_iv,_camera);
 BA.debugLineNum = 218;BA.debugLine="lblStatus.Text = \"Ready\"";
Debug.ShouldStop(33554432);
...
//C
this.state = 19;
 BA.debugLineNum = 220;BA.debugLine="RESTPost(\"https://rest-\" & userRegion &\".immed";
Debug.ShouldStop(134217728);
...
this.state = 19;
;
 BA.debugLineNum = 222;BA.debugLine="If response.StartsWith(\"ERROR: \") Then";
Debug.ShouldStop(536870912);
if (true) break;
...
//C
this.state = 61;
 BA.debugLineNum = 223;BA.debugLine="Log(response)";
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("Log",(Object)(parent._response));
 BA.debugLineNum = 224;BA.debugLine="lblStatus.Text = response";
Debug.ShouldStop(-2147483648);
...
//C
this.state = 24;
 BA.debugLineNum = 227;BA.debugLine="GetCommandID(response)";
Debug.ShouldStop(4);
_getcommandid(parent._response);
 BA.debugLineNum = 228;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immed";
Debug.ShouldStop(8);
...
this.state = 24;
;
 BA.debugLineNum = 230;BA.debugLine="If response.StartsWith(\"ERROR: \") Then";
Debug.ShouldStop(32);
if (true) break;
...
//C
this.state = 60;
 BA.debugLineNum = 231;BA.debugLine="Log(response)";
Debug.ShouldStop(64);
parent.__c.runVoidMethod ("Log",(Object)(parent._response));
 BA.debugLineNum = 232;BA.debugLine="lblStatus.Text = response";
Debug.ShouldStop(128);
parent._lblstatus.runMethod(true,"setText",parent._response);
...
//C
this.state = 29;
 BA.debugLineNum = 235;BA.debugLine="For i = 1 To 30";
Debug.ShouldStop(1024);
if (true) break;
...
//C
this.state = 32;
 BA.debugLineNum = 236;BA.debugLine="GetCommandStatus(response)";
Debug.ShouldStop(2048);
_getcommandstatus(parent._response);
 BA.debugLineNum = 237;BA.debugLine="If commandComplete Then";
Debug.ShouldStop(4096);
if (true) break;
...
//C
this.state = 45;
 BA.debugLineNum = 238;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".im";
Debug.ShouldStop(8192);
_restget(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/network/"),parent._networkid,RemoteObject.createImmutable("/camera/"),_camera));
 BA.debugLineNum = 239;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("Sleep",main.ba,anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "main", "refreshcameras"),BA.numberCast(int.class, 1000));
this.state = 75;
return;
...
this.state = 45;
;
 BA.debugLineNum = 240;BA.debugLine="GetCameraInfo(response,clv)";
Debug.ShouldStop(32768);
_getcamerainfo(parent._response,_clv);
 BA.debugLineNum = 241;BA.debugLine="DownloadImage(\"https://rest-\" & userRegion";
Debug.ShouldStop(65536);
_downloadimage(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/"),parent._camerathumbnail,RemoteObject.createImmutable(".jpg")),_iv,_camera);
 BA.debugLineNum = 242;BA.debugLine="Exit";
Debug.ShouldStop(131072);
this.state = 46;
if (true) break;
 if (true) break;
...
//C
this.state = 37;
 BA.debugLineNum = 244;BA.debugLine="If camera = \"347574\" Then";
Debug.ShouldStop(524288);
if (true) break;
...
{ BA.debugLineNum = 246;BA.debugLine="Else If camera = \"236967\" Then";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("=",_camera,BA.ObjectToString("236967"))) { 
this.state = 41;
}else 
{ BA.debugLineNum = 248;BA.debugLine="Else If camera = \"226821\" Then";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean("=",_camera,BA.ObjectToString("226821"))) { 
this.state = 43;
}}}
...
//C
this.state = 44;
 BA.debugLineNum = 245;BA.debugLine="lblStatus.Text = \"Awaiting for the Drivew";
Debug.ShouldStop(1048576);
...
//C
this.state = 44;
 BA.debugLineNum = 247;BA.debugLine="lblStatus.Text = \"Awaiting for the Front";
Debug.ShouldStop(4194304);
...
//C
this.state = 44;
 BA.debugLineNum = 249;BA.debugLine="lblStatus.Text = \"Awaiting for the Side Y";
Debug.ShouldStop(16777216);
...
this.state = 74;
;
 BA.debugLineNum = 252;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".imm";
Debug.ShouldStop(134217728);
_restget(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/network/"),parent._networkid,RemoteObject.createImmutable("/command/"),parent._commandid));
...
Debug.locals.put("i", _i);
;
 BA.debugLineNum = 255;BA.debugLine="If commandComplete = False Then";
Debug.ShouldStop(1073741824);
...
//C
this.state = 49;
 BA.debugLineNum = 256;BA.debugLine="If camera = \"347574\" Then";
Debug.ShouldStop(-2147483648);
if (true) break;
...
{ BA.debugLineNum = 259;BA.debugLine="Else If camera = \"236967\" Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",_camera,BA.ObjectToString("236967"))) { 
this.state = 53;
}else 
{ BA.debugLineNum = 262;BA.debugLine="Else If camera = \"226821\" Then";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean("=",_camera,BA.ObjectToString("226821"))) { 
this.state = 55;
}}}
...
//C
this.state = 56;
 BA.debugLineNum = 257;BA.debugLine="lblStatus.Text = \"Failed to retrieve Drive";
Debug.ShouldStop(1);
...
//C
this.state = 56;
 BA.debugLineNum = 260;BA.debugLine="lblStatus.Text = \"Failed to retrieve Front";
Debug.ShouldStop(8);
...
//C
this.state = 56;
 BA.debugLineNum = 263;BA.debugLine="lblStatus.Text = \"Failed to retrieve Side";
Debug.ShouldStop(64);
...
this.state = 66;
this.catchState = 0;
 BA.debugLineNum = 284;BA.debugLine="Log(\"RefreshCamera LastException: \" & LastExcept";
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("RefreshCamera LastException: "),parent.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 285;BA.debugLine="lblStatus.Text = \"RefreshCamera LastException: \"";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("RequestAuthToken (main) ","main",0,main.ba,main.mostCurrent,122);
...
this.state = 4;
this.catchState = 23;
 BA.debugLineNum = 129;BA.debugLine="lblStatus.Text = \"Authenticating...\"";
Debug.ShouldStop(1);
parent._lblstatus.runMethod(true,"setText",BA.ObjectToString("Authenticating..."));
 BA.debugLineNum = 130;BA.debugLine="Dim jobLogin As HttpJob";
Debug.ShouldStop(2);
_joblogin = RemoteObject.createNew ("cloyd.blink.httpjob");Debug.locals.put("jobLogin", _joblogin);
 BA.debugLineNum = 131;BA.debugLine="jobLogin.Initialize(\"\", Me)";
Debug.ShouldStop(4);
_joblogin.runClassMethod (cloyd.blink.httpjob.class, "_initialize" /*RemoteObject*/ ,main.ba,(Object)(BA.ObjectToString("")),(Object)(main.getObject()));
 BA.debugLineNum = 132;BA.debugLine="jobLogin.PostString(\"https://rest.prod.immedia-s";
Debug.ShouldStop(8);
_joblogin.runClassMethod (cloyd.blink.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(BA.ObjectToString("https://rest.prod.immedia-semi.com/login")),(Object)(RemoteObject.concat(RemoteObject.createImmutable("email="),parent._emailaddress,RemoteObject.createImmutable("&password="),parent._password)));
 BA.debugLineNum = 133;BA.debugLine="jobLogin.GetRequest.SetContentType(\"application/";
Debug.ShouldStop(16);
_joblogin.runClassMethod (cloyd.blink.httpjob.class, "_getrequest" /*RemoteObject*/ ).runVoidMethod ("SetContentType",(Object)(RemoteObject.createImmutable("application/x-www-form-urlencoded")));
 BA.debugLineNum = 134;BA.debugLine="Wait For (jobLogin) JobDone(jobLogin As HttpJob)";
Debug.ShouldStop(32);
...
;
 BA.debugLineNum = 135;BA.debugLine="If jobLogin.Success Then";
Debug.ShouldStop(64);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 136;BA.debugLine="lblStatus.Text = \"Successfully logged in to the";
Debug.ShouldStop(128);
parent._lblstatus.runMethod(true,"setText",BA.ObjectToString("Successfully logged in to the Blink server..."));
 BA.debugLineNum = 138;BA.debugLine="GetAuthInfo(jobLogin.GetString)";
Debug.ShouldStop(512);
_getauthinfo(_joblogin.runClassMethod (cloyd.blink.httpjob.class, "_getstring" /*RemoteObject*/ ));
 BA.debugLineNum = 140;BA.debugLine="RESTGet(\"https://rest-\" & userRegion & \".immedi";
Debug.ShouldStop(2048);
_restget(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/user")));
 BA.debugLineNum = 141;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(4096);
...
this.state = 7;
;
 BA.debugLineNum = 142;BA.debugLine="If response.StartsWith(\"ERROR: \") Then";
Debug.ShouldStop(8192);
if (true) break;
...
//C
this.state = 12;
 BA.debugLineNum = 143;BA.debugLine="Log(response)";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("Log",(Object)(parent._response));
 BA.debugLineNum = 144;BA.debugLine="lblStatus.Text = response";
Debug.ShouldStop(32768);
parent._lblstatus.runMethod(true,"setText",parent._response);
...
//C
this.state = 12;
 BA.debugLineNum = 147;BA.debugLine="lblStatus.Text = \"AuthToken acquired...\"";
Debug.ShouldStop(262144);
parent._lblstatus.runMethod(true,"setText",BA.ObjectToString("AuthToken acquired..."));
 BA.debugLineNum = 148;BA.debugLine="GetUserInfo(response)";
Debug.ShouldStop(524288);
...
this.state = 13;
;
 BA.debugLineNum = 151;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immedia";
Debug.ShouldStop(4194304);
_restget(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/api/v1/camera/usage")));
 BA.debugLineNum = 152;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("Sleep",main.ba,anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "main", "requestauthtoken"),BA.numberCast(int.class, 1000));
this.state = 27;
return;
...
this.state = 13;
;
 BA.debugLineNum = 153;BA.debugLine="If response.StartsWith(\"ERROR: \") Then";
Debug.ShouldStop(16777216);
if (true) break;
...
//C
this.state = 18;
 BA.debugLineNum = 154;BA.debugLine="Log(response)";
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("Log",(Object)(parent._response));
 BA.debugLineNum = 155;BA.debugLine="lblStatus.Text = response";
Debug.ShouldStop(67108864);
parent._lblstatus.runMethod(true,"setText",parent._response);
...
//C
this.state = 18;
 BA.debugLineNum = 158;BA.debugLine="GetAllCameras(response)";
Debug.ShouldStop(536870912);
...
//C
this.state = 21;
 BA.debugLineNum = 161;BA.debugLine="lblStatus.Text = \"RequestAuthToken error: \" & j";
Debug.ShouldStop(1);
parent._lblstatus.runMethod(true,"setText",RemoteObject.concat(RemoteObject.createImmutable("RequestAuthToken error: "),_joblogin.runClassMethod (cloyd.blink.httpjob.class, "_getstring" /*RemoteObject*/ )));
 BA.debugLineNum = 162;BA.debugLine="Log(\"RequestAuthToken error: \" & jobLogin.GetSt";
Debug.ShouldStop(2);
...
this.state = 24;
;
 BA.debugLineNum = 165;BA.debugLine="jobLogin.Release";
Debug.ShouldStop(16);
_joblogin.runClassMethod (cloyd.blink.httpjob.class, "_release" /*RemoteObject*/ );
 BA.debugLineNum = 166;BA.debugLine="lblStatus.Text = \"Ready\"";
Debug.ShouldStop(32);
parent._lblstatus.runMethod(true,"setText",BA.ObjectToString("Ready"));
 BA.debugLineNum = 168;BA.debugLine="RefreshCameras(True)";
Debug.ShouldStop(128);
...
this.state = 24;
this.catchState = 0;
 BA.debugLineNum = 170;BA.debugLine="lblStatus.Text = \"RequestAuthToken LastException";
Debug.ShouldStop(512);
parent._lblstatus.runMethod(true,"setText",RemoteObject.concat(RemoteObject.createImmutable("RequestAuthToken LastException: "),parent.__c.runMethod(false,"LastException",main.ba)));
 BA.debugLineNum = 171;BA.debugLine="Log(\"RequestAuthToken LastException: \" & LastExc";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("RESTGet (main) ","main",0,main.ba,main.mostCurrent,289);
...
this.state = 4;
this.catchState = 11;
 BA.debugLineNum = 291;BA.debugLine="Dim j As HttpJob";
Debug.ShouldStop(4);
_j = RemoteObject.createNew ("cloyd.blink.httpjob");Debug.locals.put("j", _j);
 BA.debugLineNum = 292;BA.debugLine="response = \"\"";
Debug.ShouldStop(8);
parent._response = BA.ObjectToString("");
 BA.debugLineNum = 293;BA.debugLine="j.Initialize(\"\", Me) 'name is empty as it is no";
Debug.ShouldStop(16);
_j.runClassMethod (cloyd.blink.httpjob.class, "_initialize" /*RemoteObject*/ ,main.ba,(Object)(BA.ObjectToString("")),(Object)(main.getObject()));
 BA.debugLineNum = 294;BA.debugLine="j.Download(url)";
Debug.ShouldStop(32);
_j.runClassMethod (cloyd.blink.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(_url));
 BA.debugLineNum = 295;BA.debugLine="j.GetRequest.SetHeader(\"TOKEN_AUTH\", authToken)";
Debug.ShouldStop(64);
_j.runClassMethod (cloyd.blink.httpjob.class, "_getrequest" /*RemoteObject*/ ).runVoidMethod ("SetHeader",(Object)(BA.ObjectToString("TOKEN_AUTH")),(Object)(parent._authtoken));
 BA.debugLineNum = 296;BA.debugLine="Wait For (j) JobDone(j As HttpJob)";
Debug.ShouldStop(128);
...
_j = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(0));Debug.locals.put("j", _j);
;
 BA.debugLineNum = 297;BA.debugLine="If j.Success Then";
Debug.ShouldStop(256);
if (true) break;
...
//C
this.state = 9;
 BA.debugLineNum = 298;BA.debugLine="response = j.GetString";
Debug.ShouldStop(512);
...
//C
this.state = 9;
 BA.debugLineNum = 300;BA.debugLine="response = \"ERROR: \" & j.ErrorMessage";
Debug.ShouldStop(2048);
parent._response = RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ ));
 BA.debugLineNum = 301;BA.debugLine="lblStatus.Text = \"ERROR: \" & j.ErrorMessage";
Debug.ShouldStop(4096);
parent._lblstatus.runMethod(true,"setText",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )));
 if (true) break;
...
this.state = 12;
this.catchState = 0;
 BA.debugLineNum = 305;BA.debugLine="response = \"ERROR: \" & LastException";
Debug.ShouldStop(65536);
parent._response = RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),parent.__c.runMethod(false,"LastException",main.ba));
 BA.debugLineNum = 306;BA.debugLine="Log(\"RESTDownload LastException: \" & LastExcepti";
Debug.ShouldStop(131072);
parent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("RESTDownload LastException: "),parent.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 307;BA.debugLine="lblStatus.Text = \"RESTGet LastException: \" & Las";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("RESTPost (main) ","main",0,main.ba,main.mostCurrent,314);
...
this.state = 4;
this.catchState = 11;
 BA.debugLineNum = 316;BA.debugLine="Dim j As HttpJob";
Debug.ShouldStop(134217728);
_j = RemoteObject.createNew ("cloyd.blink.httpjob");Debug.locals.put("j", _j);
 BA.debugLineNum = 317;BA.debugLine="response = \"\"";
Debug.ShouldStop(268435456);
parent._response = BA.ObjectToString("");
 BA.debugLineNum = 318;BA.debugLine="j.Initialize(\"\", Me) 'name is empty as it is no";
Debug.ShouldStop(536870912);
_j.runClassMethod (cloyd.blink.httpjob.class, "_initialize" /*RemoteObject*/ ,main.ba,(Object)(BA.ObjectToString("")),(Object)(main.getObject()));
 BA.debugLineNum = 319;BA.debugLine="j.PostString(url,\"\")";
Debug.ShouldStop(1073741824);
_j.runClassMethod (cloyd.blink.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(_url),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 320;BA.debugLine="j.GetRequest.SetContentType(\"application/x-www-f";
Debug.ShouldStop(-2147483648);
_j.runClassMethod (cloyd.blink.httpjob.class, "_getrequest" /*RemoteObject*/ ).runVoidMethod ("SetContentType",(Object)(RemoteObject.createImmutable("application/x-www-form-urlencoded")));
 BA.debugLineNum = 321;BA.debugLine="j.GetRequest.SetHeader(\"TOKEN_AUTH\", authToken)";
Debug.ShouldStop(1);
_j.runClassMethod (cloyd.blink.httpjob.class, "_getrequest" /*RemoteObject*/ ).runVoidMethod ("SetHeader",(Object)(BA.ObjectToString("TOKEN_AUTH")),(Object)(parent._authtoken));
 BA.debugLineNum = 322;BA.debugLine="Wait For (j) JobDone(j As HttpJob)";
Debug.ShouldStop(2);
...
_j = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(0));Debug.locals.put("j", _j);
;
 BA.debugLineNum = 323;BA.debugLine="If j.Success Then";
Debug.ShouldStop(4);
if (true) break;
...
//C
this.state = 9;
 BA.debugLineNum = 324;BA.debugLine="response = j.GetString";
Debug.ShouldStop(8);
parent._response = _j.runClassMethod (cloyd.blink.httpjob.class, "_getstring" /*RemoteObject*/ );
 if (true) break;
...
//C
this.state = 9;
 BA.debugLineNum = 326;BA.debugLine="response = \"ERROR: \" & j.ErrorMessage";
Debug.ShouldStop(32);
parent._response = RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ ));
 BA.debugLineNum = 327;BA.debugLine="lblStatus.Text = \"ERROR: \" & j.ErrorMessage";
Debug.ShouldStop(64);
parent._lblstatus.runMethod(true,"setText",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )));
 if (true) break;
...
this.state = 12;
;
 BA.debugLineNum = 329;BA.debugLine="j.Release";
Debug.ShouldStop(256);
_j.runClassMethod (cloyd.blink.httpjob.class, "_release" /*RemoteObject*/ );
 Debug.CheckDeviceExceptions();
if (true) break;
...
this.state = 12;
this.catchState = 0;
 BA.debugLineNum = 331;BA.debugLine="response = \"ERROR: \" & LastException";
Debug.ShouldStop(1024);
parent._response = RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),parent.__c.runMethod(false,"LastException",main.ba));
 BA.debugLineNum = 332;BA.debugLine="Log(\"RESTPost LastException: \" & LastException)";
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("RESTPost LastException: "),parent.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 333;BA.debugLine="lblStatus.Text = \"RESTPost LastException: \" & La";
Debug.ShouldStop(4096);
...
this.catchState = 0;
;
 BA.debugLineNum = 335;BA.debugLine="Log(\"URL: \" & url)";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("URL: "),_url)));
 BA.debugLineNum = 336;BA.debugLine="Log(\"Response: \" & response)";
Debug.ShouldStop(32768);
parent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("Response: "),parent._response)));
 BA.debugLineNum = 337;BA.debugLine="Return(response)";
Debug.ShouldStop(65536);
Debug.CheckDeviceExceptions();if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,((parent._response)));return;};
...
try {
		Debug.PushSubsStack("SetAvg (main) ","main",0,main.ba,main.mostCurrent,1033);
...
Debug.locals.put("temp", _temp);
 BA.debugLineNum = 1033;BA.debugLine="Private Sub SetAvg(bc As BitmapCreator, x As Int,";
Debug.ShouldStop(256);
 BA.debugLineNum = 1034;BA.debugLine="Try";
Debug.ShouldStop(512);
try { BA.debugLineNum = 1035;BA.debugLine="temp.Initialize";
Debug.ShouldStop(1024);
_temp.runVoidMethod ("Initialize");
 BA.debugLineNum = 1036;BA.debugLine="For Each c As ARGBColor In clrs";
Debug.ShouldStop(2048);
{
...
_temp.setField ("r",BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_temp.getField(true,"r"),_clrs.getField(true,"length")}, "/",0, 0)));
 BA.debugLineNum = 1043;BA.debugLine="temp.g = temp.g / clrs.Length";
Debug.ShouldStop(262144);
_temp.setField ("g",BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_temp.getField(true,"g"),_clrs.getField(true,"length")}, "/",0, 0)));
 BA.debugLineNum = 1044;BA.debugLine="temp.b = temp.b / clrs.Length";
Debug.ShouldStop(524288);
_temp.setField ("b",BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_temp.getField(true,"b"),_clrs.getField(true,"length")}, "/",0, 0)));
 BA.debugLineNum = 1045;BA.debugLine="bc.SetARGB(x, y, temp)";
Debug.ShouldStop(1048576);
_bc.runVoidMethod ("_setargb",(Object)(_x),(Object)(_y),(Object)(_temp));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e14) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e14.toString()); BA.debugLineNum = 1047;BA.debugLine="Log(LastException)";
Debug.ShouldStop(4194304);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 1048;BA.debugLine="lblStatus.Text = \"SetAvg LastException: \" & Last";
Debug.ShouldStop(8388608);
