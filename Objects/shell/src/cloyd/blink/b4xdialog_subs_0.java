...
try {
		Debug.PushSubsStack("Background_Click (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,255);
...
try {
		Debug.PushSubsStack("Background_MouseClicked (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,245);
...
try {
		Debug.PushSubsStack("Background_Touch (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,250);
...
try {
		Debug.PushSubsStack("Blur (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,284);
...
try {
		Debug.PushSubsStack("Button_Click (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,230);
...
try {
		Debug.PushSubsStack("Close (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,236);
...
try {
		Debug.PushSubsStack("CreateButton (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,190);
...
try {
		Debug.PushSubsStack("GetButton (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,212);
...
try {
		Debug.PushSubsStack("getVisible (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,186);
...
try {
		Debug.PushSubsStack("Initialize (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("InternalAddStubToCLVIfNeeded (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,338);
...
try {
		Debug.PushSubsStack("InternalSetTextOrCSBuilderToLabel (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,353);
...
try {
		Debug.PushSubsStack("Resize (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,260);
...
try {
		Debug.PushSubsStack("SetAvg (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,324);
...
try {
		Debug.PushSubsStack("SetButtonState (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,220);
...
try {
		Debug.PushSubsStack("Show (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,71);
...
public ResumableSub_Show(cloyd.blink.b4xdialog parent,RemoteObject __ref,RemoteObject _text,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
this._text = _text;
this._yes = _yes;
...
try {
		Debug.PushSubsStack("ShowCustom (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,94);
...
public ResumableSub_ShowCustom(cloyd.blink.b4xdialog parent,RemoteObject __ref,RemoteObject _content,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
...
try {
		Debug.PushSubsStack("ShowTemplate (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,62);
...
public ResumableSub_ShowTemplate(cloyd.blink.b4xdialog parent,RemoteObject __ref,RemoteObject _dialogtemplate,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
...
try {
		Debug.PushSubsStack("Stub_Click (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,367);
...
try {
		Debug.PushSubsStack("UpdateBlur (b4xdialog) ","b4xdialog",13,__ref.getField(false, "ba"),__ref,271);
