...
try {
		Debug.PushSubsStack("AddItemsToList (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,121);
...
_textpane.setObject(_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_createtextflow" /*RemoteObject*/ ).getObject());Debug.locals.put("TextPane", _textpane);
...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,115);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,231);
...
try {
		Debug.PushSubsStack("GetPanel (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,57);
...
_sv.setObject(__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).getField(false,"_sv").getObject());Debug.locals.put("sv", _sv);
...
try {
		Debug.PushSubsStack("SearchField_EnterPressed (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,108);
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,77);
...
try {
		Debug.PushSubsStack("SetIndex (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,223);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_allitems" /*RemoteObject*/ ).setObject (_obj.getArrayElement(false,BA.numberCast(int.class, 2)));
...
try {
		Debug.PushSubsStack("SetItems (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,184);
...
try {
		Debug.PushSubsStack("Show (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,61);
...
try {
		Debug.PushSubsStack("Update (b4xsearchtemplate) ","b4xsearchtemplate",18,__ref.getField(false, "ba"),__ref,81);
