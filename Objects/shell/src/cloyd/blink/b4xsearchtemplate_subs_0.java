...
try {
		Debug.PushSubsStack("AddItemsToList (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,123);
if (RapidSub.canDelegate("additemstolist")) { return __ref.runUserSub(false, "b4xsearchtemplate","additemstolist", __ref, _li, _full);}
RemoteObject _tf = RemoteObject.declareNull("cloyd.blink.b4jtextflow");
int _i = 0;
...
Debug.JustUpdateDeviceLine();
_tf = RemoteObject.createNew ("cloyd.blink.b4jtextflow");Debug.locals.put("tf", _tf);
 BA.debugLineNum = 127;BA.debugLine="tf.Initialize";
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_reset" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_append" /*RemoteObject*/ ,(Object)(_item.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(_x)))).runClassMethod (cloyd.blink.b4jtextflow.class, "_setcolor" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).getField(true,"_defaulttextcolor")));
 };
...
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_append" /*RemoteObject*/ ,(Object)(_item.runMethod(true,"substring",(Object)(_x),(Object)(RemoteObject.solve(new RemoteObject[] {_x,_full.runMethod(true,"length")}, "+",1, 1))))).runClassMethod (cloyd.blink.b4jtextflow.class, "_setcolor" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_texthighlightcolor" /*RemoteObject*/ )));
 };
...
_textpane = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _tf.runClassMethod (cloyd.blink.b4jtextflow.class, "_createtextflow" /*RemoteObject*/ ).getObject());Debug.locals.put("TextPane", _textpane);
...
b4xsearchtemplate._xdialog = RemoteObject.createNew ("cloyd.blink.b4xdialog");__ref.setField("_xdialog",b4xsearchtemplate._xdialog);
 //BA.debugLineNum = 6;BA.debugLine="Public SearchField As B4XFloatTextField";
b4xsearchtemplate._searchfield = RemoteObject.createNew ("cloyd.blink.b4xfloattextfield");__ref.setField("_searchfield",b4xsearchtemplate._searchfield);
...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,117);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).runClassMethod (cloyd.blink.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")));
...
try {
		Debug.PushSubsStack("DialogClosed (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,233);
...
try {
		Debug.PushSubsStack("GetPanel (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("Initialize (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("Resize (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("SearchField_EnterPressed (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,110);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xsearchtemplate.class, "_customlistview1_itemclick" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(false,"_getvalue",(Object)(BA.numberCast(int.class, 0)))));
 };
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,79);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xsearchtemplate.class, "_update" /*RemoteObject*/ ,(Object)(_new),(Object)(b4xsearchtemplate.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("SetIndex (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,225);
...
try {
		Debug.PushSubsStack("SetItems (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,186);
...
try {
		Debug.PushSubsStack("Show (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,63);
...
public ResumableSub_Show(cloyd.blink.b4xsearchtemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xsearchtemplate.class, "_update" /*RemoteObject*/ ,(Object)(BA.ObjectToString("")),(Object)(parent.__c.getField(true,"True")));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (cloyd.blink.b4xfloattextfield.class, "_settext" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 73;BA.debugLine="SearchField.TextField.RequestFocus";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (cloyd.blink.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).runVoidMethod ("RequestFocus");
...
try {
		Debug.PushSubsStack("Update (b4xsearchtemplate) ","b4xsearchtemplate",20,__ref.getField(false, "ba"),__ref,83);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xsearchtemplate.class, "_additemstolist" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_allitems" /*RemoteObject*/ )),(Object)(_str1));
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xsearchtemplate.class, "_additemstolist" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), __ref.getField(false,"_prefixlist" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_str2)))),(Object)(_str1));
