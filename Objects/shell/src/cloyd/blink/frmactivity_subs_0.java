...
try {
		Debug.PushSubsStack("CheckMonitor (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,285);
...
{ BA.debugLineNum = 292;BA.debugLine="Else If fx.Screens.Size> 1 Then";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean(">",__ref.getField(false,"_fx" /*RemoteObject*/ ).runMethod(false,"getScreens").runMethod(true,"getSize"),BA.numberCast(double.class, 1))) { 
...
_slist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_slist = __ref.getField(false,"_fx" /*RemoteObject*/ ).runMethod(false,"getScreens");Debug.locals.put("SList", _slist);Debug.locals.put("SList", _slist);
 BA.debugLineNum = 294;BA.debugLine="Dim S As Screen = SList.Get(2)";
Debug.ShouldStop(32);
_s = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX.ScreenWrapper");
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e16.toString()); BA.debugLineNum = 304;BA.debugLine="Dim SList As List = fx.Screens";
...
try {
		Debug.PushSubsStack("clvActivity_ItemClick (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,216);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 216;BA.debugLine="Sub clvActivity_ItemClick (Index As Int, Value As";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 217;BA.debugLine="Try";
Debug.ShouldStop(16777216);
try { BA.debugLineNum = 218;BA.debugLine="wvMedia.LoadUrl(\"\")";
Debug.ShouldStop(33554432);
__ref.getField(false,"_wvmedia" /*RemoteObject*/ ).runVoidMethod ("LoadUrl",(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 219;BA.debugLine="Dim video As String";
Debug.ShouldStop(67108864);
_video = RemoteObject.createImmutable("");Debug.locals.put("video", _video);
 BA.debugLineNum = 220;BA.debugLine="video = clvActivity.GetValue(Index)";
...
_video = BA.ObjectToString(__ref.getField(false,"_clvactivity" /*RemoteObject*/ ).runMethod(false,"_getvalue",(Object)(_index)));Debug.locals.put("video", _video);
 BA.debugLineNum = 221;BA.debugLine="Dim videoURL As String = Regex.Split(\"\\|\",video)";
Debug.ShouldStop(268435456);
_videourl = frmactivity.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString("\\|")),(Object)(_video)).getArrayElement(true,BA.numberCast(int.class, 0));Debug.locals.put("videoURL", _videourl);Debug.locals.put("videoURL", _videourl);
 BA.debugLineNum = 222;BA.debugLine="Dim videoTimestamp As String = Regex.Split(\"\\|\",";
Debug.ShouldStop(536870912);
_videotimestamp = frmactivity.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString("\\|")),(Object)(_video)).getArrayElement(true,BA.numberCast(int.class, 1));Debug.locals.put("videoTimestamp", _videotimestamp);Debug.locals.put("videoTimestamp", _videotimestamp);
 BA.debugLineNum = 223;BA.debugLine="ShowVideo(videoURL,videoTimestamp)";
Debug.ShouldStop(1073741824);
__ref.runClassMethod (cloyd.blink.frmactivity.class, "_showvideo" /*void*/ ,(Object)(_videourl),(Object)(_videotimestamp));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e9) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e9.toString()); BA.debugLineNum = 225;BA.debugLine="Log(LastException)";
Debug.ShouldStop(1);
frmactivity.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(frmactivity.__c.runMethod(false,"LastException",__ref.getField(false, "ba")))));
 BA.debugLineNum = 226;BA.debugLine="fx.Msgbox2(frm,LastException,\"clvActivity ItemCl";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("ConvertDateTime (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,121);
...
_p = frmactivity._dateutils.runMethod(false,"_periodbetween",(Object)(_lngticks),(Object)(frmactivity.__c.getField(false,"DateTime").runMethod(true,"getNow")));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 128;BA.debugLine="If lblDate.Text.Contains(\"Yesterday\") Or lblDate.";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean(".",__ref.getField(false,"_lbldate" /*RemoteObject*/ ).runMethod(true,"getText").runMethod(true,"contains",(Object)(RemoteObject.createImmutable("Yesterday")))) || RemoteObject.solveBoolean(".",__ref.getField(false,"_lbldate" /*RemoteObject*/ ).runMethod(true,"getText").runMethod(true,"contains",(Object)(RemoteObject.createImmutable("Today"))))) { 
 BA.debugLineNum = 129;BA.debugLine="If p.Days = 0 Then";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",_p.getField(true,"Days"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 130;BA.debugLine="If p.Hours = 0 Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("=",_p.getField(true,"Hours"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 131;BA.debugLine="If p.Minutes = 0 Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",_p.getField(true,"Minutes"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 132;BA.debugLine="Return p.Seconds & \"s ago\"";
Debug.ShouldStop(8);
Debug.CheckDeviceExceptions();if (true) return RemoteObject.concat(_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago"));
 }else {
 BA.debugLineNum = 134;BA.debugLine="Return p.Minutes & \"m \" & p.Seconds & \"s ago\"";
Debug.ShouldStop(32);
Debug.CheckDeviceExceptions();if (true) return RemoteObject.concat(_p.getField(true,"Minutes"),RemoteObject.createImmutable("m "),_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago"));
 };
 }else {
 BA.debugLineNum = 137;BA.debugLine="Return p.Hours & \"h \" & p.Minutes & \"m \" & p.S";
Debug.ShouldStop(256);
Debug.CheckDeviceExceptions();if (true) return RemoteObject.concat(_p.getField(true,"Hours"),RemoteObject.createImmutable("h "),_p.getField(true,"Minutes"),RemoteObject.createImmutable("m "),_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago"));
 };
 }else 
{ BA.debugLineNum = 139;BA.debugLine="else If p.Hours = 0 Then";
Debug.ShouldStop(1024);
if (RemoteObject.solveBoolean("=",_p.getField(true,"Hours"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 140;BA.debugLine="If p.Minutes = 0 Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean("=",_p.getField(true,"Minutes"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 141;BA.debugLine="Return p.Seconds & \"s ago\"";
Debug.ShouldStop(4096);
Debug.CheckDeviceExceptions();if (true) return RemoteObject.concat(_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago"));
 }else {
 BA.debugLineNum = 143;BA.debugLine="Return p.Minutes & \"m \" & p.Seconds & \"s ago\"";
Debug.ShouldStop(16384);
Debug.CheckDeviceExceptions();if (true) return RemoteObject.concat(_p.getField(true,"Minutes"),RemoteObject.createImmutable("m "),_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago"));
 };
 }else 
{ BA.debugLineNum = 145;BA.debugLine="else If p.Minutes = 0 Then";
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean("=",_p.getField(true,"Minutes"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 146;BA.debugLine="Return p.Seconds & \"s ago\"";
Debug.ShouldStop(131072);
Debug.CheckDeviceExceptions();if (true) return RemoteObject.concat(_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago"));
 }else {
 BA.debugLineNum = 148;BA.debugLine="Return p.Days & \"d \" & p.Hours & \"h \" & p.Minut";
Debug.ShouldStop(524288);
Debug.CheckDeviceExceptions();if (true) return RemoteObject.concat(_p.getField(true,"Days"),RemoteObject.createImmutable("d "),_p.getField(true,"Hours"),RemoteObject.createImmutable("h "),_p.getField(true,"Minutes"),RemoteObject.createImmutable("m "),_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago"));
 }}}
;
 }else {
 BA.debugLineNum = 151;BA.debugLine="Return p.Days & \"d \" & p.Hours & \"h \" & p.Minute";
...
try {
		Debug.PushSubsStack("ConvertFullDateTime (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,156);
...
Debug.locals.put("inputTime", _inputtime);
 BA.debugLineNum = 156;BA.debugLine="Sub ConvertFullDateTime(inputTime As String) As St";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 158;BA.debugLine="Dim ticks As Long = ParseUTCstring(inputTime.Repl";
Debug.ShouldStop(536870912);
_ticks = __ref.runClassMethod (cloyd.blink.frmactivity.class, "_parseutcstring" /*RemoteObject*/ ,(Object)(_inputtime.runMethod(true,"replace",(Object)(BA.ObjectToString("+00:00")),(Object)(RemoteObject.createImmutable("+0000")))));Debug.locals.put("ticks", _ticks);Debug.locals.put("ticks", _ticks);
 BA.debugLineNum = 159;BA.debugLine="DateTime.DateFormat = \"MMM d, yyyy h:mm:ss a\"";
Debug.ShouldStop(1073741824);
frmactivity.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("MMM d, yyyy h:mm:ss a"));
 BA.debugLineNum = 160;BA.debugLine="Dim lngTicks As Long = ticks";
Debug.ShouldStop(-2147483648);
_lngticks = _ticks;Debug.locals.put("lngTicks", _lngticks);Debug.locals.put("lngTicks", _lngticks);
 BA.debugLineNum = 162;BA.debugLine="Dim Yesterday As Long";
Debug.ShouldStop(2);
_yesterday = RemoteObject.createImmutable(0L);Debug.locals.put("Yesterday", _yesterday);
 BA.debugLineNum = 163;BA.debugLine="Dim timestamp As Long";
Debug.ShouldStop(4);
_timestamp = RemoteObject.createImmutable(0L);Debug.locals.put("timestamp", _timestamp);
 BA.debugLineNum = 164;BA.debugLine="DateTime.DateFormat = \"yyyyMMdd\"";
Debug.ShouldStop(8);
frmactivity.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyyMMdd"));
 BA.debugLineNum = 165;BA.debugLine="Yesterday = DateTime.Date(DateTime.add(DateTime.N";
Debug.ShouldStop(16);
_yesterday = BA.numberCast(long.class, frmactivity.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(frmactivity.__c.getField(false,"DateTime").runMethod(true,"Add",(Object)(frmactivity.__c.getField(false,"DateTime").runMethod(true,"getNow")),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, -(double) (0 + 1)))))));Debug.locals.put("Yesterday", _yesterday);
 BA.debugLineNum = 166;BA.debugLine="timestamp = DateTime.Date(lngTicks)";
Debug.ShouldStop(32);
_timestamp = BA.numberCast(long.class, frmactivity.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_lngticks)));Debug.locals.put("timestamp", _timestamp);
 BA.debugLineNum = 168;BA.debugLine="DateTime.DateFormat = \"h:mm:ss a\"";
Debug.ShouldStop(128);
frmactivity.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("h:mm:ss a"));
 BA.debugLineNum = 169;BA.debugLine="If DateUtils.IsSameDay(lngTicks,DateTime.now) The";
Debug.ShouldStop(256);
if (frmactivity._dateutils.runMethod(true,"_issameday",(Object)(_lngticks),(Object)(frmactivity.__c.getField(false,"DateTime").runMethod(true,"getNow"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 170;BA.debugLine="Return \"Today \" & DateTime.Date(lngTicks)";
Debug.ShouldStop(512);
Debug.CheckDeviceExceptions();if (true) return RemoteObject.concat(RemoteObject.createImmutable("Today "),frmactivity.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_lngticks)));
 }else 
{ BA.debugLineNum = 171;BA.debugLine="Else If Yesterday = timestamp Then";
Debug.ShouldStop(1024);
if (RemoteObject.solveBoolean("=",_yesterday,BA.numberCast(double.class, _timestamp))) { 
 BA.debugLineNum = 172;BA.debugLine="Return \"Yesterday \" & DateTime.Date(lngTicks)";
Debug.ShouldStop(2048);
Debug.CheckDeviceExceptions();if (true) return RemoteObject.concat(RemoteObject.createImmutable("Yesterday "),frmactivity.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_lngticks)));
 }else {
 BA.debugLineNum = 174;BA.debugLine="Return DateUtils.GetDayOfWeekName(lngTicks) & \"";
Debug.ShouldStop(8192);
Debug.CheckDeviceExceptions();if (true) return RemoteObject.concat(frmactivity._dateutils.runMethod(true,"_getdayofweekname",(Object)(_lngticks)),RemoteObject.createImmutable(" "),frmactivity.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_lngticks)));
 }}
;
...
try {
		Debug.PushSubsStack("CreateListItem (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,100);
...
__ref.getField(false,"_ivscreenshot" /*RemoteObject*/ ).runVoidMethod ("SetBitmap",(Object)((_screenshot.getObject())));
 BA.debugLineNum = 109;BA.debugLine="lblDate.Text = \"   \" & ConvertFullDateTime(filei";
Debug.ShouldStop(4096);
__ref.getField(false,"_lbldate" /*RemoteObject*/ ).runMethod(true,"setText",RemoteObject.concat(RemoteObject.createImmutable("   "),__ref.runClassMethod (cloyd.blink.frmactivity.class, "_convertfulldatetime" /*RemoteObject*/ ,(Object)(_fileinfo))));
 BA.debugLineNum = 110;BA.debugLine="lblFileInfo.Text = \"   \" & ConvertDateTime(filei";
Debug.ShouldStop(8192);
__ref.getField(false,"_lblfileinfo" /*RemoteObject*/ ).runMethod(true,"setText",RemoteObject.concat(RemoteObject.createImmutable("   "),__ref.runClassMethod (cloyd.blink.frmactivity.class, "_convertdatetime" /*RemoteObject*/ ,(Object)(_fileinfo))));
 BA.debugLineNum = 111;BA.debugLine="lblDeviceInfo.Text = \"   \" & devicename";
Debug.ShouldStop(16384);
...
Debug.CheckDeviceExceptions();if (true) return _p;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e11.toString()); BA.debugLineNum = 114;BA.debugLine="Log(LastException)";
Debug.ShouldStop(131072);
frmactivity.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(frmactivity.__c.runMethod(false,"LastException",__ref.getField(false, "ba")))));
...
try {
		Debug.PushSubsStack("frm_CloseRequest (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,261);
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 261;BA.debugLine="Sub frm_CloseRequest (EventData As Event)";
Debug.ShouldStop(16);
 BA.debugLineNum = 262;BA.debugLine="wvMedia.LoadUrl(\"\")";
Debug.ShouldStop(32);
__ref.getField(false,"_wvmedia" /*RemoteObject*/ ).runVoidMethod ("LoadUrl",(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 263;BA.debugLine="wvMedia.RemoveNodeFromParent";
Debug.ShouldStop(64);
__ref.getField(false,"_wvmedia" /*RemoteObject*/ ).runVoidMethod ("RemoveNodeFromParent");
 BA.debugLineNum = 264;BA.debugLine="File.Delete(File.DirApp,\"screenshot.jpg\")";
Debug.ShouldStop(128);
frmactivity.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(frmactivity.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("screenshot.jpg")));
 BA.debugLineNum = 265;BA.debugLine="File.Delete(File.DirApp,\"media.mp4\")";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("Initialize (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("ParseUTCstring (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,179);
...
Debug.locals.put("utc", _utc);
 BA.debugLineNum = 179;BA.debugLine="Sub ParseUTCstring(utc As String) As Long";
Debug.ShouldStop(262144);
 BA.debugLineNum = 180;BA.debugLine="Dim df As String = DateTime.DateFormat";
Debug.ShouldStop(524288);
_df = frmactivity.__c.getField(false,"DateTime").runMethod(true,"getDateFormat");Debug.locals.put("df", _df);Debug.locals.put("df", _df);
 BA.debugLineNum = 181;BA.debugLine="Dim res As Long";
Debug.ShouldStop(1048576);
_res = RemoteObject.createImmutable(0L);Debug.locals.put("res", _res);
 BA.debugLineNum = 182;BA.debugLine="If utc.CharAt(10) = \"T\" Then";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("=",_utc.runMethod(true,"charAt",(Object)(BA.numberCast(int.class, 10))),BA.ObjectToChar("T"))) { 
 BA.debugLineNum = 184;BA.debugLine="If utc.CharAt(19) = \".\" Then utc = utc.SubString";
Debug.ShouldStop(8388608);
...
_utc = RemoteObject.concat(_utc.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 19))),RemoteObject.createImmutable("+0000"));Debug.locals.put("utc", _utc);};
 BA.debugLineNum = 185;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd'T'HH:mm:ssZ\"";
Debug.ShouldStop(16777216);
frmactivity.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd'T'HH:mm:ssZ"));
 }else {
 BA.debugLineNum = 188;BA.debugLine="DateTime.DateFormat = \"EEE MMM dd HH:mm:ss Z yyy";
Debug.ShouldStop(134217728);
...
Debug.ShouldStop(536870912);
try { BA.debugLineNum = 191;BA.debugLine="res = DateTime.DateParse(utc)";
Debug.ShouldStop(1073741824);
_res = frmactivity.__c.getField(false,"DateTime").runMethod(true,"DateParse",(Object)(_utc));Debug.locals.put("res", _res);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e12) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e12.toString()); BA.debugLineNum = 193;BA.debugLine="res = 0";
Debug.ShouldStop(1);
_res = BA.numberCast(long.class, 0);Debug.locals.put("res", _res);
 };
 BA.debugLineNum = 195;BA.debugLine="DateTime.DateFormat = df";
Debug.ShouldStop(4);
frmactivity.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",_df);
 BA.debugLineNum = 196;BA.debugLine="Return res";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("RootPaneKeyEvent_Event (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,268);
...
Debug.locals.put("e", _e);
 BA.debugLineNum = 268;BA.debugLine="Private Sub RootPaneKeyEvent_Event(e As Event)";
Debug.ShouldStop(2048);
 BA.debugLineNum = 269;BA.debugLine="Dim KE As Reflector";
Debug.ShouldStop(4096);
_ke = RemoteObject.createNew ("anywheresoftware.b4j.agraham.reflection.Reflection");Debug.locals.put("KE", _ke);
 BA.debugLineNum = 270;BA.debugLine="Dim sCode As String";
Debug.ShouldStop(8192);
_scode = RemoteObject.createImmutable("");Debug.locals.put("sCode", _scode);
 BA.debugLineNum = 271;BA.debugLine="Dim sType As String 'ignore";
Debug.ShouldStop(16384);
_stype = RemoteObject.createImmutable("");Debug.locals.put("sType", _stype);
 BA.debugLineNum = 272;BA.debugLine="Dim result As Int 'ignore";
Debug.ShouldStop(32768);
_result = RemoteObject.createImmutable(0);Debug.locals.put("result", _result);
 BA.debugLineNum = 273;BA.debugLine="KE.Target = e	 ' e is a KeyEvent instance";
Debug.ShouldStop(65536);
_ke.setField ("Target",(_e.getObject()));
 BA.debugLineNum = 274;BA.debugLine="sCode = KE.RunMethod(\"getCode\")";
Debug.ShouldStop(131072);
_scode = BA.ObjectToString(_ke.runMethod(false,"RunMethod",(Object)(RemoteObject.createImmutable("getCode"))));Debug.locals.put("sCode", _scode);
 BA.debugLineNum = 275;BA.debugLine="sType = KE.RunMethod(\"getEventType\")";
Debug.ShouldStop(262144);
_stype = BA.ObjectToString(_ke.runMethod(false,"RunMethod",(Object)(RemoteObject.createImmutable("getEventType"))));Debug.locals.put("sType", _stype);
 BA.debugLineNum = 276;BA.debugLine="If sCode=\"ESCAPE\" Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("=",_scode,BA.ObjectToString("ESCAPE"))) { 
 BA.debugLineNum = 277;BA.debugLine="wvMedia.LoadUrl(\"\")";
Debug.ShouldStop(1048576);
__ref.getField(false,"_wvmedia" /*RemoteObject*/ ).runVoidMethod ("LoadUrl",(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 278;BA.debugLine="wvMedia.RemoveNodeFromParent";
Debug.ShouldStop(2097152);
__ref.getField(false,"_wvmedia" /*RemoteObject*/ ).runVoidMethod ("RemoveNodeFromParent");
 BA.debugLineNum = 279;BA.debugLine="File.Delete(File.DirApp,\"screenshot.jpg\")";
Debug.ShouldStop(4194304);
frmactivity.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(frmactivity.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("screenshot.jpg")));
 BA.debugLineNum = 280;BA.debugLine="File.Delete(File.DirApp,\"media.mp4\")";
Debug.ShouldStop(8388608);
frmactivity.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(frmactivity.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("media.mp4")));
 BA.debugLineNum = 281;BA.debugLine="frm.Close";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("Show (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("ShowVideo (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,231);
...
this.state = 4;
this.catchState = 11;
 BA.debugLineNum = 233;BA.debugLine="Dim j As HttpJob";
Debug.ShouldStop(256);
_j = RemoteObject.createNew ("cloyd.blink.httpjob");Debug.locals.put("j", _j);
 BA.debugLineNum = 234;BA.debugLine="j.Initialize(\"\", Me)";
Debug.ShouldStop(512);
_j.runClassMethod (cloyd.blink.httpjob.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(BA.ObjectToString("")),(Object)(__ref));
 BA.debugLineNum = 235;BA.debugLine="j.Download(Link)";
Debug.ShouldStop(1024);
_j.runClassMethod (cloyd.blink.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(_link));
 BA.debugLineNum = 236;BA.debugLine="j.GetRequest.SetHeader(\"TOKEN_AUTH\", authToken)";
Debug.ShouldStop(2048);
_j.runClassMethod (cloyd.blink.httpjob.class, "_getrequest" /*RemoteObject*/ ).runVoidMethod ("SetHeader",(Object)(BA.ObjectToString("TOKEN_AUTH")),(Object)(__ref.getField(true,"_authtoken" /*RemoteObject*/ )));
...
//C
this.state = 9;
 BA.debugLineNum = 240;BA.debugLine="Dim out As OutputStream = File.OpenOutput(File.";
Debug.ShouldStop(32768);
_out = RemoteObject.createNew ("anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper");
_out = parent.__c.getField(false,"File").runMethod(false,"OpenOutput",(Object)(parent.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(BA.ObjectToString("media.mp4")),(Object)(parent.__c.getField(true,"False")));Debug.locals.put("out", _out);Debug.locals.put("out", _out);
 BA.debugLineNum = 241;BA.debugLine="File.Copy2(j.GetInputStream, out)";
Debug.ShouldStop(65536);
parent.__c.getField(false,"File").runVoidMethod ("Copy2",(Object)((_j.runClassMethod (cloyd.blink.httpjob.class, "_getinputstream" /*RemoteObject*/ ).getObject())),(Object)((_out.getObject())));
 BA.debugLineNum = 242;BA.debugLine="out.Close '<------ very important";
Debug.ShouldStop(131072);
_out.runVoidMethod ("Close");
 BA.debugLineNum = 244;BA.debugLine="lblTimestamp.Text= timestamp";
Debug.ShouldStop(524288);
__ref.getField(false,"_lbltimestamp" /*RemoteObject*/ ).runMethod(true,"setText",_timestamp);
 BA.debugLineNum = 245;BA.debugLine="Dim sb As StringBuilder";
Debug.ShouldStop(1048576);
_sb = RemoteObject.createNew ("anywheresoftware.b4a.keywords.StringBuilderWrapper");Debug.locals.put("sb", _sb);
 BA.debugLineNum = 246;BA.debugLine="sb.Initialize";
Debug.ShouldStop(2097152);
_sb.runVoidMethod ("Initialize");
 BA.debugLineNum = 247;BA.debugLine="sb.Append(\"<video width='100%' height='100%' co";
Debug.ShouldStop(4194304);
_sb.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<video width='100%' height='100%' controls autoplay>")));
 BA.debugLineNum = 248;BA.debugLine="sb.Append(\"<source src='\" & File.GetUri(File.Di";
Debug.ShouldStop(8388608);
_sb.runVoidMethod ("Append",(Object)(RemoteObject.concat(RemoteObject.createImmutable("<source src='"),parent.__c.getField(false,"File").runMethod(true,"GetUri",(Object)(parent.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("media.mp4"))),RemoteObject.createImmutable("' Type='video/mp4'/>"))));
 BA.debugLineNum = 249;BA.debugLine="sb.Append(\"</video>\")";
Debug.ShouldStop(16777216);
_sb.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("</video>")));
 BA.debugLineNum = 250;BA.debugLine="wvMedia.LoadHtml(sb.ToString)";
Debug.ShouldStop(33554432);
...
this.state = 12;
;
 BA.debugLineNum = 254;BA.debugLine="j.Release";
Debug.ShouldStop(536870912);
_j.runClassMethod (cloyd.blink.httpjob.class, "_release" /*RemoteObject*/ );
 Debug.CheckDeviceExceptions();
if (true) break;
...
Debug.ShouldStop(-2147483648);
parent.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")))));
 BA.debugLineNum = 257;BA.debugLine="fx.Msgbox2(frm,LastException,\"ShowVideo Exceptio";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("wvMedia_PageFinished (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,312);
...
Debug.locals.put("Url", _url);
 BA.debugLineNum = 312;BA.debugLine="Sub wvMedia_PageFinished (Url As String)";
Debug.ShouldStop(8388608);
