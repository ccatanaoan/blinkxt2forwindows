...
try {
		Debug.PushSubsStack("CheckMonitor (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,249);
...
RemoteObject _s = RemoteObject.declareNull("anywheresoftware.b4j.objects.JFX.ScreenWrapper");
 BA.debugLineNum = 249;BA.debugLine="Sub CheckMonitor() As Screen";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 250;BA.debugLine="Try";
Debug.ShouldStop(33554432);
try { BA.debugLineNum = 251;BA.debugLine="If fx.Screens.Size= 1 Then";
...
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_fx" /*RemoteObject*/ ).runMethod(false,"getScreens").runMethod(true,"getSize"),BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 252;BA.debugLine="Dim SList As List = fx.Screens";
...
_slist = __ref.getField(false,"_fx" /*RemoteObject*/ ).runMethod(false,"getScreens");Debug.locals.put("SList", _slist);Debug.locals.put("SList", _slist);
 BA.debugLineNum = 253;BA.debugLine="Dim S As Screen = SList.Get(0)";
...
_s.setObject(_slist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("S", _s);
 BA.debugLineNum = 255;BA.debugLine="Return S";
Debug.ShouldStop(1073741824);
Debug.CheckDeviceExceptions();if (true) return _s;
 }else 
{ BA.debugLineNum = 256;BA.debugLine="Else If fx.Screens.Size> 1 Then";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean(">",__ref.getField(false,"_fx" /*RemoteObject*/ ).runMethod(false,"getScreens").runMethod(true,"getSize"),BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 257;BA.debugLine="Dim SList As List = fx.Screens";
Debug.ShouldStop(1);
_slist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_slist = __ref.getField(false,"_fx" /*RemoteObject*/ ).runMethod(false,"getScreens");Debug.locals.put("SList", _slist);Debug.locals.put("SList", _slist);
 BA.debugLineNum = 258;BA.debugLine="Dim S As Screen = SList.Get(2)";
Debug.ShouldStop(2);
_s = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX.ScreenWrapper");
_s.setObject(_slist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))));Debug.locals.put("S", _s);
 BA.debugLineNum = 260;BA.debugLine="Return S";
Debug.ShouldStop(8);
Debug.CheckDeviceExceptions();if (true) return _s;
 }else {
 BA.debugLineNum = 262;BA.debugLine="Dim SList As List = fx.Screens";
Debug.ShouldStop(32);
_slist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_slist = __ref.getField(false,"_fx" /*RemoteObject*/ ).runMethod(false,"getScreens");Debug.locals.put("SList", _slist);Debug.locals.put("SList", _slist);
 BA.debugLineNum = 263;BA.debugLine="Dim S As Screen = SList.Get(0)";
Debug.ShouldStop(64);
_s = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX.ScreenWrapper");
_s.setObject(_slist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("S", _s);
 BA.debugLineNum = 265;BA.debugLine="Return S";
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e16.toString()); BA.debugLineNum = 268;BA.debugLine="Dim SList As List = fx.Screens";
Debug.ShouldStop(2048);
_slist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_slist = __ref.getField(false,"_fx" /*RemoteObject*/ ).runMethod(false,"getScreens");Debug.locals.put("SList", _slist);Debug.locals.put("SList", _slist);
 BA.debugLineNum = 269;BA.debugLine="Dim S As Screen = SList.Get(0)";
Debug.ShouldStop(4096);
_s = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX.ScreenWrapper");
_s.setObject(_slist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("S", _s);
 BA.debugLineNum = 271;BA.debugLine="Return S";
...
try {
		Debug.PushSubsStack("clvActivity_ItemClick (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,179);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 179;BA.debugLine="Sub clvActivity_ItemClick (Index As Int, Value As";
Debug.ShouldStop(262144);
 BA.debugLineNum = 180;BA.debugLine="Try";
Debug.ShouldStop(524288);
try { BA.debugLineNum = 181;BA.debugLine="wvMedia.LoadUrl(\"\")";
Debug.ShouldStop(1048576);
__ref.getField(false,"_wvmedia" /*RemoteObject*/ ).runVoidMethod ("LoadUrl",(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 182;BA.debugLine="Dim video As String";
Debug.ShouldStop(2097152);
_video = RemoteObject.createImmutable("");Debug.locals.put("video", _video);
 BA.debugLineNum = 183;BA.debugLine="video = clvActivity.GetValue(Index)";
...
_video = BA.ObjectToString(__ref.getField(false,"_clvactivity" /*RemoteObject*/ ).runMethod(false,"_getvalue",(Object)(_index)));Debug.locals.put("video", _video);
 BA.debugLineNum = 184;BA.debugLine="Dim videoURL As String = Regex.Split(\"\\|\",video)";
...
_videourl = frmactivity.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString("\\|")),(Object)(_video)).getArrayElement(true,BA.numberCast(int.class, 0));Debug.locals.put("videoURL", _videourl);Debug.locals.put("videoURL", _videourl);
 BA.debugLineNum = 185;BA.debugLine="Dim videoTimestamp As String = Regex.Split(\"\\|\",";
Debug.ShouldStop(16777216);
_videotimestamp = frmactivity.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString("\\|")),(Object)(_video)).getArrayElement(true,BA.numberCast(int.class, 1));Debug.locals.put("videoTimestamp", _videotimestamp);Debug.locals.put("videoTimestamp", _videotimestamp);
 BA.debugLineNum = 186;BA.debugLine="ShowVideo(videoURL,videoTimestamp)";
Debug.ShouldStop(33554432);
__ref.runClassMethod (cloyd.blink.frmactivity.class, "_showvideo" /*void*/ ,(Object)(_videourl),(Object)(_videotimestamp));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e9) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e9.toString()); BA.debugLineNum = 188;BA.debugLine="Log(LastException)";
Debug.ShouldStop(134217728);
frmactivity.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(frmactivity.__c.runMethod(false,"LastException",__ref.getField(false, "ba")))));
 BA.debugLineNum = 189;BA.debugLine="fx.Msgbox2(frm,LastException,\"clvActivity ItemCl";
Debug.ShouldStop(268435456);
...
_ticks = __ref.runClassMethod (cloyd.blink.frmactivity.class, "_parseutcstring" /*RemoteObject*/ ,(Object)(_inputtime.runMethod(true,"replace",(Object)(BA.ObjectToString("+00:00")),(Object)(RemoteObject.createImmutable("+0000")))));Debug.locals.put("ticks", _ticks);Debug.locals.put("ticks", _ticks);
 BA.debugLineNum = 124;BA.debugLine="DateTime.DateFormat = \"MMM d, yyyy h:mm:ss a z\"";
Debug.ShouldStop(134217728);
frmactivity.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("MMM d, yyyy h:mm:ss a z"));
...
_p = frmactivity._dateutils.runMethod(false,"_periodbetween",(Object)(_lngticks),(Object)(frmactivity.__c.getField(false,"DateTime").runMethod(true,"getNow")));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 128;BA.debugLine="Return p.Days & \"d \" & p.Hours & \"h \" & p.Minutes";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("ConvertFullDateTime (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,131);
...
RemoteObject _lngticks = RemoteObject.createImmutable(0L);
Debug.locals.put("inputTime", _inputtime);
 BA.debugLineNum = 131;BA.debugLine="Sub ConvertFullDateTime(inputTime As String) As St";
Debug.ShouldStop(4);
 BA.debugLineNum = 133;BA.debugLine="Dim ticks As Long = ParseUTCstring(inputTime.Repl";
Debug.ShouldStop(16);
_ticks = __ref.runClassMethod (cloyd.blink.frmactivity.class, "_parseutcstring" /*RemoteObject*/ ,(Object)(_inputtime.runMethod(true,"replace",(Object)(BA.ObjectToString("+00:00")),(Object)(RemoteObject.createImmutable("+0000")))));Debug.locals.put("ticks", _ticks);Debug.locals.put("ticks", _ticks);
 BA.debugLineNum = 134;BA.debugLine="DateTime.DateFormat = \"MMM d, yyyy h:mm:ss a z\"";
Debug.ShouldStop(32);
frmactivity.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("MMM d, yyyy h:mm:ss a z"));
 BA.debugLineNum = 135;BA.debugLine="Dim lngTicks As Long = ticks";
Debug.ShouldStop(64);
_lngticks = _ticks;Debug.locals.put("lngTicks", _lngticks);Debug.locals.put("lngTicks", _lngticks);
 BA.debugLineNum = 138;BA.debugLine="Return DateTime.Date(lngTicks)";
Debug.ShouldStop(512);
Debug.CheckDeviceExceptions();if (true) return frmactivity.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_lngticks));
...
try {
		Debug.PushSubsStack("frm_CloseRequest (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,225);
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 225;BA.debugLine="Sub frm_CloseRequest (EventData As Event)";
Debug.ShouldStop(1);
 BA.debugLineNum = 226;BA.debugLine="wvMedia.LoadUrl(\"\")";
Debug.ShouldStop(2);
__ref.getField(false,"_wvmedia" /*RemoteObject*/ ).runVoidMethod ("LoadUrl",(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 227;BA.debugLine="wvMedia.RemoveNodeFromParent";
Debug.ShouldStop(4);
__ref.getField(false,"_wvmedia" /*RemoteObject*/ ).runVoidMethod ("RemoveNodeFromParent");
 BA.debugLineNum = 228;BA.debugLine="File.Delete(File.DirApp,\"screenshot.jpg\")";
Debug.ShouldStop(8);
frmactivity.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(frmactivity.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("screenshot.jpg")));
 BA.debugLineNum = 229;BA.debugLine="File.Delete(File.DirApp,\"media.mp4\")";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("ParseUTCstring (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,142);
...
Debug.locals.put("utc", _utc);
 BA.debugLineNum = 142;BA.debugLine="Sub ParseUTCstring(utc As String) As Long";
Debug.ShouldStop(8192);
 BA.debugLineNum = 143;BA.debugLine="Dim df As String = DateTime.DateFormat";
Debug.ShouldStop(16384);
_df = frmactivity.__c.getField(false,"DateTime").runMethod(true,"getDateFormat");Debug.locals.put("df", _df);Debug.locals.put("df", _df);
 BA.debugLineNum = 144;BA.debugLine="Dim res As Long";
Debug.ShouldStop(32768);
_res = RemoteObject.createImmutable(0L);Debug.locals.put("res", _res);
 BA.debugLineNum = 145;BA.debugLine="If utc.CharAt(10) = \"T\" Then";
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean("=",_utc.runMethod(true,"charAt",(Object)(BA.numberCast(int.class, 10))),BA.ObjectToChar("T"))) { 
 BA.debugLineNum = 147;BA.debugLine="If utc.CharAt(19) = \".\" Then utc = utc.SubString";
Debug.ShouldStop(262144);
...
_utc = RemoteObject.concat(_utc.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 19))),RemoteObject.createImmutable("+0000"));Debug.locals.put("utc", _utc);};
 BA.debugLineNum = 148;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd'T'HH:mm:ssZ\"";
Debug.ShouldStop(524288);
frmactivity.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd'T'HH:mm:ssZ"));
 }else {
 BA.debugLineNum = 151;BA.debugLine="DateTime.DateFormat = \"EEE MMM dd HH:mm:ss Z yyy";
Debug.ShouldStop(4194304);
...
Debug.ShouldStop(16777216);
try { BA.debugLineNum = 154;BA.debugLine="res = DateTime.DateParse(utc)";
Debug.ShouldStop(33554432);
_res = frmactivity.__c.getField(false,"DateTime").runMethod(true,"DateParse",(Object)(_utc));Debug.locals.put("res", _res);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e12) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e12.toString()); BA.debugLineNum = 156;BA.debugLine="res = 0";
Debug.ShouldStop(134217728);
_res = BA.numberCast(long.class, 0);Debug.locals.put("res", _res);
 };
 BA.debugLineNum = 158;BA.debugLine="DateTime.DateFormat = df";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("RootPaneKeyEvent_Event (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,232);
...
Debug.locals.put("e", _e);
 BA.debugLineNum = 232;BA.debugLine="Private Sub RootPaneKeyEvent_Event(e As Event)";
Debug.ShouldStop(128);
 BA.debugLineNum = 233;BA.debugLine="Dim KE As Reflector";
Debug.ShouldStop(256);
_ke = RemoteObject.createNew ("anywheresoftware.b4j.agraham.reflection.Reflection");Debug.locals.put("KE", _ke);
 BA.debugLineNum = 234;BA.debugLine="Dim sCode As String";
Debug.ShouldStop(512);
_scode = RemoteObject.createImmutable("");Debug.locals.put("sCode", _scode);
 BA.debugLineNum = 235;BA.debugLine="Dim sType As String 'ignore";
Debug.ShouldStop(1024);
_stype = RemoteObject.createImmutable("");Debug.locals.put("sType", _stype);
 BA.debugLineNum = 236;BA.debugLine="Dim result As Int 'ignore";
Debug.ShouldStop(2048);
_result = RemoteObject.createImmutable(0);Debug.locals.put("result", _result);
 BA.debugLineNum = 237;BA.debugLine="KE.Target = e	 ' e is a KeyEvent instance";
Debug.ShouldStop(4096);
_ke.setField ("Target",(_e.getObject()));
 BA.debugLineNum = 238;BA.debugLine="sCode = KE.RunMethod(\"getCode\")";
Debug.ShouldStop(8192);
_scode = BA.ObjectToString(_ke.runMethod(false,"RunMethod",(Object)(RemoteObject.createImmutable("getCode"))));Debug.locals.put("sCode", _scode);
 BA.debugLineNum = 239;BA.debugLine="sType = KE.RunMethod(\"getEventType\")";
Debug.ShouldStop(16384);
_stype = BA.ObjectToString(_ke.runMethod(false,"RunMethod",(Object)(RemoteObject.createImmutable("getEventType"))));Debug.locals.put("sType", _stype);
 BA.debugLineNum = 240;BA.debugLine="If sCode=\"ESCAPE\" Then";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean("=",_scode,BA.ObjectToString("ESCAPE"))) { 
 BA.debugLineNum = 241;BA.debugLine="wvMedia.LoadUrl(\"\")";
Debug.ShouldStop(65536);
__ref.getField(false,"_wvmedia" /*RemoteObject*/ ).runVoidMethod ("LoadUrl",(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 242;BA.debugLine="wvMedia.RemoveNodeFromParent";
Debug.ShouldStop(131072);
__ref.getField(false,"_wvmedia" /*RemoteObject*/ ).runVoidMethod ("RemoveNodeFromParent");
 BA.debugLineNum = 243;BA.debugLine="File.Delete(File.DirApp,\"screenshot.jpg\")";
Debug.ShouldStop(262144);
frmactivity.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(frmactivity.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("screenshot.jpg")));
 BA.debugLineNum = 244;BA.debugLine="File.Delete(File.DirApp,\"media.mp4\")";
Debug.ShouldStop(524288);
frmactivity.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(frmactivity.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("media.mp4")));
 BA.debugLineNum = 245;BA.debugLine="frm.Close";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("ShowVideo (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,194);
...
Debug.ShouldStop(8);
_j = RemoteObject.createNew ("cloyd.blink.httpjob");Debug.locals.put("j", _j);
 BA.debugLineNum = 197;BA.debugLine="j.Initialize(\"\", Me)";
Debug.ShouldStop(16);
_j.runClassMethod (cloyd.blink.httpjob.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(BA.ObjectToString("")),(Object)(__ref));
 BA.debugLineNum = 198;BA.debugLine="j.Download(Link)";
Debug.ShouldStop(32);
_j.runClassMethod (cloyd.blink.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(_link));
 BA.debugLineNum = 199;BA.debugLine="j.GetRequest.SetHeader(\"TOKEN_AUTH\", authToken)";
Debug.ShouldStop(64);
_j.runClassMethod (cloyd.blink.httpjob.class, "_getrequest" /*RemoteObject*/ ).runVoidMethod ("SetHeader",(Object)(BA.ObjectToString("TOKEN_AUTH")),(Object)(__ref.getField(true,"_authtoken" /*RemoteObject*/ )));
 BA.debugLineNum = 200;BA.debugLine="Wait For (j) JobDone(j As HttpJob)";
Debug.ShouldStop(128);
...
//C
this.state = 9;
 BA.debugLineNum = 203;BA.debugLine="Dim out As OutputStream = File.OpenOutput(File.";
Debug.ShouldStop(1024);
_out = RemoteObject.createNew ("anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper");
_out = parent.__c.getField(false,"File").runMethod(false,"OpenOutput",(Object)(parent.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(BA.ObjectToString("media.mp4")),(Object)(parent.__c.getField(true,"False")));Debug.locals.put("out", _out);Debug.locals.put("out", _out);
 BA.debugLineNum = 204;BA.debugLine="File.Copy2(j.GetInputStream, out)";
Debug.ShouldStop(2048);
parent.__c.getField(false,"File").runVoidMethod ("Copy2",(Object)((_j.runClassMethod (cloyd.blink.httpjob.class, "_getinputstream" /*RemoteObject*/ ).getObject())),(Object)((_out.getObject())));
 BA.debugLineNum = 205;BA.debugLine="out.Close '<------ very important";
Debug.ShouldStop(4096);
_out.runVoidMethod ("Close");
 BA.debugLineNum = 207;BA.debugLine="lblTimestamp.Text= timestamp";
Debug.ShouldStop(16384);
__ref.getField(false,"_lbltimestamp" /*RemoteObject*/ ).runMethod(true,"setText",_timestamp);
 BA.debugLineNum = 208;BA.debugLine="Dim sb As StringBuilder";
Debug.ShouldStop(32768);
_sb = RemoteObject.createNew ("anywheresoftware.b4a.keywords.StringBuilderWrapper");Debug.locals.put("sb", _sb);
 BA.debugLineNum = 209;BA.debugLine="sb.Initialize";
Debug.ShouldStop(65536);
_sb.runVoidMethod ("Initialize");
 BA.debugLineNum = 210;BA.debugLine="sb.Append(\"<video width='100%' height='100%' co";
Debug.ShouldStop(131072);
_sb.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("<video width='100%' height='100%' controls autoplay>")));
 BA.debugLineNum = 211;BA.debugLine="sb.Append(\"<source src='\" & File.GetUri(File.Di";
Debug.ShouldStop(262144);
_sb.runVoidMethod ("Append",(Object)(RemoteObject.concat(RemoteObject.createImmutable("<source src='"),parent.__c.getField(false,"File").runMethod(true,"GetUri",(Object)(parent.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("media.mp4"))),RemoteObject.createImmutable("' Type='video/mp4'/>"))));
 BA.debugLineNum = 212;BA.debugLine="sb.Append(\"</video>\")";
Debug.ShouldStop(524288);
_sb.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("</video>")));
 BA.debugLineNum = 214;BA.debugLine="wvMedia.LoadHtml(sb.ToString)";
Debug.ShouldStop(2097152);
...
this.state = 12;
;
 BA.debugLineNum = 218;BA.debugLine="j.Release";
Debug.ShouldStop(33554432);
_j.runClassMethod (cloyd.blink.httpjob.class, "_release" /*RemoteObject*/ );
 Debug.CheckDeviceExceptions();
if (true) break;
...
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")))));
 BA.debugLineNum = 221;BA.debugLine="fx.Msgbox2(frm,LastException,\"ShowVideo Exceptio";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("wvMedia_PageFinished (frmactivity) ","frmactivity",2,__ref.getField(false, "ba"),__ref,276);
...
Debug.locals.put("Url", _url);
 BA.debugLineNum = 276;BA.debugLine="Sub wvMedia_PageFinished (Url As String)";
Debug.ShouldStop(524288);
