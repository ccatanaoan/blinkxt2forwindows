...
try {
		Debug.PushSubsStack("Base_Resize (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,67);
...
__ref.runClassMethod (cloyd.blink.roundslider.class, "_createthumb" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.roundslider.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("CreateThumb (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,48);
...
Debug.JustUpdateDeviceLine();
_bc.runVoidMethod ("_drawpath",(Object)(_p),(Object)(BA.numberCast(int.class, 0xff5b5b5b)),(Object)(roundslider.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 60;BA.debugLine="bc.DrawCircle(r + g, r + g, r, xui.Color_White, T";
Debug.JustUpdateDeviceLine();
_bc.runVoidMethod ("_drawcircle",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_r,_g}, "+",1, 1))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_r,_g}, "+",1, 1))),(Object)(BA.numberCast(float.class, _r)),(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_White")),(Object)(roundslider.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 61;BA.debugLine="bc.DrawCircle(r + g, r + g, r, 0xFF5B5B5B, False,";
Debug.JustUpdateDeviceLine();
_bc.runVoidMethod ("_drawcircle",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_r,_g}, "+",1, 1))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_r,_g}, "+",1, 1))),(Object)(BA.numberCast(float.class, _r)),(Object)(BA.numberCast(int.class, 0xff5b5b5b)),(Object)(roundslider.__c.getField(true,"False")),(Object)(roundslider.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))));
...
try {
		Debug.PushSubsStack("DesignerCreateView (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,29);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.roundslider.class, "_base_resize" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")));
...
try {
		Debug.PushSubsStack("Draw (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,76);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle",(Object)(__ref.getField(false,"_circlerect" /*RemoteObject*/ ).runMethod(true,"getCenterX")),(Object)(__ref.getField(false,"_circlerect" /*RemoteObject*/ ).runMethod(true,"getCenterY")),(Object)(BA.numberCast(float.class, _radius)),(Object)(BA.numberCast(int.class, 0xffb6b6b6)),(Object)(roundslider.__c.getField(true,"False")),(Object)(BA.numberCast(float.class, __ref.getField(true,"_stroke" /*RemoteObject*/ ))));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle",(Object)(__ref.getField(false,"_circlerect" /*RemoteObject*/ ).runMethod(true,"getCenterX")),(Object)(__ref.getField(false,"_circlerect" /*RemoteObject*/ ).runMethod(true,"getCenterY")),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_radius,_b4jstrokeoffset}, "-",1, 1))),(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_White")),(Object)(roundslider.__c.getField(true,"True")),(Object)(BA.numberCast(float.class, 0)));
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,135);
...
try {
		Debug.PushSubsStack("Initialize (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,23);
...
try {
		Debug.PushSubsStack("pnl_MouseClicked (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("pnl_MousePressed (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("pnl_MouseReleased (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,125);
...
try {
		Debug.PushSubsStack("pnl_Touch (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,97);
...
try {
		Debug.PushSubsStack("setValue (roundslider) ","roundslider",23,__ref.getField(false, "ba"),__ref,130);
