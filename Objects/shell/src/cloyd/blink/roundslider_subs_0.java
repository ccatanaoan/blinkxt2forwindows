...
try {
		Debug.PushSubsStack("Base_Resize (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,84);
...
try {
		Debug.PushSubsStack("CreateThumb (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("DesignerCreateView (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("Draw (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,152);
...
try {
		Debug.PushSubsStack("Initialize (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("pnl_MouseClicked (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,138);
...
try {
		Debug.PushSubsStack("pnl_MousePressed (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,134);
...
try {
		Debug.PushSubsStack("pnl_MouseReleased (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,142);
...
try {
		Debug.PushSubsStack("pnl_Touch (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,114);
...
try {
		Debug.PushSubsStack("SetCircleColor (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("SetThumbColor (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("setValue (roundslider) ","roundslider",27,__ref.getField(false, "ba"),__ref,147);
