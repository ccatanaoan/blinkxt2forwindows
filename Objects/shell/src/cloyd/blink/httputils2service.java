...
public boolean isSingleton() {
    ...
    static {
		...
		remoteMe = RemoteObject.declareNull("cloyd.blink.httputils2service");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("httputils2service"), "cloyd.blink.httputils2service");
	}
