...
try {
		Debug.PushSubsStack("Base_Resize (b4xswitch) ","b4xswitch",23,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xswitch) ","b4xswitch",23,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("Draw (b4xswitch) ","b4xswitch",23,__ref.getField(false, "ba"),__ref,115);
...
try {
		Debug.PushSubsStack("getEnabled (b4xswitch) ","b4xswitch",23,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("getValue (b4xswitch) ","b4xswitch",23,__ref.getField(false, "ba"),__ref,102);
...
try {
		Debug.PushSubsStack("Initialize (b4xswitch) ","b4xswitch",23,__ref.getField(false, "ba"),__ref,25);
...
try {
		Debug.PushSubsStack("Pnl_MouseClicked (b4xswitch) ","b4xswitch",23,__ref.getField(false, "ba"),__ref,64);
...
try {
		Debug.PushSubsStack("setEnabled (b4xswitch) ","b4xswitch",23,__ref.getField(false, "ba"),__ref,106);
...
try {
		Debug.PushSubsStack("setValue (b4xswitch) ","b4xswitch",23,__ref.getField(false, "ba"),__ref,97);
...
try {
		Debug.PushSubsStack("SetValueImpl (b4xswitch) ","b4xswitch",23,__ref.getField(false, "ba"),__ref,75);
