...
try {
		Debug.PushSubsStack("Base_Resize (b4xswitch) ","b4xswitch",20,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xswitch) ","b4xswitch",20,__ref.getField(false, "ba"),__ref,31);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xswitch.class, "_setvalueimpl" /*void*/ ,(Object)(BA.ObjectToBoolean(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Value")))))),(Object)(b4xswitch.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("Draw (b4xswitch) ","b4xswitch",20,__ref.getField(false, "ba"),__ref,115);
...
try {
		Debug.PushSubsStack("getEnabled (b4xswitch) ","b4xswitch",20,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("getValue (b4xswitch) ","b4xswitch",20,__ref.getField(false, "ba"),__ref,102);
...
try {
		Debug.PushSubsStack("Initialize (b4xswitch) ","b4xswitch",20,__ref.getField(false, "ba"),__ref,25);
...
try {
		Debug.PushSubsStack("Pnl_MouseClicked (b4xswitch) ","b4xswitch",20,__ref.getField(false, "ba"),__ref,64);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xswitch.class, "_setvalueimpl" /*void*/ ,(Object)(b4xswitch.__c.runMethod(true,"Not",(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )))),(Object)(b4xswitch.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("setEnabled (b4xswitch) ","b4xswitch",20,__ref.getField(false, "ba"),__ref,106);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xswitch.class, "_setvalueimpl" /*void*/ ,(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )),(Object)(b4xswitch.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("setValue (b4xswitch) ","b4xswitch",20,__ref.getField(false, "ba"),__ref,97);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xswitch.class, "_setvalueimpl" /*void*/ ,(Object)(_b),(Object)(b4xswitch.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("SetValueImpl (b4xswitch) ","b4xswitch",20,__ref.getField(false, "ba"),__ref,75);
...
public ResumableSub_SetValueImpl(cloyd.blink.b4xswitch parent,RemoteObject __ref,RemoteObject _b,RemoteObject _immediate) {
this.parent = parent;
this.__ref = __ref;
this._b = _b;
...
//C
this.state = 11;
__ref.runClassMethod (cloyd.blink.b4xswitch.class, "_draw" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 1)));
if (true) break;

case 8:
//C
this.state = 11;
__ref.runClassMethod (cloyd.blink.b4xswitch.class, "_draw" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 0)));
if (true) break;
...
//do while
this.state = 29;
while (RemoteObject.solveBoolean("<",parent.__c.getField(false,"DateTime").runMethod(true,"getNow"),BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_start,_duration}, "+",1, 2)))) {
this.state = 16;
if (true) break;
}
if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xswitch.class, "_draw" /*RemoteObject*/ ,(Object)(_state1));
