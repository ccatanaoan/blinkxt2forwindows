...
try {
		Debug.PushSubsStack("Blur (main) ","main",0,main.ba,main.mostCurrent,1135);
...
Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 1135;BA.debugLine="Private Sub Blur (bmp As B4XBitmap) As B4XBitmap";
Debug.ShouldStop(16384);
 BA.debugLineNum = 1136;BA.debugLine="Try";
Debug.ShouldStop(32768);
try { BA.debugLineNum = 1137;BA.debugLine="Dim bc As BitmapCreator";
Debug.ShouldStop(65536);
_bc = RemoteObject.createNew ("b4j.example.bitmapcreator");Debug.locals.put("bc", _bc);
 BA.debugLineNum = 1138;BA.debugLine="Dim ReduceScale As Int = 2";
Debug.ShouldStop(131072);
_reducescale = BA.numberCast(int.class, 2);Debug.locals.put("ReduceScale", _reducescale);Debug.locals.put("ReduceScale", _reducescale);
 BA.debugLineNum = 1139;BA.debugLine="bc.Initialize(bmp.Width / ReduceScale / bmp.Scal";
Debug.ShouldStop(262144);
...
Debug.locals.put("steps", _steps);
 BA.debugLineNum = 1146;BA.debugLine="For y = 0 To bc.mHeight - 1";
Debug.ShouldStop(33554432);
{
final int step11 = 1;
...
Debug.locals.put("y", _y);
 BA.debugLineNum = 1147;BA.debugLine="For x = 0 To 2";
Debug.ShouldStop(67108864);
{
final int step12 = 1;
final int limit12 = 2;
...
Debug.locals.put("x", _x);
 BA.debugLineNum = 1148;BA.debugLine="bc.GetARGB(x, y, clrs(x))";
Debug.ShouldStop(134217728);
...
;
 BA.debugLineNum = 1150;BA.debugLine="SetAvg(bc, 1, y, clrs, temp)";
Debug.ShouldStop(536870912);
_setavg(_bc,BA.numberCast(int.class, 1),BA.numberCast(int.class, _y),_clrs,_temp);
 BA.debugLineNum = 1151;BA.debugLine="m = 0";
Debug.ShouldStop(1073741824);
_m = BA.numberCast(int.class, 0);Debug.locals.put("m", _m);
 BA.debugLineNum = 1152;BA.debugLine="For x = 2 To bc.mWidth - 2";
Debug.ShouldStop(-2147483648);
{
final int step17 = 1;
...
Debug.locals.put("x", _x);
 BA.debugLineNum = 1153;BA.debugLine="bc.GetARGB(x + 1, y, clrs(m))";
Debug.ShouldStop(1);
_bc.runVoidMethod ("_getargb",(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_x),RemoteObject.createImmutable(1)}, "+",1, 1)),(Object)(BA.numberCast(int.class, _y)),(Object)(_clrs.getArrayElement(false,_m)));
 BA.debugLineNum = 1154;BA.debugLine="m = (m + 1) Mod clrs.Length";
Debug.ShouldStop(2);
_m = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_m,RemoteObject.createImmutable(1)}, "+",1, 1)),_clrs.getField(true,"length")}, "%",0, 1);Debug.locals.put("m", _m);
 BA.debugLineNum = 1155;BA.debugLine="SetAvg(bc, x, y, clrs, temp)";
Debug.ShouldStop(4);
...
;
 BA.debugLineNum = 1158;BA.debugLine="For x = 0 To bc.mWidth - 1";
Debug.ShouldStop(32);
{
final int step23 = 1;
...
Debug.locals.put("x", _x);
 BA.debugLineNum = 1159;BA.debugLine="For y = 0 To 2";
Debug.ShouldStop(64);
{
final int step24 = 1;
final int limit24 = 2;
...
Debug.locals.put("y", _y);
 BA.debugLineNum = 1160;BA.debugLine="bc.GetARGB(x, y, clrs(y))";
Debug.ShouldStop(128);
...
;
 BA.debugLineNum = 1162;BA.debugLine="SetAvg(bc, x, 1, clrs, temp)";
Debug.ShouldStop(512);
_setavg(_bc,BA.numberCast(int.class, _x),BA.numberCast(int.class, 1),_clrs,_temp);
 BA.debugLineNum = 1163;BA.debugLine="m = 0";
Debug.ShouldStop(1024);
_m = BA.numberCast(int.class, 0);Debug.locals.put("m", _m);
 BA.debugLineNum = 1164;BA.debugLine="For y = 2 To bc.mHeight - 2";
Debug.ShouldStop(2048);
{
final int step29 = 1;
...
Debug.locals.put("y", _y);
 BA.debugLineNum = 1165;BA.debugLine="bc.GetARGB(x, y + 1, clrs(m))";
Debug.ShouldStop(4096);
_bc.runVoidMethod ("_getargb",(Object)(BA.numberCast(int.class, _x)),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_y),RemoteObject.createImmutable(1)}, "+",1, 1)),(Object)(_clrs.getArrayElement(false,_m)));
 BA.debugLineNum = 1166;BA.debugLine="m = (m + 1) Mod clrs.Length";
Debug.ShouldStop(8192);
_m = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_m,RemoteObject.createImmutable(1)}, "+",1, 1)),_clrs.getField(true,"length")}, "%",0, 1);Debug.locals.put("m", _m);
 BA.debugLineNum = 1167;BA.debugLine="SetAvg(bc, x, y, clrs, temp)";
Debug.ShouldStop(16384);
_setavg(_bc,BA.numberCast(int.class, _x),BA.numberCast(int.class, _y),_clrs,_temp);
 }
}Debug.locals.put("y", _y);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e37.toString()); BA.debugLineNum = 1172;BA.debugLine="Log(LastException)";
Debug.ShouldStop(524288);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 1173;BA.debugLine="fx.msgbox(MainForm,\"Blur LastException: \" & Last";
Debug.ShouldStop(1048576);
main._fx.runVoidMethodAndSync ("Msgbox",(Object)(main._mainform),(Object)(RemoteObject.concat(RemoteObject.createImmutable("Blur LastException: "),main.__c.runMethod(false,"LastException",main.ba))),(Object)(main._mainform.runMethod(true,"getTitle")));
 ...
 BA.debugLineNum = 1175;BA.debugLine="Return bc.Bitmap";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("BlurIV (main) ","main",0,main.ba,main.mostCurrent,1125);
...
Debug.locals.put("iv", _iv);
 BA.debugLineNum = 1125;BA.debugLine="Sub BlurIV (image As String,iv As ImageView)";
Debug.ShouldStop(16);
 BA.debugLineNum = 1126;BA.debugLine="Try";
Debug.ShouldStop(32);
try { BA.debugLineNum = 1127;BA.debugLine="Dim bmp As B4XBitmap = xui.LoadBitmapResize(File";
Debug.ShouldStop(64);
...
_bmp = main._xui.runMethod(false,"LoadBitmapResize",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(_image),(Object)(BA.numberCast(int.class, _iv.runMethod(true,"getWidth"))),(Object)(BA.numberCast(int.class, _iv.runMethod(true,"getHeight"))),(Object)(main.__c.getField(true,"True")));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 1128;BA.debugLine="iv.SetImage(Blur(bmp))";
Debug.ShouldStop(128);
_iv.runVoidMethod ("SetImage",(Object)((_blur(_bmp).getObject())));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e5) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e5.toString()); BA.debugLineNum = 1130;BA.debugLine="Log(LastException)";
Debug.ShouldStop(512);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 1131;BA.debugLine="fx.msgbox(MainForm,\"BlurIV LastException: \" & La";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("btnActivity_Click (main) ","main",0,main.ba,main.mostCurrent,1198);
...
//C
this.state = -1;
 BA.debugLineNum = 1199;BA.debugLine="btnDriveway.Enabled = False";
Debug.ShouldStop(16384);
parent._btndriveway.runMethod(true,"setEnabled",parent.__c.getField(true,"False"));
 BA.debugLineNum = 1200;BA.debugLine="btnRefresh.Enabled = False";
Debug.ShouldStop(32768);
parent._btnrefresh.runMethod(true,"setEnabled",parent.__c.getField(true,"False"));
 BA.debugLineNum = 1201;BA.debugLine="btnActivity.Enabled = False";
Debug.ShouldStop(65536);
parent._btnactivity.runMethod(true,"setEnabled",parent.__c.getField(true,"False"));
 BA.debugLineNum = 1203;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immedia-s";
Debug.ShouldStop(262144);
_restget(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/api/v1/accounts/88438/media/changed?since=-999999999-01-01T00:00:00+18:00&page=1")));
 BA.debugLineNum = 1205;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("btnRefresh_Click (main) ","main",0,main.ba,main.mostCurrent,1306);
if (RapidSub.canDelegate("btnrefresh_click")) { return cloyd.blink.main.remoteMe.runUserSub(false, "main","btnrefresh_click");}
 BA.debugLineNum = 1306;BA.debugLine="Sub btnRefresh_Click";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 1307;BA.debugLine="btnDriveway.Enabled = False";
Debug.ShouldStop(67108864);
main._btndriveway.runMethod(true,"setEnabled",main.__c.getField(true,"False"));
 BA.debugLineNum = 1308;BA.debugLine="btnRefresh.Enabled = False";
Debug.ShouldStop(134217728);
main._btnrefresh.runMethod(true,"setEnabled",main.__c.getField(true,"False"));
 BA.debugLineNum = 1309;BA.debugLine="btnActivity.Enabled = False";
Debug.ShouldStop(268435456);
main._btnactivity.runMethod(true,"setEnabled",main.__c.getField(true,"False"));
 BA.debugLineNum = 1310;BA.debugLine="BlurIV(\"Driveway.jpg\",ivDriveway)";
Debug.ShouldStop(536870912);
_bluriv(BA.ObjectToString("Driveway.jpg"),main._ivdriveway);
 BA.debugLineNum = 1311;BA.debugLine="BlurIV(\"FrontDoor.jpg\",ivFrontDoor)";
Debug.ShouldStop(1073741824);
_bluriv(BA.ObjectToString("FrontDoor.jpg"),main._ivfrontdoor);
 BA.debugLineNum = 1312;BA.debugLine="BlurIV(\"SideYard.jpg\",ivSideYard)";
Debug.ShouldStop(-2147483648);
_bluriv(BA.ObjectToString("SideYard.jpg"),main._ivsideyard);
 BA.debugLineNum = 1313;BA.debugLine="RefreshCameras(True)";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("ConvertDateTime (main) ","main",0,main.ba,main.mostCurrent,1226);
...
Debug.locals.put("inputTime", _inputtime);
 BA.debugLineNum = 1226;BA.debugLine="Sub ConvertDateTime(inputTime As String) As String";
Debug.ShouldStop(512);
 BA.debugLineNum = 1228;BA.debugLine="Dim timestampProcessed As String";
Debug.ShouldStop(2048);
_timestampprocessed = RemoteObject.createImmutable("");Debug.locals.put("timestampProcessed", _timestampprocessed);
 BA.debugLineNum = 1229;BA.debugLine="timestampProcessed =  ConvertFullDateTime(inputTi";
Debug.ShouldStop(4096);
_timestampprocessed = _convertfulldatetime(_inputtime);Debug.locals.put("timestampProcessed", _timestampprocessed);
 BA.debugLineNum = 1231;BA.debugLine="Dim ticks As Long = ParseUTCstring(inputTime.Repl";
Debug.ShouldStop(16384);
_ticks = _parseutcstring(_inputtime.runMethod(true,"replace",(Object)(BA.ObjectToString("+00:00")),(Object)(RemoteObject.createImmutable("+0000"))));Debug.locals.put("ticks", _ticks);Debug.locals.put("ticks", _ticks);
 BA.debugLineNum = 1232;BA.debugLine="DateTime.DateFormat = \"MMM d, yyyy h:mm:ss a\"";
Debug.ShouldStop(32768);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("MMM d, yyyy h:mm:ss a"));
 BA.debugLineNum = 1233;BA.debugLine="Dim lngTicks As Long = ticks";
Debug.ShouldStop(65536);
_lngticks = _ticks;Debug.locals.put("lngTicks", _lngticks);Debug.locals.put("lngTicks", _lngticks);
 BA.debugLineNum = 1234;BA.debugLine="Dim p As Period = DateUtils.PeriodBetween(lngTick";
Debug.ShouldStop(131072);
_p = main._dateutils.runMethod(false,"_periodbetween",(Object)(_lngticks),(Object)(main.__c.getField(false,"DateTime").runMethod(true,"getNow")));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 1236;BA.debugLine="If timestampProcessed.Contains(\"Yesterday\") Or ti";
Debug.ShouldStop(524288);
...
if (true) return RemoteObject.concat(_timestampprocessed,RemoteObject.createImmutable(" ("),_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago)"));
 ...
 BA.debugLineNum = 1242;BA.debugLine="Return timestampProcessed & \" (\" & p.Minutes";
Debug.ShouldStop(33554432);
if (true) return RemoteObject.concat(_timestampprocessed,RemoteObject.createImmutable(" ("),_p.getField(true,"Minutes"),RemoteObject.createImmutable("m "),_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago)"));
 ...
 BA.debugLineNum = 1245;BA.debugLine="Return timestampProcessed & \" (\" & p.Hours & \"";
Debug.ShouldStop(268435456);
...
{ BA.debugLineNum = 1247;BA.debugLine="else If p.Hours = 0 Then";
Debug.ShouldStop(1073741824);
if (RemoteObject.solveBoolean("=",_p.getField(true,"Hours"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 1248;BA.debugLine="If p.Minutes = 0 Then";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean("=",_p.getField(true,"Minutes"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 1249;BA.debugLine="Return timestampProcessed & \" (\" & p.Seconds &";
Debug.ShouldStop(1);
if (true) return RemoteObject.concat(_timestampprocessed,RemoteObject.createImmutable(" ("),_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago)"));
 }else {
 BA.debugLineNum = 1251;BA.debugLine="Return timestampProcessed & \" (\" & p.Minutes &";
Debug.ShouldStop(4);
if (true) return RemoteObject.concat(_timestampprocessed,RemoteObject.createImmutable(" ("),_p.getField(true,"Minutes"),RemoteObject.createImmutable("m "),_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago)"));
 };
 }else 
{ BA.debugLineNum = 1253;BA.debugLine="else If p.Minutes = 0 Then";
Debug.ShouldStop(16);
if (RemoteObject.solveBoolean("=",_p.getField(true,"Minutes"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 1254;BA.debugLine="Return timestampProcessed & \" (\" & p.Seconds &";
Debug.ShouldStop(32);
if (true) return RemoteObject.concat(_timestampprocessed,RemoteObject.createImmutable(" ("),_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago)"));
 }else {
 BA.debugLineNum = 1256;BA.debugLine="Return timestampProcessed & \" (\" & p.Days & \"d";
Debug.ShouldStop(128);
...
;
 ...
 BA.debugLineNum = 1259;BA.debugLine="Return timestampProcessed & \" (\" & p.Days & \"d \"";
Debug.ShouldStop(1024);
if (true) return RemoteObject.concat(_timestampprocessed,RemoteObject.createImmutable(" ("),_p.getField(true,"Days"),RemoteObject.createImmutable("d "),_p.getField(true,"Hours"),RemoteObject.createImmutable("h "),_p.getField(true,"Minutes"),RemoteObject.createImmutable("m "),_p.getField(true,"Seconds"),RemoteObject.createImmutable("s ago)"));
 };
...
try {
		Debug.PushSubsStack("ConvertDateTimePlain (main) ","main",0,main.ba,main.mostCurrent,1216);
...
RemoteObject _lngticks = RemoteObject.createImmutable(0L);
Debug.locals.put("inputTime", _inputtime);
 BA.debugLineNum = 1216;BA.debugLine="Sub ConvertDateTimePlain(inputTime As String) As S";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 1218;BA.debugLine="Dim ticks As Long = ParseUTCstring(inputTime.Repl";
Debug.ShouldStop(2);
_ticks = _parseutcstring(_inputtime.runMethod(true,"replace",(Object)(BA.ObjectToString("+00:00")),(Object)(RemoteObject.createImmutable("+0000"))));Debug.locals.put("ticks", _ticks);Debug.locals.put("ticks", _ticks);
 BA.debugLineNum = 1219;BA.debugLine="DateTime.DateFormat = \"MMM d, yyyy h:mm:ss a\"";
Debug.ShouldStop(4);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("MMM d, yyyy h:mm:ss a"));
 BA.debugLineNum = 1220;BA.debugLine="Dim lngTicks As Long = ticks";
Debug.ShouldStop(8);
_lngticks = _ticks;Debug.locals.put("lngTicks", _lngticks);Debug.locals.put("lngTicks", _lngticks);
 BA.debugLineNum = 1223;BA.debugLine="Return DateTime.Date(lngTicks)";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("ConvertFullDateTime (main) ","main",0,main.ba,main.mostCurrent,1264);
...
Debug.locals.put("inputTime", _inputtime);
 BA.debugLineNum = 1264;BA.debugLine="Sub ConvertFullDateTime(inputTime As String) As St";
Debug.ShouldStop(32768);
 BA.debugLineNum = 1266;BA.debugLine="Dim ticks As Long = ParseUTCstring(inputTime.Repl";
Debug.ShouldStop(131072);
_ticks = _parseutcstring(_inputtime.runMethod(true,"replace",(Object)(BA.ObjectToString("+00:00")),(Object)(RemoteObject.createImmutable("+0000"))));Debug.locals.put("ticks", _ticks);Debug.locals.put("ticks", _ticks);
 BA.debugLineNum = 1267;BA.debugLine="DateTime.DateFormat = \"MMM d, yyyy h:mm:ss a\"";
Debug.ShouldStop(262144);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("MMM d, yyyy h:mm:ss a"));
 BA.debugLineNum = 1268;BA.debugLine="Dim lngTicks As Long = ticks";
Debug.ShouldStop(524288);
_lngticks = _ticks;Debug.locals.put("lngTicks", _lngticks);Debug.locals.put("lngTicks", _lngticks);
 BA.debugLineNum = 1270;BA.debugLine="Dim Yesterday As Long";
Debug.ShouldStop(2097152);
_yesterday = RemoteObject.createImmutable(0L);Debug.locals.put("Yesterday", _yesterday);
 BA.debugLineNum = 1271;BA.debugLine="Dim timestamp As Long";
Debug.ShouldStop(4194304);
_timestamp = RemoteObject.createImmutable(0L);Debug.locals.put("timestamp", _timestamp);
 BA.debugLineNum = 1272;BA.debugLine="DateTime.DateFormat = \"yyyyMMdd\"";
Debug.ShouldStop(8388608);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyyMMdd"));
 BA.debugLineNum = 1273;BA.debugLine="Yesterday = DateTime.Date(DateTime.add(DateTime.N";
Debug.ShouldStop(16777216);
_yesterday = BA.numberCast(long.class, main.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(main.__c.getField(false,"DateTime").runMethod(true,"Add",(Object)(main.__c.getField(false,"DateTime").runMethod(true,"getNow")),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, -(double) (0 + 1)))))));Debug.locals.put("Yesterday", _yesterday);
 BA.debugLineNum = 1274;BA.debugLine="timestamp = DateTime.Date(lngTicks)";
Debug.ShouldStop(33554432);
_timestamp = BA.numberCast(long.class, main.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_lngticks)));Debug.locals.put("timestamp", _timestamp);
 BA.debugLineNum = 1276;BA.debugLine="DateTime.DateFormat = \"h:mm:ss a\"";
Debug.ShouldStop(134217728);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("h:mm:ss a"));
 BA.debugLineNum = 1277;BA.debugLine="If DateUtils.IsSameDay(lngTicks,DateTime.now) The";
Debug.ShouldStop(268435456);
if (main._dateutils.runMethod(true,"_issameday",(Object)(_lngticks),(Object)(main.__c.getField(false,"DateTime").runMethod(true,"getNow"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1278;BA.debugLine="Return \"Today \" & DateTime.Date(lngTicks)";
Debug.ShouldStop(536870912);
...
{ BA.debugLineNum = 1279;BA.debugLine="Else If Yesterday = timestamp Then";
Debug.ShouldStop(1073741824);
if (RemoteObject.solveBoolean("=",_yesterday,BA.numberCast(double.class, _timestamp))) { 
 BA.debugLineNum = 1280;BA.debugLine="Return \"Yesterday \" & DateTime.Date(lngTicks)";
Debug.ShouldStop(-2147483648);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Yesterday "),main.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_lngticks)));
 ...
 BA.debugLineNum = 1282;BA.debugLine="Return DateUtils.GetDayOfWeekName(lngTicks) & \"";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("GetLiveView (main) ","main",0,main.ba,main.mostCurrent,1076);
...
Debug.locals.put("json", _json);
 BA.debugLineNum = 1076;BA.debugLine="Sub GetLiveView(json As String)";
Debug.ShouldStop(524288);
 BA.debugLineNum = 1077;BA.debugLine="Try";
Debug.ShouldStop(1048576);
try { BA.debugLineNum = 1078;BA.debugLine="Dim parser As JSONParser";
Debug.ShouldStop(2097152);
_parser = RemoteObject.createNew ("anywheresoftware.b4j.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 1079;BA.debugLine="parser.Initialize(json)";
Debug.ShouldStop(4194304);
_parser.runVoidMethod ("Initialize",(Object)(_json));
 BA.debugLineNum = 1080;BA.debugLine="Dim root As Map = parser.NextObject";
Debug.ShouldStop(8388608);
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _parser.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 1081;BA.debugLine="Dim duration As Int = root.Get(\"duration\")";
Debug.ShouldStop(16777216);
_duration = BA.numberCast(int.class, _root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("duration")))));Debug.locals.put("duration", _duration);Debug.locals.put("duration", _duration);
 BA.debugLineNum = 1082;BA.debugLine="Dim server As String = root.Get(\"server\")";
Debug.ShouldStop(33554432);
_server = BA.ObjectToString(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("server")))));Debug.locals.put("server", _server);Debug.locals.put("server", _server);
 BA.debugLineNum = 1083;BA.debugLine="Dim device_name As String = root.Get(\"device_nam";
Debug.ShouldStop(67108864);
_device_name = BA.ObjectToString(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("device_name")))));Debug.locals.put("device_name", _device_name);Debug.locals.put("device_name", _device_name);
 BA.debugLineNum = 1084;BA.debugLine="Dim network_id As Int = root.Get(\"network_id\")";
Debug.ShouldStop(134217728);
_network_id = BA.numberCast(int.class, _root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("network_id")))));Debug.locals.put("network_id", _network_id);Debug.locals.put("network_id", _network_id);
 BA.debugLineNum = 1085;BA.debugLine="Dim continue_interval As Int = root.Get(\"continu";
Debug.ShouldStop(268435456);
_continue_interval = BA.numberCast(int.class, _root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("continue_interval")))));Debug.locals.put("continue_interval", _continue_interval);Debug.locals.put("continue_interval", _continue_interval);
 BA.debugLineNum = 1086;BA.debugLine="Dim continue_warning As Int = root.Get(\"continue";
Debug.ShouldStop(536870912);
_continue_warning = BA.numberCast(int.class, _root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("continue_warning")))));Debug.locals.put("continue_warning", _continue_warning);Debug.locals.put("continue_warning", _continue_warning);
 BA.debugLineNum = 1087;BA.debugLine="Dim id As Int = root.Get(\"id\")";
Debug.ShouldStop(1073741824);
_id = BA.numberCast(int.class, _root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("id")))));Debug.locals.put("id", _id);Debug.locals.put("id", _id);
 BA.debugLineNum = 1088;BA.debugLine="Dim submit_logs As String = root.Get(\"submit_log";
Debug.ShouldStop(-2147483648);
_submit_logs = BA.ObjectToString(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("submit_logs")))));Debug.locals.put("submit_logs", _submit_logs);Debug.locals.put("submit_logs", _submit_logs);
 BA.debugLineNum = 1089;BA.debugLine="Dim camera_name As String = root.Get(\"camera_nam";
Debug.ShouldStop(1);
_camera_name = BA.ObjectToString(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("camera_name")))));Debug.locals.put("camera_name", _camera_name);Debug.locals.put("camera_name", _camera_name);
 BA.debugLineNum = 1090;BA.debugLine="Dim lv_save As String = root.Get(\"lv_save\")";
Debug.ShouldStop(2);
_lv_save = BA.ObjectToString(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("lv_save")))));Debug.locals.put("lv_save", _lv_save);Debug.locals.put("lv_save", _lv_save);
 BA.debugLineNum = 1091;BA.debugLine="Log(\"Liveview: \" & server)";
Debug.ShouldStop(4);
main.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("Liveview: "),_server)));
 BA.debugLineNum = 1092;BA.debugLine="Dim mp As MediaPlayer";
Debug.ShouldStop(8);
_mp = RemoteObject.createNew ("anywheresoftware.b4j.objects.MediaPlayerWrapper");Debug.locals.put("mp", _mp);
 BA.debugLineNum = 1093;BA.debugLine="mp.Initialize(\"mp\", server)";
Debug.ShouldStop(16);
_mp.runVoidMethod ("Initialize",main.ba,(Object)(BA.ObjectToString("mp")),(Object)(_server));
 BA.debugLineNum = 1094;BA.debugLine="mp.Play";
Debug.ShouldStop(32);
_mp.runVoidMethod ("Play");
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e20) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e20.toString()); BA.debugLineNum = 1096;BA.debugLine="Log(LastException)";
Debug.ShouldStop(128);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 1097;BA.debugLine="fx.msgbox(MainForm,\"GetCommandStatus LastExcepti";
Debug.ShouldStop(256);
main._fx.runVoidMethodAndSync ("Msgbox",(Object)(main._mainform),(Object)(RemoteObject.concat(RemoteObject.createImmutable("GetCommandStatus LastException: "),main.__c.runMethod(false,"LastException",main.ba))),(Object)(main._mainform.runMethod(true,"getTitle")));
 };
...
this.state = 4;
this.catchState = 13;
 BA.debugLineNum = 1048;BA.debugLine="RESTPost(\"https://rest-\" & userRegion & \".immedi";
Debug.ShouldStop(8388608);
_restpost(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/network/"),parent._networkid,RemoteObject.createImmutable("/disarm")));
 BA.debugLineNum = 1050;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(33554432);
...
this.state = 4;
;
 BA.debugLineNum = 1051;BA.debugLine="File.WriteString(File.DirApp,\"response_arm.txt\",";
Debug.ShouldStop(67108864);
...
_getcommandid(parent._response);
 BA.debugLineNum = 1053;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immedia-";
Debug.ShouldStop(268435456);
...
this.state = 4;
;
 BA.debugLineNum = 1055;BA.debugLine="For i = 1 To 30";
Debug.ShouldStop(1073741824);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 1056;BA.debugLine="GetCommandStatus(response)";
Debug.ShouldStop(-2147483648);
_getcommandstatus(parent._response);
 BA.debugLineNum = 1057;BA.debugLine="If commandComplete Then";
Debug.ShouldStop(1);
if (true) break;
...
//C
this.state = 10;
 BA.debugLineNum = 1059;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("Sleep",main.ba,anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "main", "ivdriveway_mouseclicked"),BA.numberCast(int.class, 1000));
this.state = 19;
return;
...
this.state = 10;
;
 BA.debugLineNum = 1061;BA.debugLine="File.WriteString(File.DirApp,\"response_arm_com";
Debug.ShouldStop(16);
parent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(parent.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(BA.ObjectToString("response_arm_commandcomplete.txt")),(Object)(parent._response));
 BA.debugLineNum = 1062;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(32);
parent.__c.runVoidMethod ("Sleep",main.ba,anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "main", "ivdriveway_mouseclicked"),BA.numberCast(int.class, 1000));
this.state = 20;
return;
...
this.state = 18;
;
 BA.debugLineNum = 1065;BA.debugLine="RESTGet(\"https://rest-\" & userRegion &\".immedia";
Debug.ShouldStop(256);
_restget(RemoteObject.concat(RemoteObject.createImmutable("https://rest-"),parent._userregion,RemoteObject.createImmutable(".immedia-semi.com/network/"),parent._networkid,RemoteObject.createImmutable("/command/"),parent._commandid));
 BA.debugLineNum = 1066;BA.debugLine="Sleep(1000)";
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("Sleep",main.ba,anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "main", "ivdriveway_mouseclicked"),BA.numberCast(int.class, 1000));
this.state = 21;
return;
...
this.state = 14;
this.catchState = 0;
 BA.debugLineNum = 1069;BA.debugLine="Log(LastException)";
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(parent.__c.runMethod(false,"LastException",main.ba))));
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("ivFrontDoor_MouseClicked (main) ","main",0,main.ba,main.mostCurrent,1101);
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 1101;BA.debugLine="Sub ivFrontDoor_MouseClicked (EventData As MouseEv";
Debug.ShouldStop(4096);
 BA.debugLineNum = 1102;BA.debugLine="Dim mf As frmMedia";
Debug.ShouldStop(8192);
_mf = RemoteObject.createNew ("cloyd.blink.frmmedia");Debug.locals.put("mf", _mf);
 BA.debugLineNum = 1103;BA.debugLine="mf.Initialize(MainForm)";
Debug.ShouldStop(16384);
_mf.runClassMethod (cloyd.blink.frmmedia.class, "_initialize" /*RemoteObject*/ ,main.ba,(Object)(main._mainform));
 BA.debugLineNum = 1104;BA.debugLine="mf.timestamp = lblFrontDoor.Text";
Debug.ShouldStop(32768);
_mf.setField ("_timestamp" /*RemoteObject*/ ,main._lblfrontdoor.runMethod(true,"getText"));
 BA.debugLineNum = 1105;BA.debugLine="mf.url=$\"    <h1>${lblFrontDoor.Text}</h1>    <im";
Debug.ShouldStop(65536);
_mf.setField ("_url" /*RemoteObject*/ ,(RemoteObject.concat(RemoteObject.createImmutable("\n"),RemoteObject.createImmutable("   <h1>"),main.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main._lblfrontdoor.runMethod(true,"getText")))),RemoteObject.createImmutable("</h1>\n"),RemoteObject.createImmutable("   <img src=\""),main.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.__c.getField(false,"File").runMethod(true,"GetUri",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("FrontDoor.jpg")))))),RemoteObject.createImmutable("\"/>\n"),RemoteObject.createImmutable("   \n"),RemoteObject.createImmutable(""))));
 BA.debugLineNum = 1110;BA.debugLine="mf.Show";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("ivSideYard_MouseClicked (main) ","main",0,main.ba,main.mostCurrent,1113);
...
RemoteObject _mf = RemoteObject.declareNull("cloyd.blink.frmmedia");
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 1113;BA.debugLine="Sub ivSideYard_MouseClicked (EventData As MouseEve";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 1114;BA.debugLine="Dim mf As frmMedia";
Debug.ShouldStop(33554432);
_mf = RemoteObject.createNew ("cloyd.blink.frmmedia");Debug.locals.put("mf", _mf);
 BA.debugLineNum = 1115;BA.debugLine="mf.Initialize(MainForm)";
Debug.ShouldStop(67108864);
_mf.runClassMethod (cloyd.blink.frmmedia.class, "_initialize" /*RemoteObject*/ ,main.ba,(Object)(main._mainform));
 BA.debugLineNum = 1116;BA.debugLine="mf.timestamp = lblSideYard.Text";
Debug.ShouldStop(134217728);
_mf.setField ("_timestamp" /*RemoteObject*/ ,main._lblsideyard.runMethod(true,"getText"));
 BA.debugLineNum = 1117;BA.debugLine="mf.url=$\"    <h1>${lblSideYard.Text}</h1>    <img";
Debug.ShouldStop(268435456);
_mf.setField ("_url" /*RemoteObject*/ ,(RemoteObject.concat(RemoteObject.createImmutable("\n"),RemoteObject.createImmutable("   <h1>"),main.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main._lblsideyard.runMethod(true,"getText")))),RemoteObject.createImmutable("</h1>\n"),RemoteObject.createImmutable("   <img src=\""),main.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((main.__c.getField(false,"File").runMethod(true,"GetUri",(Object)(main.__c.getField(false,"File").runMethod(true,"getDirApp")),(Object)(RemoteObject.createImmutable("SideYard.jpg")))))),RemoteObject.createImmutable("\"/>\n"),RemoteObject.createImmutable("   \n"),RemoteObject.createImmutable(""))));
 BA.debugLineNum = 1122;BA.debugLine="mf.Show";
Debug.ShouldStop(2);
_mf.runClassMethod (cloyd.blink.frmmedia.class, "_show" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("ParseUTCstring (main) ","main",0,main.ba,main.mostCurrent,1286);
...
Debug.locals.put("utc", _utc);
 BA.debugLineNum = 1286;BA.debugLine="Sub ParseUTCstring(utc As String) As Long";
Debug.ShouldStop(32);
 BA.debugLineNum = 1287;BA.debugLine="Dim df As String = DateTime.DateFormat";
Debug.ShouldStop(64);
_df = main.__c.getField(false,"DateTime").runMethod(true,"getDateFormat");Debug.locals.put("df", _df);Debug.locals.put("df", _df);
 BA.debugLineNum = 1288;BA.debugLine="Dim res As Long";
Debug.ShouldStop(128);
_res = RemoteObject.createImmutable(0L);Debug.locals.put("res", _res);
 BA.debugLineNum = 1289;BA.debugLine="If utc.CharAt(10) = \"T\" Then";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("=",_utc.runMethod(true,"charAt",(Object)(BA.numberCast(int.class, 10))),BA.ObjectToChar("T"))) { 
 BA.debugLineNum = 1291;BA.debugLine="If utc.CharAt(19) = \".\" Then utc = utc.SubString";
Debug.ShouldStop(1024);
...
_utc = RemoteObject.concat(_utc.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 19))),RemoteObject.createImmutable("+0000"));Debug.locals.put("utc", _utc);};
 BA.debugLineNum = 1292;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd'T'HH:mm:ssZ\"";
Debug.ShouldStop(2048);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd'T'HH:mm:ssZ"));
 }else {
 BA.debugLineNum = 1295;BA.debugLine="DateTime.DateFormat = \"EEE MMM dd HH:mm:ss Z yyy";
Debug.ShouldStop(16384);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("EEE MMM dd HH:mm:ss Z yyyy"));
 };
 BA.debugLineNum = 1297;BA.debugLine="Try";
Debug.ShouldStop(65536);
try { BA.debugLineNum = 1298;BA.debugLine="res = DateTime.DateParse(utc)";
Debug.ShouldStop(131072);
_res = main.__c.getField(false,"DateTime").runMethod(true,"DateParse",(Object)(_utc));Debug.locals.put("res", _res);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e12) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e12.toString()); BA.debugLineNum = 1300;BA.debugLine="res = 0";
Debug.ShouldStop(524288);
_res = BA.numberCast(long.class, 0);Debug.locals.put("res", _res);
 };
 BA.debugLineNum = 1302;BA.debugLine="DateTime.DateFormat = df";
Debug.ShouldStop(2097152);
main.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",_df);
 BA.debugLineNum = 1303;BA.debugLine="Return res";
Debug.ShouldStop(4194304);
if (true) return _res;
...
try {
		Debug.PushSubsStack("SetAvg (main) ","main",0,main.ba,main.mostCurrent,1178);
...
Debug.locals.put("temp", _temp);
 BA.debugLineNum = 1178;BA.debugLine="Private Sub SetAvg(bc As BitmapCreator, x As Int,";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 1179;BA.debugLine="Try";
Debug.ShouldStop(67108864);
try { BA.debugLineNum = 1180;BA.debugLine="temp.Initialize";
Debug.ShouldStop(134217728);
_temp.runVoidMethod ("Initialize");
 BA.debugLineNum = 1181;BA.debugLine="For Each c As ARGBColor In clrs";
Debug.ShouldStop(268435456);
{
...
_temp.setField ("r",BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_temp.getField(true,"r"),_clrs.getField(true,"length")}, "/",0, 0)));
 BA.debugLineNum = 1188;BA.debugLine="temp.g = temp.g / clrs.Length";
Debug.ShouldStop(8);
_temp.setField ("g",BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_temp.getField(true,"g"),_clrs.getField(true,"length")}, "/",0, 0)));
 BA.debugLineNum = 1189;BA.debugLine="temp.b = temp.b / clrs.Length";
Debug.ShouldStop(16);
_temp.setField ("b",BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_temp.getField(true,"b"),_clrs.getField(true,"length")}, "/",0, 0)));
 BA.debugLineNum = 1190;BA.debugLine="bc.SetARGB(x, y, temp)";
Debug.ShouldStop(32);
_bc.runVoidMethod ("_setargb",(Object)(_x),(Object)(_y),(Object)(_temp));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e14) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.ba, e14.toString()); BA.debugLineNum = 1192;BA.debugLine="Log(LastException)";
Debug.ShouldStop(128);
main.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.__c.runMethod(false,"LastException",main.ba))));
 BA.debugLineNum = 1193;BA.debugLine="fx.msgbox(MainForm,\"SetAvg LastException: \" & La";
Debug.ShouldStop(256);
