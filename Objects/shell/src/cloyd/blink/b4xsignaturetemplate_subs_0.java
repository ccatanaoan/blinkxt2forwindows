...
try {
		Debug.PushSubsStack("DialogClosed (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "ba"),__ref,53);
...
try {
		Debug.PushSubsStack("getBitmap (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("GetPanel (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("Initialize (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("mBase_Touch (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("Resize (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("Show (b4xsignaturetemplate) ","b4xsignaturetemplate",22,__ref.getField(false, "ba"),__ref,31);
