...
try {
		Debug.PushSubsStack("Base_Resize (scrollinglabel) ","scrollinglabel",24,__ref.getField(false, "ba"),__ref,38);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.scrollinglabel.class, "_settext" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("DesignerCreateView (scrollinglabel) ","scrollinglabel",24,__ref.getField(false, "ba"),__ref,23);
...
_l.setObject(_lbl.getObject());Debug.locals.put("l", _l);
...
try {
		Debug.PushSubsStack("getText (scrollinglabel) ","scrollinglabel",24,__ref.getField(false, "ba"),__ref,91);
...
try {
		Debug.PushSubsStack("getTextColor (scrollinglabel) ","scrollinglabel",24,__ref.getField(false, "ba"),__ref,124);
...
try {
		Debug.PushSubsStack("Initialize (scrollinglabel) ","scrollinglabel",24,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("MeasureTextWidth (scrollinglabel) ","scrollinglabel",24,__ref.getField(false, "ba"),__ref,115);
...
try {
		Debug.PushSubsStack("setText (scrollinglabel) ","scrollinglabel",24,__ref.getField(false, "ba"),__ref,43);
...
Debug.JustUpdateDeviceLine();
_originaltextwidth = __ref.runClassMethod (cloyd.blink.scrollinglabel.class, "_measuretextwidth" /*RemoteObject*/ ,(Object)(_t),(Object)(__ref.getField(false,"_fnt" /*RemoteObject*/ )));Debug.locals.put("originalTextWidth", _originaltextwidth);Debug.locals.put("originalTextWidth", _originaltextwidth);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.scrollinglabel.class, "_stopscrolling" /*RemoteObject*/ );
 }else {
...
Debug.JustUpdateDeviceLine();
_width = __ref.runClassMethod (cloyd.blink.scrollinglabel.class, "_measuretextwidth" /*RemoteObject*/ ,(Object)(_duplicatetext),(Object)(__ref.getField(false,"_fnt" /*RemoteObject*/ )));Debug.locals.put("Width", _width);Debug.locals.put("Width", _width);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.scrollinglabel.class, "_startscrolling" /*void*/ ,(Object)(_p),(Object)(_originaltextwidth));
 };
...
try {
		Debug.PushSubsStack("setTextColor (scrollinglabel) ","scrollinglabel",24,__ref.getField(false, "ba"),__ref,119);
...
try {
		Debug.PushSubsStack("StartScrolling (scrollinglabel) ","scrollinglabel",24,__ref.getField(false, "ba"),__ref,99);
...
public ResumableSub_StartScrolling(cloyd.blink.scrollinglabel parent,RemoteObject __ref,RemoteObject _p,RemoteObject _originalwidth) {
this.parent = parent;
this.__ref = __ref;
this._p = _p;
...
try {
		Debug.PushSubsStack("StopScrolling (scrollinglabel) ","scrollinglabel",24,__ref.getField(false, "ba"),__ref,95);
