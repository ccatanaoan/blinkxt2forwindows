...
try {
		Debug.PushSubsStack("Append (b4jtextflow) ","b4jtextflow",30,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("CreateTextFlow (b4jtextflow) ","b4jtextflow",30,__ref.getField(false, "ba"),__ref,45);
...
try {
		Debug.PushSubsStack("Initialize (b4jtextflow) ","b4jtextflow",30,__ref.getField(false, "ba"),__ref,7);
...
try {
		Debug.PushSubsStack("Reset (b4jtextflow) ","b4jtextflow",30,__ref.getField(false, "ba"),__ref,11);
...
try {
		Debug.PushSubsStack("SetColor (b4jtextflow) ","b4jtextflow",30,__ref.getField(false, "ba"),__ref,28);
...
try {
		Debug.PushSubsStack("SetFont (b4jtextflow) ","b4jtextflow",30,__ref.getField(false, "ba"),__ref,23);
...
try {
		Debug.PushSubsStack("SetStrikethrough (b4jtextflow) ","b4jtextflow",30,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("SetUnderline (b4jtextflow) ","b4jtextflow",30,__ref.getField(false, "ba"),__ref,33);
