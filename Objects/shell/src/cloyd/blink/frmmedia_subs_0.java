...
try {
		Debug.PushSubsStack("btnHiddenExitEscapeKey_Click (frmmedia) ","frmmedia",1,__ref.getField(false, "ba"),__ref,89);
...
try {
		Debug.PushSubsStack("CheckMonitor (frmmedia) ","frmmedia",1,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("frm_CloseRequest (frmmedia) ","frmmedia",1,__ref.getField(false, "ba"),__ref,46);
...
try {
		Debug.PushSubsStack("Initialize (frmmedia) ","frmmedia",1,__ref.getField(false, "ba"),__ref,12);
...
_jo.setObject(__ref.getField(false,"_btnhiddenexitescapekey" /*RemoteObject*/ ).getObject());Debug.locals.put("JO", _jo);
...
try {
		Debug.PushSubsStack("KeyPressed_Event (frmmedia) ","frmmedia",1,__ref.getField(false, "ba"),__ref,43);
...
try {
		Debug.PushSubsStack("RootPaneKeyEvent_Event (frmmedia) ","frmmedia",1,__ref.getField(false, "ba"),__ref,50);
...
try {
		Debug.PushSubsStack("Show (frmmedia) ","frmmedia",1,__ref.getField(false, "ba"),__ref,31);
