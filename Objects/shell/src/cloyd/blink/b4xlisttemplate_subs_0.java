...
b4xlisttemplate._xdialog = RemoteObject.createNew ("cloyd.blink.b4xdialog");__ref.setField("_xdialog",b4xlisttemplate._xdialog);
...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xlisttemplate) ","b4xlisttemplate",16,__ref.getField(false, "ba"),__ref,76);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xlisttemplate.class, "_selectitem" /*RemoteObject*/ ,(Object)(_item),(Object)(b4xlisttemplate.__c.getField(true,"True")));
 }else {
...
try {
		Debug.PushSubsStack("DialogClosed (b4xlisttemplate) ","b4xlisttemplate",16,__ref.getField(false, "ba"),__ref,89);
...
try {
		Debug.PushSubsStack("GetPanel (b4xlisttemplate) ","b4xlisttemplate",16,__ref.getField(false, "ba"),__ref,37);
...
try {
		Debug.PushSubsStack("Initialize (b4xlisttemplate) ","b4xlisttemplate",16,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("Resize (b4xlisttemplate) ","b4xlisttemplate",16,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("SelectItem (b4xlisttemplate) ","b4xlisttemplate",16,__ref.getField(false, "ba"),__ref,59);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).runClassMethod (cloyd.blink.b4xdialog.class, "_setbuttonstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("g",__ref.getField(false,"_selecteditems" /*RemoteObject*/ ).runMethod(true,"getSize"),__ref.getField(true,"_multiselectionminimum" /*RemoteObject*/ )))));
...
try {
		Debug.PushSubsStack("Show (b4xlisttemplate) ","b4xlisttemplate",16,__ref.getField(false, "ba"),__ref,41);
...
public ResumableSub_Show(cloyd.blink.b4xlisttemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xlisttemplate.class, "_selectitem" /*RemoteObject*/ ,(Object)(_item),(Object)(parent.__c.getField(true,"False")));
 if (true) break;
if (true) break;
...
Debug.JustUpdateDeviceLine();
_dialog.runClassMethod (cloyd.blink.b4xdialog.class, "_internaladdstubtoclvifneeded" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).getField(true,"_defaulttextbackgroundcolor")));
