...
try {
		Debug.PushSubsStack("CopyFormatData (b4xformatter) ","b4xformatter",22,__ref.getField(false, "ba"),__ref,36);
...
Debug.JustUpdateDeviceLine();
_d = RemoteObject.createNew ("cloyd.blink.b4xformatter._b4xformatdata");Debug.locals.put("d", _d);
...
try {
		Debug.PushSubsStack("CreateDefaultFormat (b4xformatter) ","b4xformatter",22,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("Initialize (b4xformatter) ","b4xformatter",22,__ref.getField(false, "ba"),__ref,11);
...
Debug.JustUpdateDeviceLine();
_d = __ref.runClassMethod (cloyd.blink.b4xformatter.class, "_createdefaultformat" /*RemoteObject*/ );Debug.locals.put("d", _d);Debug.locals.put("d", _d);
 BA.debugLineNum = 14;BA.debugLine="AddFormatData(d, MIN_VALUE, MAX_VALUE, True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.b4xformatter.class, "_addformatdata" /*RemoteObject*/ ,(Object)(_d),(Object)(BA.numberCast(double.class, __ref.getField(true,"_min_value" /*RemoteObject*/ ))),(Object)(BA.numberCast(double.class, __ref.getField(true,"_max_value" /*RemoteObject*/ ))),(Object)(b4xformatter.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("NewFormatData (b4xformatter) ","b4xformatter",22,__ref.getField(false, "ba"),__ref,30);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (cloyd.blink.b4xformatter.class, "_copyformatdata" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (cloyd.blink.b4xformatter.class, "_getdefaultformat" /*RemoteObject*/ )));
