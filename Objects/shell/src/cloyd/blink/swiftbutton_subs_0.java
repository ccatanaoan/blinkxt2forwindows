...
try {
		Debug.PushSubsStack("Base_Resize (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,50);
...
try {
		Debug.PushSubsStack("DesignerCreateView (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("Draw (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,116);
...
try {
		Debug.PushSubsStack("getEnabled (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,58);
...
try {
		Debug.PushSubsStack("Initialize (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("p_MouseClicked (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("p_Touch (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,68);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(swiftbutton.__c.getField(true,"True")));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(_inside));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(swiftbutton.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("SetColors (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,106);
...
try {
		Debug.PushSubsStack("setEnabled (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,62);
...
try {
		Debug.PushSubsStack("SetPressedState (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,89);
...
try {
		Debug.PushSubsStack("Update (swiftbutton) ","swiftbutton",29,__ref.getField(false, "ba"),__ref,112);
