...
b4xtimedtemplate._anotherprogressbar1 = RemoteObject.createNew ("cloyd.blink.anotherprogressbar");__ref.setField("_anotherprogressbar1",b4xtimedtemplate._anotherprogressbar1);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xtimedtemplate) ","b4xtimedtemplate",21,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("GetPanel (b4xtimedtemplate) ","b4xtimedtemplate",21,__ref.getField(false, "ba"),__ref,16);
...
_innerpanel.setObject(b4xtimedtemplate.__c.runMethodAndSync(false,"CallSubNew2",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mtemplate" /*RemoteObject*/ )),(Object)(BA.ObjectToString("GetPanel")),(Object)((_dialog))));Debug.locals.put("InnerPanel", _innerpanel);
...
try {
		Debug.PushSubsStack("Initialize (b4xtimedtemplate) ","b4xtimedtemplate",21,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("Show (b4xtimedtemplate) ","b4xtimedtemplate",21,__ref.getField(false, "ba"),__ref,28);
...
public ResumableSub_Show(cloyd.blink.b4xtimedtemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_anotherprogressbar1" /*RemoteObject*/ ).runClassMethod (cloyd.blink.anotherprogressbar.class, "_setvaluenoanimation" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_anotherprogressbar1" /*RemoteObject*/ ).runClassMethod (cloyd.blink.anotherprogressbar.class, "_setvalue" /*RemoteObject*/ ,BA.numberCast(int.class, 100));
...
Debug.JustUpdateDeviceLine();
_dialog.runClassMethod (cloyd.blink.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Cancel")));
 if (true) break;
