...
try {
		Debug.PushSubsStack("DialogClosed (b4xtimedtemplate) ","b4xtimedtemplate",24,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("GetPanel (b4xtimedtemplate) ","b4xtimedtemplate",24,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("Initialize (b4xtimedtemplate) ","b4xtimedtemplate",24,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("Show (b4xtimedtemplate) ","b4xtimedtemplate",24,__ref.getField(false, "ba"),__ref,28);
