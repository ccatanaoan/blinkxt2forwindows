...
try {
		Debug.PushSubsStack("Base_Resize (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("CreateLabel (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,243);
...
try {
		Debug.PushSubsStack("Decrement (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,179);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("getSelectedValue (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,114);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (cloyd.blink.b4xplusminus.class, "_getvalueimpl" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mselectedindex" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("GetValueImpl (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,127);
...
try {
		Debug.PushSubsStack("Increment (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,159);
...
try {
		Debug.PushSubsStack("Initialize (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,29);
...
try {
		Debug.PushSubsStack("InternalSetTextOrCSBuilderToLabel (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,253);
...
try {
		Debug.PushSubsStack("pnlArrow_MouseClicked (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,272);
...
try {
		Debug.PushSubsStack("pnlArrow_MousePressed (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,268);
...
try {
		Debug.PushSubsStack("pnlArrow_MouseReleased (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,276);
...
try {
		Debug.PushSubsStack("pnlArrow_Touch (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,192);
...
try {
		Debug.PushSubsStack("SetIndex (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,139);
...
try {
		Debug.PushSubsStack("SetNumericRange (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,105);
...
try {
		Debug.PushSubsStack("setSelectedValue (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,118);
...
try {
		Debug.PushSubsStack("SetStringItems (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("StartDownLoop (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,230);
...
try {
		Debug.PushSubsStack("Touch (b4xplusminus) ","b4xplusminus",19,__ref.getField(false, "ba"),__ref,196);
