...
try {
		Debug.PushSubsStack("Complete (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,239);
...
try {
		Debug.PushSubsStack("Delete (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,197);
...
try {
		Debug.PushSubsStack("Delete2 (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,202);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeDelete",(Object)(__ref.runClassMethod (cloyd.blink.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(_link),(Object)(_parameters))));
...
try {
		Debug.PushSubsStack("Download (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,167);
...
try {
		Debug.PushSubsStack("Download2 (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,177);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeGet",(Object)(__ref.runClassMethod (cloyd.blink.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(_link),(Object)(_parameters))));
...
try {
		Debug.PushSubsStack("escapeLink (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("GetBitmap (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,246);
...
try {
		Debug.PushSubsStack("GetInputStream (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,271);
...
try {
		Debug.PushSubsStack("GetRequest (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,234);
...
try {
		Debug.PushSubsStack("GetString (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,215);
...
Debug.JustUpdateDeviceLine();
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (cloyd.blink.httpjob.class, "_getstring2" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("UTF8")));
...
try {
		Debug.PushSubsStack("GetString2 (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,220);
...
try {
		Debug.PushSubsStack("Head (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,74);
...
try {
		Debug.PushSubsStack("Initialize (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("MultipartStartSection (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,128);
...
try {
		Debug.PushSubsStack("PatchBytes (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,58);
...
try {
		Debug.PushSubsStack("PatchString (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,53);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.httpjob.class, "_patchbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PostBytes (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("PostFile (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,139);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_out.runMethod(false,"ToBytesArray")));
 }else {
...
try {
		Debug.PushSubsStack("PostMultipart (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,82);
...
RemoteObject _fd = RemoteObject.declareNull("cloyd.blink.httpjob._multipartfiledata");
RemoteObject _in = RemoteObject.declareNull("anywheresoftware.b4a.objects.streams.File.InputStreamWrapper");
Debug.locals.put("Link", _link);
...
Debug.JustUpdateDeviceLine();
_empty = __ref.runClassMethod (cloyd.blink.httpjob.class, "_multipartstartsection" /*RemoteObject*/ ,(Object)(_stream),(Object)(_empty));Debug.locals.put("empty", _empty);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_stream.runMethod(false,"ToBytesArray")));
...
try {
		Debug.PushSubsStack("PostString (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,31);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PutBytes (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("PutString (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,42);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.httpjob.class, "_putbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("Release (httpjob) ","httpjob",4,__ref.getField(false, "ba"),__ref,208);
