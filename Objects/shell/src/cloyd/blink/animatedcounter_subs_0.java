...
try {
		Debug.PushSubsStack("Base_Resize (animatedcounter) ","animatedcounter",5,__ref.getField(false, "ba"),__ref,67);
...
_bmp = __ref.runClassMethod (cloyd.blink.animatedcounter.class, "_createbitmap" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbltemplate" /*RemoteObject*/ )));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
...
try {
		Debug.PushSubsStack("CreateBitmap (animatedcounter) ","animatedcounter",5,__ref.getField(false, "ba"),__ref,90);
...
try {
		Debug.PushSubsStack("CreateFadeBitmap (animatedcounter) ","animatedcounter",5,__ref.getField(false, "ba"),__ref,54);
...
Debug.JustUpdateDeviceLine();
_bc.runVoidMethod ("_fillgradient",(Object)(RemoteObject.createNewArray("int",new int[] {2},new Object[] {__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_White"),BA.numberCast(int.class, 0x00ffffff)})),(Object)(_r),(Object)(RemoteObject.createImmutable("TOP_BOTTOM")));
...
Debug.JustUpdateDeviceLine();
_bc.runVoidMethod ("_fillgradient",(Object)(RemoteObject.createNewArray("int",new int[] {2},new Object[] {__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_White"),BA.numberCast(int.class, 0x00ffffff)})),(Object)(_r),(Object)(RemoteObject.createImmutable("BOTTOM_TOP")));
...
try {
		Debug.PushSubsStack("DesignerCreateView (animatedcounter) ","animatedcounter",5,__ref.getField(false, "ba"),__ref,28);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_fade" /*RemoteObject*/ ,__ref.runClassMethod (cloyd.blink.animatedcounter.class, "_createfadebitmap" /*RemoteObject*/ ));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.animatedcounter.class, "_setvalue" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.animatedcounter.class, "_base_resize" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")));
 BA.debugLineNum = 50;BA.debugLine="setValue(getValue)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (cloyd.blink.animatedcounter.class, "_setvalue" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (cloyd.blink.animatedcounter.class, "_getvalue" /*RemoteObject*/ )));
 };
...
try {
		Debug.PushSubsStack("getValue (animatedcounter) ","animatedcounter",5,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("Initialize (animatedcounter) ","animatedcounter",5,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("setValue (animatedcounter) ","animatedcounter",5,__ref.getField(false, "ba"),__ref,106);
...
try {
		Debug.PushSubsStack("TopFromValue (animatedcounter) ","animatedcounter",5,__ref.getField(false, "ba"),__ref,85);
