...
try {
		Debug.PushSubsStack("Base_Resize (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("CmbBox_SelectedIndexChanged (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,153);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("GetItem (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,127);
...
try {
		Debug.PushSubsStack("getSelectedIndex (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("getSelectedItem (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,121);
...
Debug.JustUpdateDeviceLine();
_i = __ref.runClassMethod (cloyd.blink.b4xcombobox.class, "_getselectedindex" /*RemoteObject*/ );Debug.locals.put("i", _i);Debug.locals.put("i", _i);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (cloyd.blink.b4xcombobox.class, "_getitem" /*RemoteObject*/ ,(Object)(_i));
...
try {
		Debug.PushSubsStack("getSize (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("IndexOf (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,87);
...
try {
		Debug.PushSubsStack("Initialize (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("RaiseEvent (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("SetItems (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("setSelectedIndex (b4xcombobox) ","b4xcombobox",11,__ref.getField(false, "ba"),__ref,106);
