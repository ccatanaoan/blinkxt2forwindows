...
try {
		Debug.PushSubsStack("CompleteJob (httputils2service) ","httputils2service",1,httputils2service.ba,httputils2service.mostCurrent,93);
...
try {
		Debug.PushSubsStack("hc_ResponseError (httputils2service) ","httputils2service",1,httputils2service.ba,httputils2service.mostCurrent,70);
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (httputils2service) ","httputils2service",1,httputils2service.ba,httputils2service.mostCurrent,55);
...
try {
		Debug.PushSubsStack("Response_StreamFinish (httputils2service) ","httputils2service",1,httputils2service.ba,httputils2service.mostCurrent,62);
...
try {
		Debug.PushSubsStack("Service_Create (httputils2service) ","httputils2service",1,httputils2service.ba,httputils2service.mostCurrent,13);
...
try {
		Debug.PushSubsStack("SubmitJob (httputils2service) ","httputils2service",1,httputils2service.ba,httputils2service.mostCurrent,42);
...
Debug.JustUpdateDeviceLine();
httputils2service._hc.runVoidMethod ("ExecuteCredentials",httputils2service.ba,(Object)(_job.runClassMethod (b4j.example.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(httputils2service._taskcounter),(Object)(_job.getField(true,"_username" /*RemoteObject*/ )),(Object)(_job.getField(true,"_password" /*RemoteObject*/ )));
 }else {
 BA.debugLineNum = 49;BA.debugLine="hc.Execute(job.GetRequest, taskCounter)";
Debug.JustUpdateDeviceLine();
httputils2service._hc.runVoidMethod ("Execute",httputils2service.ba,(Object)(_job.runClassMethod (b4j.example.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(httputils2service._taskcounter));
 };
