...
public static b4j.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"accountID",main._accountid,"AtualSkin",main._atualskin,"authToken",main._authtoken,"btnDriveway",main._btndriveway,"cameraThumbnail",main._camerathumbnail,"commandComplete",main._commandcomplete,"commandID",main._commandid,"emailAddress",main._emailaddress,"f_H",main._f_h,"f_W",main._f_w,"f_X",main._f_x,"f_Y",main._f_y,"fx",main._fx,"HttpUtils2Service",Debug.moduleToString(b4j.example.httputils2service.class),"imgInit",main._imginit,"isMaximized",main._ismaximized,"ivClose",main._ivclose,"ivDriveway",main._ivdriveway,"ivFrontDoor",main._ivfrontdoor,"ivMax",main._ivmax,"ivMin",main._ivmin,"ivSideYard",main._ivsideyard,"lblDriveway",main._lbldriveway,"lblFrontDoor",main._lblfrontdoor,"lblSideYard",main._lblsideyard,"lblStatus",main._lblstatus,"lbTitle",main._lbtitle,"MainForm",main._mainform,"networkID",main._networkid,"password",main._password,"response",main._response,"userRegion",main._userregion,"xMouse",main._xmouse,"yMouse",main._ymouse};
}
}